...
content:
    enable: true
    block:
    - title_left: "كيفية تحويل DOCX إلى XLSX في C # .NET"
      content_left: |
          اتبع هذه الخطوات البسيطة لتحويل DOCX إلى XLSX في .NET. اعرض مستند XLSX كما هو أو اعرضه على هيئة HTML دون استخدام أي برنامج خارجي.
    ...
    - title_left: "إضافة نص أو صورة مائية إلى XLSX في C #"
      content_left: |
          قم بتحويل المستندات بدقة (DOCX إلى XLSX) تمامًا مثل الملف الأصلي وقم بتطبيق علامات مائية نصية أو صورية على صفحات المستند المحولة باستخدام C # .NET.
