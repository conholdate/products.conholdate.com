...
content:
    enable: true
    block:
    - title_left: "كيفية تحويل DOCM إلى PPT في C # .NET"
      content_left: |
          اتبع هذه الخطوات البسيطة لتحويل DOCM إلى PPT في .NET. اعرض مستند PPT كما هو أو اعرضه على هيئة HTML دون استخدام أي برنامج خارجي.

          -   قم بإنشاء كائن **Converter** لتحويل مستند DOCM
          -   اضبط خيارات التحويل لتنسيق PPT
          -   استدعاء **Convert** طريقة **Converter** فئة المثيل للتحويل إلى PPT
          -   عيِّن خيارات عارض HTML
          -   أنشئ كائن **Viewer** لعرض PPT المحول بتنسيق HTML
    ...
    - title_left: "إضافة نص أو صورة مائية إلى PPT في C #"
      content_left: |
          قم بتحويل المستندات بدقة (DOCM إلى PPT) تمامًا مثل الملف الأصلي وقم بتطبيق علامات مائية نصية أو صورية على صفحات المستند المحولة باستخدام C # .NET.
