...
content:
    enable: true
    block:
    - title_left: "كيفية تحويل OTT إلى SVGZ في C # .NET"
      content_left: |
          اتبع هذه الخطوات البسيطة لتحويل OTT إلى SVGZ في .NET. اعرض مستند SVGZ كما هو أو اعرضه على هيئة HTML دون استخدام أي برنامج خارجي.
    ...
    - title_left: "إضافة نص أو صورة مائية إلى SVGZ في C #"
      content_left: |
          قم بتحويل المستندات بدقة (OTT إلى SVGZ) تمامًا مثل الملف الأصلي وقم بتطبيق علامات مائية نصية أو صورية على صفحات المستند المحولة باستخدام C # .NET.
