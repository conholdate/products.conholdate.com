...
content:
    enable: true
    block:
    - title_left: "كيفية تحويل ODT إلى PPT في C # .NET"
      content_left: |
          اتبع هذه الخطوات البسيطة لتحويل ODT إلى PPT في .NET. اعرض مستند PPT كما هو أو اعرضه على هيئة HTML دون استخدام أي برنامج خارجي.
    ...
    - title_left: "إضافة نص أو صورة مائية إلى PPT في C #"
      content_left: |
          قم بتحويل المستندات بدقة (ODT إلى PPT) تمامًا مثل الملف الأصلي وقم بتطبيق علامات مائية نصية أو صورية على صفحات المستند المحولة باستخدام C # .NET.
