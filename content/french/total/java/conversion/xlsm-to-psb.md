...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLSM en PSB en Java"
      content_left: |
          Effectuez la conversion de fichiers XLSM en PSB en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir XLSM protégé par mot de passe en PSB"
      content_left: |
