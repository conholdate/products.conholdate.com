...
draft: false
path: "fr/total/java/conversion/htm-to-emf/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Conversion Java HTM vers EMF"
ad_description: "API de conversion de documents HTM vers EMF pour Java | Plus de 100 formats de fichiers pris en charge"

############################# Head ############################
head_title: "Convertir HTM en EMF dans les applications Java et J2SE"
head_description: "Bibliothèque de conversion de documents Java pour convertir HTM en EMF et plus de 100 autres formats de fichiers dans les applications Java et J2SE. Affichez le document EMF converti en tant que visualiseur HTML."

############################# Header ############################
title: "Convertir HTM en EMF en Java et afficher au format HTML"
description: "Convertissez par programme HTM en EMF dans les applications Java et J2SE à l'aide d'options de manipulation de documents flexibles pour personnaliser le document résultant. Convertissez le document complet ou certaines pages spécifiques en fonction des numéros de page ou des plages de pages sélectives à l'aide de la bibliothèque de conversion Java HTM vers EMF."
...
content:
    enable: true
    block:
    - title_left: "Comment convertir HTM en EMF en Java"
      content_left: |
          Exécutez le fichier HTM vers EMF conversion en Java en trois étapes simples. Affichez le document converti au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir HTM protégé par mot de passe en EMF"
      content_left: |
