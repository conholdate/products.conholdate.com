...
content:
    enable: true
    block:
    - title_left: "Comment convertir TSV en XML en Java"
      content_left: |
          Effectuez la conversion de fichiers TSV en XML en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir TSV protégé par mot de passe en XML"
      content_left: |
