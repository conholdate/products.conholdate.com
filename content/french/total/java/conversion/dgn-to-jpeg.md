...
draft: false
path: "fr/total/java/conversion/dgn-to-jpeg/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Conversion Java DGN vers JPEG"
ad_description: "API de conversion de documents DGN vers JPEG pour Java | Plus de 100 formats de fichiers pris en charge"

############################# Head ############################
head_title: "Convertir DGN en JPEG dans les applications Java et J2SE"
head_description: "Bibliothèque de conversion de documents Java pour convertir DGN en JPEG et plus de 100 autres formats de fichiers dans les applications Java et J2SE. Affichez le document JPEG converti en tant que visualiseur HTML."

############################# Header ############################
title: "Convertir DGN en JPEG en Java et afficher au format HTML"
description: "Convertissez par programme DGN en JPEG dans les applications Java et J2SE à l'aide d'options de manipulation de documents flexibles pour personnaliser le document résultant. Convertissez le document complet ou certaines pages spécifiques en fonction des numéros de page ou des plages de pages sélectives à l'aide de la bibliothèque de conversion Java DGN vers JPEG."
...
content:
    enable: true
    block:
    - title_left: "Comment convertir DGN en JPEG en Java"
      content_left: |
          Exécutez le fichier DGN vers JPEG conversion en Java en trois étapes simples. Affichez le document converti au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir DGN protégé par mot de passe en JPEG"
      content_left: |
