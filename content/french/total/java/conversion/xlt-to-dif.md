...
content:
    ...
    - title_left: "Comment convertir XLT en DIF en Java"
      content_left: |
          Effectuez la conversion de fichiers XLT en DIF en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.
