...
draft: false
path: "fr/total/java/conversion/mhtml-to-ppsx/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Conversion Java MHTML vers PPSX"
ad_description: "API de conversion de documents MHTML vers PPSX pour Java | Plus de 100 formats de fichiers pris en charge"

############################# Head ############################
head_title: "Convertir MHTML en PPSX dans les applications Java et J2SE"
head_description: "Bibliothèque de conversion de documents Java pour convertir MHTML en PPSX et plus de 100 autres formats de fichiers dans les applications Java et J2SE. Affichez le document PPSX converti en tant que visualiseur HTML."

############################# Header ############################
title: "Convertir MHTML en PPSX en Java et afficher au format HTML"
description: "Convertissez par programme MHTML en PPSX dans les applications Java et J2SE à l'aide d'options de manipulation de documents flexibles pour personnaliser le document résultant. Convertissez le document complet ou certaines pages spécifiques en fonction des numéros de page ou des plages de pages sélectives à l'aide de la bibliothèque de conversion Java MHTML vers PPSX."
...
content:
    enable: true
    block:
    - title_left: "Comment convertir MHTML en PPSX en Java"
      content_left: |
          Exécutez le fichier MHTML vers PPSX conversion en Java en trois étapes simples. Affichez le document converti au format HTML sans aucune dépendance à un logiciel externe.

          -   Créez une nouvelle instance de la classe **Converter** et chargez le fichier MHTML
          -   Définissez **ConvertOptions** pour le type de document PPSX
          -   Appelez la méthode **Convert** de l'instance de classe **Converter** pour conversion en PPSX
          -   Définir les options du visualiseur HTML
          -   Créez un objet **Viewer** pour afficher le PPSX converti au format HTML
    ...
    - title_left: "Convertir MHTML protégé par mot de passe en PPSX"
      content_left: |
