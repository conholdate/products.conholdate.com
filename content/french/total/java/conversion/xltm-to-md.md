...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLTM en MD en Java"
      content_left: |
          Effectuez la conversion de fichiers XLTM en MD en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir XLTM protégé par mot de passe en MD"
      content_left: |
