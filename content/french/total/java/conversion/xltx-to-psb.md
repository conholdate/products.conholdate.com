...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLTX en PSB en Java"
      content_left: |
          Effectuez la conversion de fichiers XLTX en PSB en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.

          -   Créez une nouvelle instance de la classe **Converter** et chargez le fichier XLTX
          -   Définissez **ConvertOptions** pour le type de document PSB
    ...
    - title_left: "Convertir XLTX protégé par mot de passe en PSB"
      content_left: |
