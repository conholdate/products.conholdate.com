...
content:
    enable: true
    block:
    - title_left: "Comment convertir WORD en PPS en Java"
      content_left: |
          Effectuez la conversion de fichiers WORD en PPS en Java en trois étapes simples. Affichez le document MHTML converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
