...
content:
    enable: true
    block:
    - title_left: "Comment convertir FODS en MD en Java"
      content_left: |
          Effectuez la conversion de fichiers FODS en MD en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.

          -   Créez une nouvelle instance de la classe **Converter** et chargez le fichier FODS
          -   Définissez **ConvertOptions** pour le type de document MD
    ...
    - title_left: "Convertir FODS protégé par mot de passe en MD"
      content_left: |
