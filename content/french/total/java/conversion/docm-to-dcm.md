...
content:
    ...
    - title_left: "Comment convertir DOCM en DCM en Java"
      content_left: |
          Effectuez la conversion de fichiers DOCM en DCM en Java en trois étapes simples. Affichez le document MHTML converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
