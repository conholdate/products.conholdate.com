...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLTX en HTM en Java"
      content_left: |
          Effectuez la conversion de fichiers XLTX en HTM en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir XLTX protégé par mot de passe en HTM"
      content_left: |
