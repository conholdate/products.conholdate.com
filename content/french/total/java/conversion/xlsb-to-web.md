...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLSB en WEB en Java"
      content_left: |
          Effectuez la conversion de fichiers XLSB en WEB en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir XLSB protégé par mot de passe en WEB"
      content_left: |
