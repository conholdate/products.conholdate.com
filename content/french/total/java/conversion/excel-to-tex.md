...
content:
    enable: true
    block:
    - title_left: "Comment convertir EXCEL en TEX en Java"
      content_left: |
          Effectuez la conversion de fichiers EXCEL en TEX en Java en trois étapes simples. Affichez le document converti tel qu'il est ou affichez-le au format HTML sans aucune dépendance à un logiciel externe.
    ...
    - title_left: "Convertir EXCEL protégé par mot de passe en TEX"
      content_left: |
