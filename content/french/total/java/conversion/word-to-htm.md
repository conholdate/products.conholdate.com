...
content:
    enable: true
    block:
    - title_left: "Comment convertir WORD en HTM en Java"
      content_left: |
          Effectuez la conversion de fichiers WORD en HTM en Java en trois étapes simples. Affichez le document MHTML converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
