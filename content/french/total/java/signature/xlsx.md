...
draft: false
path: "fr/total/java/signature/xlsx/"
...
ad_headline: "Signer numériquement XLSX | Java"
ad_description: "Ajouter, modifier, rechercher, vérifier et supprimer des signatures numériques de XLSX en Java"

############################# Head ############################
head_title: "Signer un fichier XLSX avec des signatures de texte ou d'image en Java"
head_description: "Java XLSX Signature API pour ajouter, modifier, supprimer, vérifier et rechercher des signatures numériques (texte, image, métadonnées, QR-Code, tampon). Affichez le fichier BMP signé au format HTML."

############################# Header ############################
title: "Signer le fichier XLSX en Java et afficher en HTML"
description: "Signez et sécurisez les fichiers XLSX dans les applications Java à l'aide de types de signature électronique populaires tels que le texte, l'image, les métadonnées, le code QR, le tampon et le champ de formulaire. Générez, mettez à jour, supprimez, vérifiez et recherchez par programmation des signatures numériques dans des documents XLSX, des images et divers autres formats de fichiers sans qu'Adobe Reader soit installé."
...
content:
    enable: true
    block:
    - title_left: "Comment ajouter des signatures d'image à XLSX en Java"
      content_left: |
          À l'aide de [Conholdate.Total for Java](https://products.conholdate.com/total/java/) - insérez une image personnalisée en tant que signature électronique dans un document XLSX en Java. Ajoutez le logo de l'entreprise, l'icône de tampon ou le nom en utilisant différentes couleurs et effets de texte.
    ...
    - title_left: "Ajouter des signatures de texte à XLSX en Java"
      content_left: |
          Ajoutez une signature de texte personnalisée à un document XLSX en Java à l'aide de paramètres de texte avancés tels que la couleur de la police, la taille, le nom, l'alignement du texte et l'ajustement des bordures.
