...
draft: false
path: "fr/total/java/signature/dot/"
...
ad_headline: "Signer numériquement DOT | Java"
ad_description: "Ajouter, modifier, rechercher, vérifier et supprimer des signatures numériques de DOT en Java"

############################# Head ############################
head_title: "Signer un fichier DOT avec des signatures de texte ou d'image en Java"
head_description: "Java DOT Signature API pour ajouter, modifier, supprimer, vérifier et rechercher des signatures numériques (texte, image, métadonnées, QR-Code, tampon). Affichez le fichier BMP signé au format HTML."

############################# Header ############################
title: "Signer le fichier DOT en Java et afficher en HTML"
description: "Signez et sécurisez les fichiers DOT dans les applications Java à l'aide de types de signature électronique populaires tels que le texte, l'image, les métadonnées, le code QR, le tampon et le champ de formulaire. Générez, mettez à jour, supprimez, vérifiez et recherchez par programmation des signatures numériques dans des documents DOT, des images et divers autres formats de fichiers sans qu'Adobe Reader soit installé."
...
content:
    enable: true
    block:
    - title_left: "Comment ajouter des signatures d'image à DOT en Java"
      content_left: |
          À l'aide de [Conholdate.Total for Java](https://products.conholdate.com/total/java/) - insérez une image personnalisée en tant que signature électronique dans un document DOT en Java. Ajoutez le logo de l'entreprise, l'icône de tampon ou le nom en utilisant différentes couleurs et effets de texte.
    ...
    - title_left: "Ajouter des signatures de texte à DOT en Java"
      content_left: |
          Ajoutez une signature de texte personnalisée à un document DOT en Java à l'aide de paramètres de texte avancés tels que la couleur de la police, la taille, le nom, l'alignement du texte et l'ajustement des bordures.
