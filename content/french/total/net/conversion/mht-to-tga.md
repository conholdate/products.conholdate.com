...
content:
    enable: true
    block:
    - title_left: "Convertir MHT en TGA en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHT en TGA dans .NET. Affichez le document TGA converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
