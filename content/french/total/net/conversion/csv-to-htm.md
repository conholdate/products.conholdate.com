...
content:
    enable: true
    block:
    - title_left: "Comment convertir CSV en HTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de CSV en HTM dans .NET. Affichez le document HTM converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
