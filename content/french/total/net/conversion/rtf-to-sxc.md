...
ad_headline: "Convertir RTF en SXC | .NET"
ad_description: "La solution de conversion de documents RTF en SXC la plus précise pour vos applications .NET."

############################# Head ############################
head_title: "Convertir RTF en SXC en C# VB.NET ASP.NET | Conversion de documents"
head_description: "Exemple de code pour convertir RTF en SXC et plus de 100 autres formats de fichiers dans les applications .NET (C#, VB.NET, ASP.NET et .NET Core). Affichez le document SXC converti en tant que visualiseur HTML."

############################# Header ############################
title: "Convertir un fichier RTF en SXC en C# .NET"
description: "Convertissez par programmation RTF en SXC dans les applications C# .NET à l'aide des fonctionnalités flexibles du document conversion pour personnaliser le document résultant. Convertissez le document complet d'un format de fichier à un autre ou choisissez des pages sélectives d'un document source en fonction des numéros de page ou des plages de pages et convertissez facilement en un format de document pris en charge."
...
content:
    enable: true
    block:
    - title_left: "Conversion de RTF en SXC en C# .NET"
      content_left: |
          Suivez ces étapes simples pour convertir RTF en SXC en C# .NET. Affichez le document SXC converti au format HTML sans utiliser de logiciel externe.
    ...
    - title_left: "Ajouter un filigrane au SXC converti en C#"
      content_left: |
          Convertissez avec précision des documents (RTF en SXC) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
