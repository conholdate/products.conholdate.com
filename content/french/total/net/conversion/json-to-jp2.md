...
content:
    enable: true
    block:
    - title_left: "Convertir JSON en JP2 en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de JSON en JP2 dans .NET. Affichez le document JP2 converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
          ...
          -   Créez un objet **Viewer** pour afficher le JP2 converti au format HTML, PDF ou image
