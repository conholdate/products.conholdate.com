...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLAM en JP2 en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XLAM en JP2 dans .NET. Affichez le document JP2 converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
