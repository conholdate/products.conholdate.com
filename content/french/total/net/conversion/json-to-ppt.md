...
content:
    enable: true
    block:
    - title_left: "Convertir JSON en PPT en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de JSON en PPT dans .NET. Affichez le document PPT converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
          ...
          -   Créez un objet **Viewer** pour afficher le PPT converti au format HTML, PDF ou image
