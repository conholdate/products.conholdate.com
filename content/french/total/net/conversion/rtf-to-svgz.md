...
content:
    enable: true
    block:
    - title_left: "Comment convertir RTF en SVGZ en C# .NET"
      content_left: |
          Suivez ces étapes simples pour convertir RTF en SVGZ dans .NET. Affichez le document SVGZ converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
    ...
    - title_left: "Ajouter un texte ou un filigrane d'image à SVGZ en C#"
      content_left: |
          Convertissez avec précision les documents (RTF en SVGZ) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
