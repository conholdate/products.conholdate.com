...
content:
    enable: true
    block:
    - title_left: "Convertir JSON en OTP en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de JSON en OTP dans .NET. Affichez le document OTP converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
          ...
          -   Créez un objet **Viewer** pour afficher le OTP converti au format HTML, PDF ou image
