...
draft: false
path: "fr/total/net/conversion/potx-to-ott/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM CSV DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT OTP ODP ODS EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Convertir POTX en OTT | .NET"
ad_description: "La solution de conversion de documents POTX en OTT la plus précise pour vos applications .NET."

############################# Head ############################
head_title: "Convertir POTX en OTT en C# VB.NET ASP.NET | Conversion de documents"
head_description: "Exemple de code pour convertir POTX en OTT et plus de 100 autres formats de fichiers dans les applications .NET (C#, VB.NET, ASP.NET et .NET Core). Affichez le document OTT converti en tant que visualiseur HTML."

############################# Header ############################
title: "Convertir un fichier POTX en OTT en C# .NET"
description: "Convertissez par programmation POTX en OTT dans les applications C# .NET à l'aide des fonctionnalités flexibles du document conversion pour personnaliser le document résultant. Convertissez le document complet d'un format de fichier à un autre ou choisissez des pages sélectives d'un document source en fonction des numéros de page ou des plages de pages et convertissez facilement en un format de document pris en charge."
...
content:
    enable: true
    block:
    - title_left: "Conversion de POTX en OTT en C# .NET"
      content_left: |
          Suivez ces étapes simples pour convertir POTX en OTT en C# .NET. Affichez le document OTT converti au format HTML sans utiliser de logiciel externe.
    ...
    - title_left: "Ajouter un filigrane au OTT converti en C#"
      content_left: |
          Convertissez avec précision des documents (POTX en OTT) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
