...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLAM en XPS en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XLAM en XPS dans .NET. Affichez le document XPS converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
    ...
    - title_left: "Ajouter un texte ou un filigrane d'image à XPS en C #"
      content_left: |
          Convertissez avec précision des documents (XLAM en XPS) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
