...
content:
    enable: true
    block:
    - title_left: "Convertir MHTML en ODT en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHTML en ODT dans .NET. Affichez le document ODT converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
