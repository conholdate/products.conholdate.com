...
content:
    enable: true
    block:
    - title_left: "Convertir CHM en PDF en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de CHM en PDF dans .NET. Affichez le document PDF converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
