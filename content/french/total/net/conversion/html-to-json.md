...
content:
    enable: true
    block:
    - title_left: "Convertir HTML en JSON en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de HTML en JSON dans .NET. Affichez le document JSON converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
