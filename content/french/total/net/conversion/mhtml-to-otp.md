...
content:
    enable: true
    block:
    - title_left: "Convertir MHTML en OTP en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHTML en OTP dans .NET. Affichez le document OTP converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
