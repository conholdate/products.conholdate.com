...
content:
    enable: true
    block:
    - title_left: "Comment convertir DOTM en HTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour convertir DOTM en HTM dans .NET. Affichez le document HTM converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.

          -   Créer un objet **Converter** pour convertir le document DOTM
          -   Définir les options de conversion pour le format HTM
          -   Appelez la méthode **Convert** de l'instance de classe **Converter** pour la conversion en HTM
    ...
    - title_left: "Ajouter un texte ou un filigrane d'image à HTM en C#"
      content_left: |
          Convertissez avec précision les documents (DOTM en HTM) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
