...
content:
    enable: true
    block:
    - title_left: "Convertir MHTML en POTX en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHTML en POTX dans .NET. Affichez le document POTX converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
