...
content:
    enable: true
    block:
    - title_left: "Convertir XML en JPG en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XML en JPG dans .NET. Affichez le document JPG converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
