...
content:
    enable: true
    block:
    - title_left: "Convertir MHT en WMF en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHT en WMF dans .NET. Affichez le document WMF converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
