...
content:
    enable: true
    block:
    - title_left: "Convertir MHTML en HTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHTML en HTM dans .NET. Affichez le document HTM converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
