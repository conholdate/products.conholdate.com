...
content:
    enable: true
    block:
    - title_left: "Convertir XML en PPSM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XML en PPSM dans .NET. Affichez le document PPSM converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
