...
content:
    enable: true
    block:
    - title_left: "Convertir HTM en RTF en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de HTM en RTF dans .NET. Affichez le document RTF converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
