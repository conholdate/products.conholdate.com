...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLAM en WMZ en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XLAM en WMZ dans .NET. Affichez le document WMZ converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
    ...
    - title_left: "Ajouter un texte ou un filigrane d'image à WMZ en C #"
      content_left: |
          Convertissez avec précision des documents (XLAM en WMZ) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
