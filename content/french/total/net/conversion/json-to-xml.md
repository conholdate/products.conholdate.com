...
content:
    enable: true
    block:
    - title_left: "Convertir JSON en XML en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de JSON en XML dans .NET. Affichez le document XML converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
          ...
          -   Créez un objet **Viewer** pour afficher le XML converti au format HTML, PDF ou image
