...
content:
    enable: true
    block:
    - title_left: "Convertir XML en JP2 en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XML en JP2 dans .NET. Affichez le document JP2 converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
