...
content:
    enable: true
    block:
    - title_left: "Convertir HTML en WMZ en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de HTML en WMZ dans .NET. Affichez le document WMZ converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
