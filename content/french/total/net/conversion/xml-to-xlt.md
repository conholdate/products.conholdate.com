...
content:
    enable: true
    block:
    - title_left: "Convertir XML en XLT en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XML en XLT dans .NET. Affichez le document XLT converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
