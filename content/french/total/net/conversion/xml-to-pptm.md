...
content:
    enable: true
    block:
    - title_left: "Convertir XML en PPTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XML en PPTM dans .NET. Affichez le document PPTM converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
