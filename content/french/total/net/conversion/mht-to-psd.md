...
content:
    enable: true
    block:
    - title_left: "Convertir MHT en PSD en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHT en PSD dans .NET. Affichez le document PSD converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
