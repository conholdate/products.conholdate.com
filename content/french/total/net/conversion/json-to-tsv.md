...
content:
    enable: true
    block:
    - title_left: "Convertir JSON en TSV en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de JSON en TSV dans .NET. Affichez le document TSV converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
