...
content:
    enable: true
    block:
    - title_left: "Convertir HTM en DIF en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de HTM en DIF dans .NET. Affichez le document DIF converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
