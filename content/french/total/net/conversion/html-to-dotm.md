...
content:
    enable: true
    block:
    - title_left: "Convertir HTML en DOTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de HTML en DOTM dans .NET. Affichez le document DOTM converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
