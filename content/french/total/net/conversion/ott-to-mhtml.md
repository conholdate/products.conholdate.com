...
content:
    enable: true
    block:
    - title_left: "Comment convertir OTT en MHTML en C# .NET"
      content_left: |
          Suivez ces étapes simples pour convertir OTT en MHTML dans .NET. Affichez le document MHTML converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.

          -   Créer un objet **Converter** pour convertir le document OTT
    ...
    - title_left: "Ajouter un texte ou un filigrane d'image à MHTML en C#"
      content_left: |
          Convertissez avec précision les documents (OTT en MHTML) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
