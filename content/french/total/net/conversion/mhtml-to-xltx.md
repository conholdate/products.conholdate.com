...
content:
    enable: true
    block:
    - title_left: "Convertir MHTML en XLTX en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHTML en XLTX dans .NET. Affichez le document XLTX converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
