...
content:
    enable: true
    block:
    - title_left: "Convertir HTM en SVGZ en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de HTM en SVGZ dans .NET. Affichez le document SVGZ converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
