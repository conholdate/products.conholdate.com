...
content:
    enable: true
    block:
    - title_left: "Convertir MHT en XLTX en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de MHT en XLTX dans .NET. Affichez le document XLTX converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
