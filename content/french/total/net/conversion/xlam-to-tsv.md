...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLAM en TSV en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XLAM en TSV dans .NET. Affichez le document TSV converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
    ...
    - title_left: "Ajouter un texte ou un filigrane d'image à TSV en C #"
      content_left: |
          Convertissez avec précision des documents (XLAM en TSV) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
