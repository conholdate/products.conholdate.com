...
content:
    enable: true
    block:
    - title_left: "Convertir CHM en MHTML en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de CHM en MHTML dans .NET. Affichez le document MHTML converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
