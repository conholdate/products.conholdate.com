...
content:
    enable: true
    block:
    - title_left: "Convertir CHM en EPUB en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de CHM en EPUB dans .NET. Affichez le document EPUB converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
