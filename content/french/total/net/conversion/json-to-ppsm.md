...
content:
    enable: true
    block:
    - title_left: "Convertir JSON en PPSM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de JSON en PPSM dans .NET. Affichez le document PPSM converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
          ...
          -   Créez un objet **Viewer** pour afficher le PPSM converti au format HTML, PDF ou image
