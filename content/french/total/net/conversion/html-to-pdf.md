...
content:
    ...
    - title_left: "Convertir HTML en PDF en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de HTML en PDF dans .NET. Affichez le document PDF converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
