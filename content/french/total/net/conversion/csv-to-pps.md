...
content:
    enable: true
    block:
    - title_left: "Comment convertir CSV en PPS en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de CSV en PPS dans .NET. Affichez le document PPS converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
    ...
    - title_left: "Ajouter un texte ou un filigrane d'image à PPS en C #"
      content_left: |
          Convertissez avec précision des documents (CSV en PPS) exactement comme le fichier d'origine et appliquez des filigranes de texte ou d'image aux pages de document converties à l'aide de C# .NET.
