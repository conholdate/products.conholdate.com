...
content:
    enable: true
    block:
    - title_left: "Comment convertir XLAM en HTML en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XLAM en HTML dans .NET. Affichez le document HTML converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
