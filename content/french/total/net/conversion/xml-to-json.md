...
content:
    enable: true
    block:
    - title_left: "Convertir XML en JSON en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de XML en JSON dans .NET. Affichez le document JSON converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
          ...
          -   Créez un objet **Viewer** pour afficher le JSON converti au format HTML, PDF ou image
