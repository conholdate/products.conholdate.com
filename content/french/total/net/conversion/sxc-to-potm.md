...
ad_description: "La solution de conversion de documents SXC en POTM la plus précise pour vos applications .NET."

############################# Head ############################
head_title: "Convertir SXC en POTM en C# VB.NET ASP.NET | Conversion de documents"
head_description: "Exemple de code pour convertir SXC en POTM et plus de 100 autres formats de fichiers dans les applications .NET (C#, VB.NET, ASP.NET et .NET Core). Affichez le document POTM converti en tant que visualiseur HTML."

############################# Header ############################
title: "Convertir un fichier SXC en POTM en C# .NET"
description: "Convertissez par programmation SXC en POTM dans les applications C# .NET à l'aide des fonctionnalités flexibles du document conversion pour personnaliser le document résultant. Convertissez le document complet d'un format de fichier à un autre ou choisissez des pages sélectives d'un document source en fonction des numéros de page ou des plages de pages et convertissez facilement en un format de document pris en charge."
...
content:
    enable: true
    block:
    - title_left: "Conversion de SXC en POTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour convertir SXC en POTM en C# .NET. Affichez le document POTM converti au format HTML sans utiliser de logiciel externe.
