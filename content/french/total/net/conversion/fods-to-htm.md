...
content:
    enable: true
    block:
    - title_left: "Comment convertir FODS en HTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de FODS en HTM dans .NET. Affichez le document HTM converti tel quel ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
