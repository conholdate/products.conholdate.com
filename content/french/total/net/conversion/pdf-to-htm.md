...
content:
    enable: true
    block:
    - title_left: "Comment convertir PDF en HTM en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de PDF en HTM dans .NET. Affichez le document converti tel qu'il est ou rendez-le et affichez-le au format HTML sans utiliser de logiciel externe.
