...
content:
    enable: true
    block:
    - title_left: "Convertir JSON en DOT en C# .NET"
      content_left: |
          Suivez ces étapes simples pour la conversion de JSON en DOT dans .NET. Affichez le document DOT converti tel quel ou rendez-le et affichez-le au format HTML, PDF ou une image sans utiliser de logiciel externe.
          ...
          -   Créez un objet **Viewer** pour afficher le DOT converti au format HTML, PDF ou image
