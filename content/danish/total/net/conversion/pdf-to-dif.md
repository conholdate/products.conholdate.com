...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres PDF til DIF i C# .NET"
      content_left: |
          Følg disse enkle trin for PDF til DIF konvertering i .NET. Se det konverterede dokument, som det er, eller gengiv og vis det som HTML uden brug af ekstern software.
