...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres TXT til DIF i C# .NET"
      content_left: |
          Følg disse enkle trin for TXT til DIF konvertering i .NET. Se det konverterede DIF-dokument, som det er, eller gengiv og vis det som HTML uden brug af ekstern software.
    ...
    - title_left: "Tilføj tekst eller billedvandmærke til DIF i C#"
      content_left: |
          Konverter dokumenter (TXT til DIF) nøjagtigt som den originale fil, og anvend tekst- eller billedvandmærker på de konverterede dokumentsider ved hjælp af C# .NET.
