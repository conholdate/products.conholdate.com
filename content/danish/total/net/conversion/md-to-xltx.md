...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres MD til XLTX i C# .NET"
      content_left: |
          Følg disse enkle trin for MD til XLTX konvertering i .NET. Se det konverterede XLTX-dokument, som det er, eller gengiv og vis det som HTML uden brug af ekstern software.
    ...
    - title_left: "Tilføj tekst eller billedvandmærke til XLTX i C#"
      content_left: |
          Konverter dokumenter (MD til XLTX) nøjagtigt som den originale fil, og anvend tekst- eller billedvandmærker på de konverterede dokumentsider ved hjælp af C# .NET.
