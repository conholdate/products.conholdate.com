...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSM til XLTX i Java"
      content_left: |
          Udfør XLSM til XLTX filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSM til XLTX"
      content_left: |
