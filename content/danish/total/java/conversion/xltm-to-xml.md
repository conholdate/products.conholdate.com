...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLTM til XML i Java"
      content_left: |
          Udfør XLTM til XML filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLTM til XML"
      content_left: |
