...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSM til POTM i Java"
      content_left: |
          Udfør XLSM til POTM filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSM til POTM"
      content_left: |
