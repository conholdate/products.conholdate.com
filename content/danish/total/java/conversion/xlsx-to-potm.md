...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSX til POTM i Java"
      content_left: |
          Udfør XLSX til POTM filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs XLSX-filen
          -   Indstil **ConvertOptions** for POTM-dokumenttypen
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSX til POTM"
      content_left: |
