...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSB til JSON i Java"
      content_left: |
          Udfør XLSB til JSON filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSB til JSON"
      content_left: |
