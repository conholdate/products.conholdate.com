...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres EXCEL til JPG i Java"
      content_left: |
          Udfør EXCEL til JPG filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet EXCEL til JPG"
      content_left: |
