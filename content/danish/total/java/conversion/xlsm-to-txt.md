...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSM til TXT i Java"
      content_left: |
          Udfør XLSM til TXT filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSM til TXT"
      content_left: |
