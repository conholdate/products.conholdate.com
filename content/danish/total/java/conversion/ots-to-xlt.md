...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres OTS til XLT i Java"
      content_left: |
          Udfør OTS til XLT filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet OTS til XLT"
      content_left: |
