...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLT til PPSX i Java"
      content_left: |
          Udfør XLT til PPSX filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLT til PPSX"
      content_left: |
