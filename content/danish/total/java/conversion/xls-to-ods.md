...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLS til ODS i Java"
      content_left: |
          Udfør XLS til ODS filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLS til ODS"
      content_left: |
