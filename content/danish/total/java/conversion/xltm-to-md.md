...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLTM til MD i Java"
      content_left: |
          Udfør XLTM til MD filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs XLTM-filen
          -   Indstil **ConvertOptions** for MD-dokumenttypen
    ...
    - title_left: "Konverter adgangskodebeskyttet XLTM til MD"
      content_left: |
