...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres SXC til TIFF i Java"
      content_left: |
          Udfør SXC til TIFF filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet SXC til TIFF"
      content_left: |
