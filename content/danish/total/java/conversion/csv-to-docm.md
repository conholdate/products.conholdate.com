...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres CSV til DOCM i Java"
      content_left: |
          Udfør CSV til DOCM filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet CSV til DOCM"
      content_left: |
