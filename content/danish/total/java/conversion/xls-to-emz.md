...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLS til EMZ i Java"
      content_left: |
          Udfør XLS til EMZ filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLS til EMZ"
      content_left: |
