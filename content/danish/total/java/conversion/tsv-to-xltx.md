...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres TSV til XLTX i Java"
      content_left: |
          Udfør TSV til XLTX filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet TSV til XLTX"
      content_left: |
