...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSX til WMZ i Java"
      content_left: |
          Udfør XLSX til WMZ filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs XLSX-filen
          -   Indstil **ConvertOptions** for WMZ-dokumenttypen
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSX til WMZ"
      content_left: |
