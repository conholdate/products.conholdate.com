...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres SXC til JP2 i Java"
      content_left: |
          Udfør SXC til JP2 filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet SXC til JP2"
      content_left: |
