...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres EXCEL til SVG i Java"
      content_left: |
          Udfør EXCEL til SVG filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet EXCEL til SVG"
      content_left: |
