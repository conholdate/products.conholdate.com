...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres ODS til MHTML i Java"
      content_left: |
          Udfør ODS til MHTML filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet ODS til MHTML"
      content_left: |
