...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSX til TGA i Java"
      content_left: |
          Udfør XLSX til TGA filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSX til TGA"
      content_left: |
