...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres TSV til IMAGE i Java"
      content_left: |
          Udfør TSV til IMAGE filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs TSV-filen
    ...
    - title_left: "Konverter adgangskodebeskyttet TSV til IMAGE"
      content_left: |
