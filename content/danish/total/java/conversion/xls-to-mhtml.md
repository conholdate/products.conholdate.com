...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLS til MHTML i Java"
      content_left: |
          Udfør XLS til MHTML filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs XLS-filen
    ...
    - title_left: "Konverter adgangskodebeskyttet XLS til MHTML"
      content_left: |
