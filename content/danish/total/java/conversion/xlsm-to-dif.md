...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSM til DIF i Java"
      content_left: |
          Udfør XLSM til DIF filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSM til DIF"
      content_left: |
