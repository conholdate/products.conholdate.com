...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres SXC til XLTX i Java"
      content_left: |
          Udfør SXC til XLTX filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet SXC til XLTX"
      content_left: |
