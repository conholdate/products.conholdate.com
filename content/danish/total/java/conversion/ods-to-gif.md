...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres ODS til GIF i Java"
      content_left: |
          Udfør ODS til GIF filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet ODS til GIF"
      content_left: |
