...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres DOCX til TIFF i Java"
      content_left: |
          Udfør DOCX til TIFF filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede MHTML-dokument, som det er, eller gengiv og vis det som HTML uden brug af ekstern software.
