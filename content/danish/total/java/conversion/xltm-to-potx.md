...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLTM til POTX i Java"
      content_left: |
          Udfør XLTM til POTX filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLTM til POTX"
      content_left: |
