...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLAM til PPT i Java"
      content_left: |
          Udfør XLAM til PPT filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLAM til PPT"
      content_left: |
