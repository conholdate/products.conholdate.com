...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres ODS til IMAGE i Java"
      content_left: |
          Udfør ODS til IMAGE filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs ODS-filen
    ...
    - title_left: "Konverter adgangskodebeskyttet ODS til IMAGE"
      content_left: |
