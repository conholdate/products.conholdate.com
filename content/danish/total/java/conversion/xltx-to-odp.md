...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLTX til ODP i Java"
      content_left: |
          Udfør XLTX til ODP filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLTX til ODP"
      content_left: |
