...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLTM til ODS i Java"
      content_left: |
          Udfør XLTM til ODS filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs XLTM-filen
          -   Indstil **ConvertOptions** for ODS-dokumenttypen
    ...
    - title_left: "Konverter adgangskodebeskyttet XLTM til ODS"
      content_left: |
