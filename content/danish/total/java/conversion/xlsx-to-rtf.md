...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSX til RTF i Java"
      content_left: |
          Udfør XLSX til RTF filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.

          -   Opret en ny forekomst af klassen **Converter** og indlæs XLSX-filen
          -   Indstil **ConvertOptions** for RTF-dokumenttypen
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSX til RTF"
      content_left: |
