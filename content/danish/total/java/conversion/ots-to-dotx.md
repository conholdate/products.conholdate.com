...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres OTS til DOTX i Java"
      content_left: |
          Udfør OTS til DOTX filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet OTS til DOTX"
      content_left: |
