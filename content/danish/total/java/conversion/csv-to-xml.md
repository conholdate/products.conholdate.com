...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres CSV til XML i Java"
      content_left: |
          Udfør CSV til XML filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet CSV til XML"
      content_left: |
