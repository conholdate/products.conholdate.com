...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLAM til RTF i Java"
      content_left: |
          Udfør XLAM til RTF filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLAM til RTF"
      content_left: |
