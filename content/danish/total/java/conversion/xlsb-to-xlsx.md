...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres XLSB til XLSX i Java"
      content_left: |
          Udfør XLSB til XLSX filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet XLSB til XLSX"
      content_left: |
