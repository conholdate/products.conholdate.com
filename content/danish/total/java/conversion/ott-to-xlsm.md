...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres OTT til XLSM i Java"
      content_left: |
          Udfør OTT til XLSM filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede MHTML-dokument, som det er, eller gengiv og vis det som HTML uden brug af ekstern software.
