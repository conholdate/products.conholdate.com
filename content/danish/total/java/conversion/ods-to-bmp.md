...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres ODS til BMP i Java"
      content_left: |
          Udfør ODS til BMP filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet ODS til BMP"
      content_left: |
