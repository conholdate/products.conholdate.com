...
content:
    enable: true
    block:
    - title_left: "Sådan konverteres OTS til CSV i Java"
      content_left: |
          Udfør OTS til CSV filkonvertering i Java ved hjælp af tre enkle trin. Se det konverterede dokument, som det er, eller gengiv det for at se det som HTML uden nogen ekstern softwareafhængighed.
    ...
    - title_left: "Konverter adgangskodebeskyttet OTS til CSV"
      content_left: |
