...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar OTT till TIFF i C# .NET"
      content_left: |
          Följ dessa enkla steg för konvertering av OTT till TIFF i .NET. Visa det konverterade TIFF-dokumentet som det är eller rendera och visa det som HTML utan att använda någon extern programvara.
    ...
    - title_left: "Lägg till text eller bildvattenstämpel till TIFF i C#"
      content_left: |
          Konvertera dokument (OTT till TIFF) exakt som originalfilen och använd text- eller bildvattenstämplar på de konverterade dokumentsidorna med C# .NET.
