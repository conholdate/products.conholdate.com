...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar OTT till JP2 i C# .NET"
      content_left: |
          Följ dessa enkla steg för konvertering av OTT till JP2 i .NET. Visa det konverterade JP2-dokumentet som det är eller rendera och visa det som HTML utan att använda någon extern programvara.
    ...
    - title_left: "Lägg till text eller bildvattenstämpel till JP2 i C#"
      content_left: |
          Konvertera dokument (OTT till JP2) exakt som originalfilen och använd text- eller bildvattenstämplar på de konverterade dokumentsidorna med C# .NET.
