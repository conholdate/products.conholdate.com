...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLTM till TIFF i Java"
      content_left: |
          Utför XLTM till TIFF filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLTM till TIFF"
      content_left: |
