...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar CSV till DICOM i Java"
      content_left: |
          Utför CSV till DICOM filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.

          -   Skapa en ny instans av klassen **Converter** och ladda CSV-filen
    ...
    - title_left: "Konvertera lösenordsskyddad CSV till DICOM"
      content_left: |
