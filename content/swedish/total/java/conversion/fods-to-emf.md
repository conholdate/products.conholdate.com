...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar FODS till EMF i Java"
      content_left: |
          Utför FODS till EMF filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad FODS till EMF"
      content_left: |
