...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSB till MD i Java"
      content_left: |
          Utför XLSB till MD filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLSB till MD"
      content_left: |
