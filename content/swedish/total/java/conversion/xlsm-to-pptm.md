...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSM till PPTM i Java"
      content_left: |
          Utför XLSM till PPTM filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLSM till PPTM"
      content_left: |
