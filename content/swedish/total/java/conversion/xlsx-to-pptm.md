...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSX till PPTM i Java"
      content_left: |
          Utför XLSX till PPTM filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLSX till PPTM"
      content_left: |
