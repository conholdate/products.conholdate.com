...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar CSV till OTP i Java"
      content_left: |
          Utför CSV till OTP filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad CSV till OTP"
      content_left: |
