...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSX till PPSX i Java"
      content_left: |
          Utför XLSX till PPSX filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLSX till PPSX"
      content_left: |
