...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLTM till BMP i Java"
      content_left: |
          Utför XLTM till BMP filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLTM till BMP"
      content_left: |
