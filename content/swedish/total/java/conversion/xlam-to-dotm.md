...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLAM till DOTM i Java"
      content_left: |
          Utför XLAM till DOTM filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLAM till DOTM"
      content_left: |
