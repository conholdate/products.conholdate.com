...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar EXCEL till WEB i Java"
      content_left: |
          Utför EXCEL till WEB filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad EXCEL till WEB"
      content_left: |
