...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLTM till DICOM i Java"
      content_left: |
          Utför XLTM till DICOM filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.

          -   Skapa en ny instans av klassen **Converter** och ladda XLTM-filen
    ...
    - title_left: "Konvertera lösenordsskyddad XLTM till DICOM"
      content_left: |
