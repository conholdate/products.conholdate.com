...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar OTS till IMAGE i Java"
      content_left: |
          Utför OTS till IMAGE filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.

          -   Skapa en ny instans av klassen **Converter** och ladda OTS-filen
    ...
    - title_left: "Konvertera lösenordsskyddad OTS till IMAGE"
      content_left: |
