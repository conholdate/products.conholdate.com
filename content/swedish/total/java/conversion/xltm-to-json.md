...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLTM till JSON i Java"
      content_left: |
          Utför XLTM till JSON filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.

          -   Skapa en ny instans av klassen **Converter** och ladda XLTM-filen
          -   Ställ in **ConvertOptions** för JSON-dokumenttypen
    ...
    - title_left: "Konvertera lösenordsskyddad XLTM till JSON"
      content_left: |
