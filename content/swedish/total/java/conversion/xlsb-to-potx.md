...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSB till POTX i Java"
      content_left: |
          Utför XLSB till POTX filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLSB till POTX"
      content_left: |
