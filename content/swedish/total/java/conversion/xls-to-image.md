...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLS till IMAGE i Java"
      content_left: |
          Utför XLS till IMAGE filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.

          -   Skapa en ny instans av klassen **Converter** och ladda XLS-filen
    ...
    - title_left: "Konvertera lösenordsskyddad XLS till IMAGE"
      content_left: |
