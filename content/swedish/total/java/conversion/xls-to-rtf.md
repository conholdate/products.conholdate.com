...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLS till RTF i Java"
      content_left: |
          Utför XLS till RTF filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLS till RTF"
      content_left: |
