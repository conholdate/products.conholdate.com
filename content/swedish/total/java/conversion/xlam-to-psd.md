...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLAM till PSD i Java"
      content_left: |
          Utför XLAM till PSD filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLAM till PSD"
      content_left: |
