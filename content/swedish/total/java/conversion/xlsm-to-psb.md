...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSM till PSB i Java"
      content_left: |
          Utför XLSM till PSB filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLSM till PSB"
      content_left: |
