...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar OTS till JSON i Java"
      content_left: |
          Utför OTS till JSON filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad OTS till JSON"
      content_left: |
