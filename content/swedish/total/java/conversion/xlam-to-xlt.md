...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLAM till XLT i Java"
      content_left: |
          Utför XLAM till XLT filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLAM till XLT"
      content_left: |
