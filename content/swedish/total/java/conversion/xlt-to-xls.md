...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLT till XLS i Java"
      content_left: |
          Utför XLT till XLS filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLT till XLS"
      content_left: |
