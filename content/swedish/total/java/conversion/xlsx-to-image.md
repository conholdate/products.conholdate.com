...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSX till IMAGE i Java"
      content_left: |
          Utför XLSX till IMAGE filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.

          -   Skapa en ny instans av klassen **Converter** och ladda XLSX-filen
    ...
    - title_left: "Konvertera lösenordsskyddad XLSX till IMAGE"
      content_left: |
