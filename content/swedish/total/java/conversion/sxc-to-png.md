...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar SXC till PNG i Java"
      content_left: |
          Utför SXC till PNG filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad SXC till PNG"
      content_left: |
