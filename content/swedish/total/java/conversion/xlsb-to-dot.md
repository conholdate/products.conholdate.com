...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLSB till DOT i Java"
      content_left: |
          Utför XLSB till DOT filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLSB till DOT"
      content_left: |
