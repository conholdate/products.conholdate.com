...
content:
    enable: true
    block:
    - title_left: "Hur man konverterar XLTX till TXT i Java"
      content_left: |
          Utför XLTX till TXT filkonvertering i Java med tre enkla steg. Visa det konverterade dokumentet som det är eller återge det för att visa det som HTML utan något externt programberoende.
    ...
    - title_left: "Konvertera lösenordsskyddad XLTX till TXT"
      content_left: |
