...
content:
    enable: true
    block:
    - title_left: "Como converter DOC para EMZ em Java"
      content_left: |
          Execute a conversão de arquivos DOC para EMZ em Java usando três etapas simples. Visualize o documento MHTML convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
