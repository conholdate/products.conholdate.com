...
content:
    enable: true
    block:
    - title_left: "Como converter XLTM para XLAM em Java"
      content_left: |
          Execute a conversão de arquivos XLTM para XLAM em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLTM protegido por senha para XLAM"
      content_left: |
