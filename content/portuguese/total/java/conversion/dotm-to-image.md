...
content:
    enable: true
    block:
    - title_left: "Como converter DOTM para IMAGE em Java"
      content_left: |
          Execute a conversão de arquivos DOTM para IMAGE em Java usando três etapas simples. Visualize o documento MHTML convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo DOTM
