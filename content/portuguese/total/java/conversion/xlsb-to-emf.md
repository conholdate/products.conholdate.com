...
content:
    enable: true
    block:
    - title_left: "Como converter XLSB para EMF em Java"
      content_left: |
          Execute a conversão de arquivos XLSB para EMF em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo XLSB
          -   Defina **ConvertOptions** para o tipo de documento EMF
    ...
    - title_left: "Converter XLSB protegido por senha para EMF"
      content_left: |
