...
content:
    enable: true
    block:
    - title_left: "Como converter XLTM para POTX em Java"
      content_left: |
          Execute a conversão de arquivos XLTM para POTX em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLTM protegido por senha para POTX"
      content_left: |
