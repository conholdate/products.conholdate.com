...
content:
    enable: true
    block:
    - title_left: "Como converter SXC para JSON em Java"
      content_left: |
          Execute a conversão de arquivos SXC para JSON em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter SXC protegido por senha para JSON"
      content_left: |
