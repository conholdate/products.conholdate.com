...
content:
    enable: true
    block:
    - title_left: "Como converter XLSB para TEX em Java"
      content_left: |
          Execute a conversão de arquivos XLSB para TEX em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLSB protegido por senha para TEX"
      content_left: |
