...
content:
    enable: true
    block:
    - title_left: "Como converter FODS para WEBP em Java"
      content_left: |
          Execute a conversão de arquivos FODS para WEBP em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter FODS protegido por senha para WEBP"
      content_left: |
