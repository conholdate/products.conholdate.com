...
content:
    enable: true
    block:
    - title_left: "Como converter ODS para DICOM em Java"
      content_left: |
          Execute a conversão de arquivos ODS para DICOM em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo ODS
    ...
    - title_left: "Converter ODS protegido por senha para DICOM"
      content_left: |
