...
content:
    enable: true
    block:
    - title_left: "Como converter OTS para PPTM em Java"
      content_left: |
          Execute a conversão de arquivos OTS para PPTM em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter OTS protegido por senha para PPTM"
      content_left: |
