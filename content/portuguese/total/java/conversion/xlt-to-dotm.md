...
content:
    enable: true
    block:
    - title_left: "Como converter XLT para DOTM em Java"
      content_left: |
          Execute a conversão de arquivos XLT para DOTM em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLT protegido por senha para DOTM"
      content_left: |
