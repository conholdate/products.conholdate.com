...
content:
    enable: true
    block:
    - title_left: "Como converter CSV para DOCX em Java"
      content_left: |
          Execute a conversão de arquivos CSV para DOCX em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter CSV protegido por senha para DOCX"
      content_left: |
