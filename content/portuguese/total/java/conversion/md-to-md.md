...
content:
    enable: true
    block:
    - title_left: "Como converter MD para MD em Java"
      content_left: |
          Execute a conversão de arquivos MD para MD em Java usando três etapas simples. Visualize o documento MHTML convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
