...
content:
    enable: true
    block:
    - title_left: "Como converter XLSM para MD em Java"
      content_left: |
          Execute a conversão de arquivos XLSM para MD em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLSM protegido por senha para MD"
      content_left: |
