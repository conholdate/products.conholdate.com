...
content:
    enable: true
    block:
    - title_left: "Como converter XLSM para JP2 em Java"
      content_left: |
          Execute a conversão de arquivos XLSM para JP2 em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLSM protegido por senha para JP2"
      content_left: |
