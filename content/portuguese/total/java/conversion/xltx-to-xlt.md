...
content:
    enable: true
    block:
    - title_left: "Como converter XLTX para XLT em Java"
      content_left: |
          Execute a conversão de arquivos XLTX para XLT em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLTX protegido por senha para XLT"
      content_left: |
