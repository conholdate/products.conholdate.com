...
content:
    enable: true
    block:
    - title_left: "Como converter FODS para DICOM em Java"
      content_left: |
          Execute a conversão de arquivos FODS para DICOM em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo FODS
    ...
    - title_left: "Converter FODS protegido por senha para DICOM"
      content_left: |
