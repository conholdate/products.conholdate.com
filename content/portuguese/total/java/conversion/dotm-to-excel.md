...
content:
    enable: true
    block:
    - title_left: "Como converter DOTM para EXCEL em Java"
      content_left: |
          Execute a conversão de arquivos DOTM para EXCEL em Java usando três etapas simples. Visualize o documento MHTML convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo DOTM
          -   Defina **ConvertOptions** para o tipo de documento EXCEL
          -   Chame o método **Convert** da instância de classe **Converter** para conversão em EXCEL
          -   Definir opções para visualizador de HTML
          -   Crie o objeto **Viewer** para visualizar o EXCEL convertido como HTML
