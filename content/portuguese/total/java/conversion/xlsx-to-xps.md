...
content:
    enable: true
    block:
    - title_left: "Como converter XLSX para XPS em Java"
      content_left: |
          Execute a conversão de arquivos XLSX para XPS em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLSX protegido por senha para XPS"
      content_left: |
