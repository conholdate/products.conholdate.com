...
content:
    enable: true
    block:
    - title_left: "Como converter SXC para XLSX em Java"
      content_left: |
          Execute a conversão de arquivos SXC para XLSX em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter SXC protegido por senha para XLSX"
      content_left: |
