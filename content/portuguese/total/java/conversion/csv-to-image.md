...
content:
    enable: true
    block:
    - title_left: "Como converter CSV para IMAGE em Java"
      content_left: |
          Execute a conversão de arquivos CSV para IMAGE em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo CSV
    ...
    - title_left: "Converter CSV protegido por senha para IMAGE"
      content_left: |
