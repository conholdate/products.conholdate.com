...
content:
    enable: true
    block:
    - title_left: "Como converter CSV para TIFF em Java"
      content_left: |
          Execute a conversão de arquivos CSV para TIFF em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter CSV protegido por senha para TIFF"
      content_left: |
