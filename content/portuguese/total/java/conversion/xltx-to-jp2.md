...
content:
    enable: true
    block:
    - title_left: "Como converter XLTX para JP2 em Java"
      content_left: |
          Execute a conversão de arquivos XLTX para JP2 em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLTX protegido por senha para JP2"
      content_left: |
