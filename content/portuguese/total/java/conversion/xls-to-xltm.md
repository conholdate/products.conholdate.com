...
content:
    enable: true
    block:
    - title_left: "Como converter XLS para XLTM em Java"
      content_left: |
          Execute a conversão de arquivos XLS para XLTM em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLS protegido por senha para XLTM"
      content_left: |
