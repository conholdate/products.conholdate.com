...
content:
    enable: true
    block:
    - title_left: "Como converter ODS para PPSX em Java"
      content_left: |
          Execute a conversão de arquivos ODS para PPSX em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter ODS protegido por senha para PPSX"
      content_left: |
