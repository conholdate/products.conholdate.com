...
content:
    enable: true
    block:
    - title_left: "Como converter XLSX para ICO em Java"
      content_left: |
          Execute a conversão de arquivos XLSX para ICO em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo XLSX
          -   Defina **ConvertOptions** para o tipo de documento ICO
    ...
    - title_left: "Converter XLSX protegido por senha para ICO"
      content_left: |
