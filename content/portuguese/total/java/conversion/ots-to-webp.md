...
content:
    enable: true
    block:
    - title_left: "Como converter OTS para WEBP em Java"
      content_left: |
          Execute a conversão de arquivos OTS para WEBP em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
