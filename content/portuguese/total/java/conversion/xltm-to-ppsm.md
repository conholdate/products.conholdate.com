...
content:
    enable: true
    block:
    - title_left: "Como converter XLTM para PPSM em Java"
      content_left: |
          Execute a conversão de arquivos XLTM para PPSM em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter XLTM protegido por senha para PPSM"
      content_left: |
