...
content:
    enable: true
    block:
    - title_left: "Como converter EXCEL para MHT em Java"
      content_left: |
          Execute a conversão de arquivos EXCEL para MHT em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.
    ...
    - title_left: "Converter EXCEL protegido por senha para MHT"
      content_left: |
