...
content:
    enable: true
    block:
    - title_left: "Como converter TSV para IMAGE em Java"
      content_left: |
          Execute a conversão de arquivos TSV para IMAGE em Java usando três etapas simples. Visualize o documento convertido como está ou renderize-o para visualização como HTML sem qualquer dependência de software externo.

          -   Crie uma nova instância da classe **Converter** e carregue o arquivo TSV
    ...
    - title_left: "Converter TSV protegido por senha para IMAGE"
      content_left: |
