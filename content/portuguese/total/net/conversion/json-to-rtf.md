...
draft: false
path: "pt/total/net/conversion/json-to-rtf/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para RTF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para RTF em .NET. Visualize o documento RTF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
