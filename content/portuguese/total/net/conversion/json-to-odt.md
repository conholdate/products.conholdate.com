...
draft: false
path: "pt/total/net/conversion/json-to-odt/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para ODT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para ODT em .NET. Visualize o documento ODT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
