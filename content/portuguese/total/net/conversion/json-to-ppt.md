...
draft: false
path: "pt/total/net/conversion/json-to-ppt/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PPT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PPT em .NET. Visualize o documento PPT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
