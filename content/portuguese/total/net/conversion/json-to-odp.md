...
draft: false
path: "pt/total/net/conversion/json-to-odp/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para ODP em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para ODP em .NET. Visualize o documento ODP convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
