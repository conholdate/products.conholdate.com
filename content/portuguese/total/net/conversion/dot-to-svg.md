...
content:
    enable: true
    block:
    - title_left: "Como converter DOT para SVG em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de DOT para SVG em .NET. Visualize o documento SVG convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao SVG em C #"
      content_left: |
          Converta documentos com precisão (DOT para SVG) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
