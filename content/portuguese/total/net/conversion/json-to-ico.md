...
draft: false
path: "pt/total/net/conversion/json-to-ico/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para ICO em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para ICO em .NET. Visualize o documento ICO convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
