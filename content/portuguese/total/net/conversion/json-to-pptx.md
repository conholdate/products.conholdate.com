...
draft: false
path: "pt/total/net/conversion/json-to-pptx/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PPTX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PPTX em .NET. Visualize o documento PPTX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
