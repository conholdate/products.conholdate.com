...
draft: false
path: "pt/total/net/conversion/json-to-pps/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PPS em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PPS em .NET. Visualize o documento PPS convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
