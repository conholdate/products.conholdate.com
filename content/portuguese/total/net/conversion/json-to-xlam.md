...
draft: false
path: "pt/total/net/conversion/json-to-xlam/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLAM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLAM em .NET. Visualize o documento XLAM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
