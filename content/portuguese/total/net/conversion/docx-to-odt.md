...
content:
    enable: true
    block:
    - title_left: "Como converter DOCX para ODT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de DOCX para ODT em .NET. Visualize o documento ODT convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao ODT em C #"
      content_left: |
          Converta documentos com precisão (DOCX para ODT) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
