...
draft: false
path: "pt/total/net/conversion/chm-to-gif/"
...
content:
    enable: true
    block:
    - title_left: "Converter CHM para GIF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de CHM para GIF em .NET. Visualize o documento GIF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
