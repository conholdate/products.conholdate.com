...
draft: false
path: "pt/total/net/conversion/json-to-png/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PNG em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PNG em .NET. Visualize o documento PNG convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
