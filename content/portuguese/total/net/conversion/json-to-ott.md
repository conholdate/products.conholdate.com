...
draft: false
path: "pt/total/net/conversion/json-to-ott/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para OTT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para OTT em .NET. Visualize o documento OTT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
