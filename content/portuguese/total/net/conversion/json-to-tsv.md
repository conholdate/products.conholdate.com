...
draft: false
path: "pt/total/net/conversion/json-to-tsv/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para TSV em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para TSV em .NET. Visualize o documento TSV convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
