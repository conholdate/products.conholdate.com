...
draft: false
path: "pt/total/net/conversion/json-to-epub/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para EPUB em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para EPUB em .NET. Visualize o documento EPUB convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
