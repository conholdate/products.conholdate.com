...
content:
    enable: true
    block:
    - title_left: "Como converter XLAM para DOTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de XLAM para DOTM em .NET. Visualize o documento DOTM convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao DOTM em C #"
      content_left: |
          Converta documentos com precisão (XLAM para DOTM) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
