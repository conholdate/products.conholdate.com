...
draft: false
path: "pt/total/net/conversion/json-to-emf/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para EMF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para EMF em .NET. Visualize o documento EMF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
