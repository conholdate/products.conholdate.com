...
draft: false
path: "pt/total/net/conversion/json-to-htm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para HTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para HTM em .NET. Visualize o documento HTM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
