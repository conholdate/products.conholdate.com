...
draft: false
path: "pt/total/net/conversion/json-to-xls/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLS em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLS em .NET. Visualize o documento XLS convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
