...
draft: false
path: "pt/total/net/conversion/csv-to-xlam/"
other_out_formats: "PDF DOC DOCX DOCM DOT DOTX DOTM TXT RTF HTML HTM MHTML MHT XLS XLSX XLSM XLSB XLT XLTX XLTM XLAM CSV TSV DIF SXC FODS PPT PPTX PPS PPSX PPSM POT POTX PPTM POTM ODT OTT OTP ODP ODS EMZ WMZ SVG SVGZ XPS TEX DCM WMF EMF BMP PNG GIF JPEG TIFF ICO WEBP JP2 TGA PSB PSD EPUB MD XML JSON DICOM FODP JPG"
ad_headline: "Converter CSV para XLAM | .NET"
ad_description: "A solução mais precisa de conversão de documentos CSV para XLAM para seus aplicativos .NET."

############################# Head ############################
head_title: "Converter CSV do Excel para XLAM em C# ASP.NET | Conversão de Documentos .NET"
head_description: "API de conversão de formatos de documento de planilha .NET Excel. Converta CSV para XLAM e mais de 100 outras imagens e formatos de arquivo de documento em aplicativos .NET (C#, VB.NET, ASP.NET e .NET Core)."

############################# Header ############################
title: "Converter arquivo Excel (CSV) para XLAM em C# .NET"
description: "Use a API nativa do conversor de documentos do Excel para converter CSV para XLAM em aplicativos C# VB.NET e ASP.NET. Trabalhe com recursos flexíveis de conversão de documentos para personalizar a aparência do documento resultante. Converta com precisão todos os formatos populares de planilhas do Excel de e para documentos do Word, apresentações do PowerPoint, PDF, Photoshop, eBook, formatos de arquivo da Web e de imagem. Converta todo o documento ou escolha páginas específicas do arquivo de documento de origem com base nos números de página ou intervalos de página seletivos e converta facilmente para um formato de documento compatível."
...
content:
    enable: true
    block:
    - title_left: "Como converter CSV para XLAM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de CSV para XLAM em .NET. Visualize o documento XLAM convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao XLAM em C #"
      content_left: |
          Converta documentos com precisão (CSV para XLAM) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
