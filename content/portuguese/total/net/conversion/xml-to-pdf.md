...
draft: false
path: "pt/total/net/conversion/xml-to-pdf/"
...
content:
    enable: true
    block:
    - title_left: "Converter XML para PDF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de XML para PDF em .NET. Visualize o documento PDF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
