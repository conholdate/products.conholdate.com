...
draft: false
path: "pt/total/net/conversion/json-to-fods/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para FODS em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para FODS em .NET. Visualize o documento FODS convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
