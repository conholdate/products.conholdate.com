...
content:
    enable: true
    block:
    - title_left: "Como converter WORD para TIFF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de WORD para TIFF em .NET. Visualize o documento TIFF convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao TIFF em C #"
      content_left: |
          Converta documentos com precisão (WORD para TIFF) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
