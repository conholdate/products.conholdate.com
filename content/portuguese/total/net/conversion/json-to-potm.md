...
draft: false
path: "pt/total/net/conversion/json-to-potm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para POTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para POTM em .NET. Visualize o documento POTM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
