...
content:
    enable: true
    block:
    - title_left: "Como converter WORD para PDF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de WORD para PDF em .NET. Visualize o documento PDF convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao PDF em C #"
      content_left: |
          Converta documentos com precisão (WORD para PDF) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
