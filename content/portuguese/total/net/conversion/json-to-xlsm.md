...
draft: false
path: "pt/total/net/conversion/json-to-xlsm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLSM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLSM em .NET. Visualize o documento XLSM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
