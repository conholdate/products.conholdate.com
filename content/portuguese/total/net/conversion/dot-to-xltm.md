...
content:
    enable: true
    block:
    - title_left: "Como converter DOT para XLTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de DOT para XLTM em .NET. Visualize o documento XLTM convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao XLTM em C #"
      content_left: |
          Converta documentos com precisão (DOT para XLTM) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
