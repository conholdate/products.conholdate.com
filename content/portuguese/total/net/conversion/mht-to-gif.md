...
draft: false
path: "pt/total/net/conversion/mht-to-gif/"
...
content:
    enable: true
    block:
    - title_left: "Converter MHT para GIF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de MHT para GIF em .NET. Visualize o documento GIF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
