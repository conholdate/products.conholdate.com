...
draft: false
path: "pt/total/net/conversion/json-to-wmf/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para WMF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para WMF em .NET. Visualize o documento WMF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
