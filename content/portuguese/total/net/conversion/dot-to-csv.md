...
content:
    enable: true
    block:
    - title_left: "Como converter DOT para CSV em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de DOT para CSV em .NET. Visualize o documento CSV convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao CSV em C #"
      content_left: |
          Converta documentos com precisão (DOT para CSV) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
