...
draft: false
path: "pt/total/net/conversion/json-to-dot/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DOT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DOT em .NET. Visualize o documento DOT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
