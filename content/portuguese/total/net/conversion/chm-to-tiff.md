...
draft: false
path: "pt/total/net/conversion/chm-to-tiff/"
...
content:
    enable: true
    block:
    - title_left: "Converter CHM para TIFF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de CHM para TIFF em .NET. Visualize o documento TIFF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
