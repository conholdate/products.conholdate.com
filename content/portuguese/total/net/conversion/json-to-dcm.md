...
draft: false
path: "pt/total/net/conversion/json-to-dcm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DCM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DCM em .NET. Visualize o documento DCM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
