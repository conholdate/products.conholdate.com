...
draft: false
path: "pt/total/net/conversion/json-to-xlt/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLT em .NET. Visualize o documento XLT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
