...
draft: false
path: "pt/total/net/conversion/json-to-doc/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DOC em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DOC em .NET. Visualize o documento DOC convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
