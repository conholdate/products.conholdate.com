...
draft: false
path: "pt/total/net/conversion/json-to-ppsm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PPSM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PPSM em .NET. Visualize o documento PPSM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
