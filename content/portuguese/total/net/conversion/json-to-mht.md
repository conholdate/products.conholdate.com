...
draft: false
path: "pt/total/net/conversion/json-to-mht/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para MHT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para MHT em .NET. Visualize o documento MHT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
