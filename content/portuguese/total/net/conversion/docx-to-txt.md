...
content:
    enable: true
    block:
    - title_left: "Como converter DOCX para TXT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de DOCX para TXT em .NET. Visualize o documento TXT convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao TXT em C #"
      content_left: |
          Converta documentos com precisão (DOCX para TXT) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
