...
draft: false
path: "pt/total/net/conversion/json-to-pdf/"
...
ad_headline: "Converter JSON para PDF | .NET"
ad_description: "A solução mais precisa de conversão de documentos JSON para PDF para seus aplicativos .NET."

############################# Head ############################
head_title: "A solução mais precisa de conversão de documentos JSON para PDF para seus aplicativos .NET."
head_description: "C# .NET JSON para API de conversão PDF. Converta JSON para PDF, Word, Excel, PowerPoint, imagens e mais de 100 outros formatos de arquivo em aplicativos .NET (C#, VB.NET, ASP.NET e .NET Core)."

############################# Header ############################
title: "Converter JSON para PDF em C# .NET Core"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PDF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PDF em .NET. Visualize o documento PDF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
