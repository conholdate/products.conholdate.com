...
content:
    enable: true
    block:
    - title_left: "Como converter XLAM para POTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de XLAM para POTM em .NET. Visualize o documento POTM convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao POTM em C #"
      content_left: |
          Converta documentos com precisão (XLAM para POTM) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
