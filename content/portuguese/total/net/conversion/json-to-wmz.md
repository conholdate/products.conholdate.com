...
draft: false
path: "pt/total/net/conversion/json-to-wmz/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para WMZ em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para WMZ em .NET. Visualize o documento WMZ convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
