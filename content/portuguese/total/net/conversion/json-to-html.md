...
draft: false
path: "pt/total/net/conversion/json-to-html/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para HTML em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para HTML em .NET. Visualize o documento HTML convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
