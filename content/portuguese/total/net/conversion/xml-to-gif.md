...
draft: false
path: "pt/total/net/conversion/xml-to-gif/"
...
content:
    enable: true
    block:
    - title_left: "Converter XML para GIF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de XML para GIF em .NET. Visualize o documento GIF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
