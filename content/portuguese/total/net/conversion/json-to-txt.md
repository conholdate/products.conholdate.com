...
draft: false
path: "pt/total/net/conversion/json-to-txt/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para TXT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para TXT em .NET. Visualize o documento TXT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
