...
draft: false
path: "pt/total/net/conversion/htm-to-pdf/"
...
content:
    enable: true
    block:
    - title_left: "Converter HTM para PDF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de HTM para PDF em .NET. Visualize o documento PDF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
