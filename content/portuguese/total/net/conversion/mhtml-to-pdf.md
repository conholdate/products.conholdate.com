...
draft: false
path: "pt/total/net/conversion/mhtml-to-pdf/"
...
content:
    enable: true
    block:
    - title_left: "Converter MHTML para PDF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de MHTML para PDF em .NET. Visualize o documento PDF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
          ...
          -   Crie um objeto **Viewer** para visualizar o PDF convertido como HTML, PDF ou imagem
