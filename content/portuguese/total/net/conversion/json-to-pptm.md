...
draft: false
path: "pt/total/net/conversion/json-to-pptm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PPTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PPTM em .NET. Visualize o documento PPTM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
