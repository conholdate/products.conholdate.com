...
draft: false
path: "pt/total/net/conversion/json-to-psd/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PSD em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PSD em .NET. Visualize o documento PSD convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
