...
content:
    enable: true
    block:
    - title_left: "Como converter DOCX para WMF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de DOCX para WMF em .NET. Visualize o documento WMF convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao WMF em C #"
      content_left: |
          Converta documentos com precisão (DOCX para WMF) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
