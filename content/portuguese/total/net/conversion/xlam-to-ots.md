...
content:
    enable: true
    block:
    - title_left: "Como converter XLAM para OTS em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de XLAM para OTS em .NET. Visualize o documento OTS convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao OTS em C #"
      content_left: |
          Converta documentos com precisão (XLAM para OTS) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
