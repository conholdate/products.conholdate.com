...
draft: false
path: "pt/total/net/conversion/json-to-docm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DOCM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DOCM em .NET. Visualize o documento DOCM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
