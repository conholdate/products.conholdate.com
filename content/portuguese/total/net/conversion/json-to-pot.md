...
draft: false
path: "pt/total/net/conversion/json-to-pot/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para POT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para POT em .NET. Visualize o documento POT convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
