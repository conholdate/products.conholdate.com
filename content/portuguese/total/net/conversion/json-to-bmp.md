...
draft: false
path: "pt/total/net/conversion/json-to-bmp/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para BMP em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para BMP em .NET. Visualize o documento BMP convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
