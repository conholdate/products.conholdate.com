...
draft: false
path: "pt/total/net/conversion/json-to-word/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para WORD em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para WORD em .NET. Visualize o documento WORD convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
