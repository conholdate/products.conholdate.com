...
draft: false
path: "pt/total/net/conversion/json-to-xlsb/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLSB em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLSB em .NET. Visualize o documento XLSB convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
