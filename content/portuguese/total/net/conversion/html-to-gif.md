...
draft: false
path: "pt/total/net/conversion/html-to-gif/"
...
content:
    enable: true
    block:
    - title_left: "Converter HTML para GIF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de HTML para GIF em .NET. Visualize o documento GIF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
