...
content:
    enable: true
    block:
    - title_left: "Como converter OTT para GIF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de OTT para GIF em .NET. Visualize o documento GIF convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao GIF em C #"
      content_left: |
          Converta documentos com precisão (OTT para GIF) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
