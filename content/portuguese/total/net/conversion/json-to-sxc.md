...
draft: false
path: "pt/total/net/conversion/json-to-sxc/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para SXC em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para SXC em .NET. Visualize o documento SXC convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
