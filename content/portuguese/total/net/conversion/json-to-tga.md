...
draft: false
path: "pt/total/net/conversion/json-to-tga/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para TGA em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para TGA em .NET. Visualize o documento TGA convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
