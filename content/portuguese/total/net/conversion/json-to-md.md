...
draft: false
path: "pt/total/net/conversion/json-to-md/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para MD em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para MD em .NET. Visualize o documento MD convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
