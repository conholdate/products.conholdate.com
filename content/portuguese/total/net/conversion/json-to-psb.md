...
draft: false
path: "pt/total/net/conversion/json-to-psb/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PSB em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PSB em .NET. Visualize o documento PSB convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
