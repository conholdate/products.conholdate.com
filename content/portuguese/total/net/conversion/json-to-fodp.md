...
draft: false
path: "pt/total/net/conversion/json-to-fodp/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para FODP em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para FODP em .NET. Visualize o documento FODP convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
