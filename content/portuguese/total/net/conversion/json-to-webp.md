...
draft: false
path: "pt/total/net/conversion/json-to-webp/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para WEBP em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para WEBP em .NET. Visualize o documento WEBP convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
