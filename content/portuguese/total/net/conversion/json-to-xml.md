...
draft: false
path: "pt/total/net/conversion/json-to-xml/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XML em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XML em .NET. Visualize o documento XML convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
