...
draft: false
path: "pt/total/net/conversion/json-to-csv/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para CSV em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para CSV em .NET. Visualize o documento CSV convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
