...
draft: false
path: "pt/total/net/conversion/json-to-ods/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para ODS em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para ODS em .NET. Visualize o documento ODS convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
