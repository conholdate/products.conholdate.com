...
draft: false
path: "pt/total/net/conversion/json-to-emz/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para EMZ em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para EMZ em .NET. Visualize o documento EMZ convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
