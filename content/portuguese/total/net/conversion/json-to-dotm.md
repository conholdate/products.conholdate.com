...
draft: false
path: "pt/total/net/conversion/json-to-dotm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DOTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DOTM em .NET. Visualize o documento DOTM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
