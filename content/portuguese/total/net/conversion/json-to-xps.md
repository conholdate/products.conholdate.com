...
draft: false
path: "pt/total/net/conversion/json-to-xps/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XPS em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XPS em .NET. Visualize o documento XPS convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
