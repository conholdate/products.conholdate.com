...
draft: false
path: "pt/total/net/conversion/json-to-docx/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DOCX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DOCX em .NET. Visualize o documento DOCX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
