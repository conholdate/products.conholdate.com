...
draft: false
path: "pt/total/net/conversion/json-to-mhtml/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para MHTML em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para MHTML em .NET. Visualize o documento MHTML convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
