...
draft: false
path: "pt/total/net/conversion/json-to-image/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para IMAGE em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para IMAGE em .NET. Visualize o documento IMAGE convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
