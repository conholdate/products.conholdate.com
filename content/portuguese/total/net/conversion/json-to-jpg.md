...
draft: false
path: "pt/total/net/conversion/json-to-jpg/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para JPG em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para JPG em .NET. Visualize o documento JPG convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
