...
draft: false
path: "pt/total/net/conversion/json-to-xlsx/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLSX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLSX em .NET. Visualize o documento XLSX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
