...
content:
    enable: true
    block:
    - title_left: "Como converter XLAM para XLT em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de XLAM para XLT em .NET. Visualize o documento XLT convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao XLT em C #"
      content_left: |
          Converta documentos com precisão (XLAM para XLT) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
