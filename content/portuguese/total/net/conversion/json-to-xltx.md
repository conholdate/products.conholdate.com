...
draft: false
path: "pt/total/net/conversion/json-to-xltx/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLTX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLTX em .NET. Visualize o documento XLTX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
