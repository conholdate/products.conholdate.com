...
draft: false
path: "pt/total/net/conversion/json-to-ppsx/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para PPSX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para PPSX em .NET. Visualize o documento PPSX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
