...
draft: false
path: "pt/total/net/conversion/json-to-svgz/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para SVGZ em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para SVGZ em .NET. Visualize o documento SVGZ convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
