...
draft: false
path: "pt/total/net/conversion/json-to-jpeg/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para JPEG em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para JPEG em .NET. Visualize o documento JPEG convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
