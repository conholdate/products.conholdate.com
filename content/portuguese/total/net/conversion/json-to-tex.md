...
draft: false
path: "pt/total/net/conversion/json-to-tex/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para TEX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para TEX em .NET. Visualize o documento TEX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
