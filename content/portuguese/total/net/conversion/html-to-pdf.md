...
draft: false
path: "pt/total/net/conversion/html-to-pdf/"
...
content:
    ...
    - title_left: "Converter HTML para PDF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de HTML para PDF em .NET. Visualize o documento PDF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
