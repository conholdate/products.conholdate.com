...
draft: false
path: "pt/total/net/conversion/json-to-xltm/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para XLTM em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para XLTM em .NET. Visualize o documento XLTM convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
