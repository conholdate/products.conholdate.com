...
draft: false
path: "pt/total/net/conversion/json-to-potx/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para POTX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para POTX em .NET. Visualize o documento POTX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
