...
content:
    enable: true
    block:
    - title_left: "Como converter XLAM para XLS em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de XLAM para XLS em .NET. Visualize o documento XLS convertido como está ou renderize e exiba como HTML sem usar nenhum software externo.
    ...
    - title_left: "Adicionar marca d'água de texto ou imagem ao XLS em C #"
      content_left: |
          Converta documentos com precisão (XLAM para XLS) exatamente como o arquivo original e aplique marcas d'água de texto ou imagem às páginas do documento convertido usando C# .NET.
