...
draft: false
path: "pt/total/net/conversion/json-to-dif/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DIF em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DIF em .NET. Visualize o documento DIF convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
