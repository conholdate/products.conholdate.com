...
draft: false
path: "pt/total/net/conversion/json-to-dotx/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para DOTX em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para DOTX em .NET. Visualize o documento DOTX convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
