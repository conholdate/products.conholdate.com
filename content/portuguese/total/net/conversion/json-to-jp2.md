...
draft: false
path: "pt/total/net/conversion/json-to-jp2/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para JP2 em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para JP2 em .NET. Visualize o documento JP2 convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
