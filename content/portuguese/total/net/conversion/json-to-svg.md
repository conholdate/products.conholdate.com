...
draft: false
path: "pt/total/net/conversion/json-to-svg/"
...
content:
    enable: true
    block:
    - title_left: "Converter JSON para SVG em C# .NET"
      content_left: |
          Siga estes passos simples para conversão de JSON para SVG em .NET. Visualize o documento SVG convertido como está ou renderize e exiba como HTML, PDF ou uma imagem sem usar nenhum software externo.
