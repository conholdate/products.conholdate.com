...
############################# Head ############################
head_title: "Add Digital Signatures to XLSX File in C#, VB.NET, Xamarin"
head_description: "Digitally add signatures to Excel spreadsheet (XLSX) and 100+ other file formats in C# .NET. View the signed file in HTML using Conholdate.Total for .NET APIs."

############################# Header ############################
title: "Digitally Add Signatures to XLSX in .NET"
description: "Digitally sign and verify signatures in Excel spreadsheet (XLSX) formats within your C#, ASP.NET, VB.NET & Xamarin applications. Implement Barcode, Text, Image, Metadata, QR Code, Form Field and stamp signatures in multiple forms by setting up customized text, font style, colors and adjusting advanced e-signatures properties in the document."
...
steps:
    enable: true
    title_left: "C# Code to Digitally Sign a XLSX File"
    content_left: |
    ...
    code: |
        ```cs
        // Add digital e-signatures to Excel Worksheet (XLSX) file using GroupDocs.Signature API
        // Instantiate Signature with input XLSX document
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-excel-o"
          title: " About Excel XLSX File Format"
          content: |
