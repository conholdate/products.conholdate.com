...
############################# Head ############################
head_title: "Add Digital Signatures to OTS File Viewer in C#, VB.NET"
head_description: "Digitally add signatures to an OpenDocument Spreadsheet template file (OTS) and 100+ other file formats in C# .NET. View the signed file in HTML using Conholdate.Total for .NET APIs."

############################# Header ############################
title: "Digitally Add Signatures to OTS Viewer"
description: "Digitally sign and verify signatures in an OpenDocument Spreadsheet template file (OTS) within your C#, ASP.NET, VB.NET & Xamarin applications. Implement Barcode, Text, Image, Metadata, QR Code, Form Field and stamp signatures in multiple forms by setting up customized text, font style, colors and adjusting advanced e-signatures properties in the document."
...
steps:
    enable: true
    title_left: "C# Code to Digitally Sign a OTS File"
    content_left: |
        [Conholdate.Total for .NET](https://products.conholdate.com/total/net/) supports signing an OpenDocument Spreadsheet template file (OTS) with digital signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add digital e-signatures to OTS file using GroupDocs.Signature API
        // Instantiate Signature with input OTS document
        using (Signature signature = new Signature("input.ots"))
          {
          ...
          signature.Sign("output.ots", options);

          // Set options to view signed document as HTML
          HtmlViewOptions viewOptions = HtmlViewOptions.forEmbeddedResources("output{0}.html");
          try (Viewer viewer = new Viewer("output.ots")) {
