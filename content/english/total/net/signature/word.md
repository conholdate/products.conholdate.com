...
############################# Head ############################
head_title: "Add Digital Signatures to Word File Viewer in C#, VB.NET"
head_description: "Digitally add signatures to Word processing documents and 100+ other file formats in C# .NET. View the signed file in HTML using Conholdate.Total for .NET APIs."

############################# Header ############################
title: "Digitally Add Signatures to Word Viewer"
...
steps:
    enable: true
    title_left: "C# Code to Digitally Sign a Word File"
    content_left: |
        [Conholdate.Total for .NET](https://products.conholdate.com/total/net/) supports signing Word documents with digital signatures using a few lines of C# .NET code.
