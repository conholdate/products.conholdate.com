...
############################# Head ############################
head_title: "Add Digital Signatures to DOCX File Viewer in C#, VB.NET"
head_description: "Digitally add signatures to Word processing documents (DOCX) and 100+ other file formats in C# .NET. View the signed file in HTML using Conholdate.Total for .NET APIs."

############################# Header ############################
title: "Digitally Add Signatures to DOCX Viewer"
description: "Digitally sign and verify signatures in Word processing document formats within your C#, ASP.NET, VB.NET & Xamarin applications. Implement Barcode, Text, Image, Metadata, QR Code, Form Field and stamp signatures in multiple forms by setting up customized text, font style, colors and adjusting advanced e-signatures properties in the document."
...
steps:
    enable: true
    title_left: "C# Code to Digitally Sign a DOCX File"
    content_left: |
        [Conholdate.Total for .NET](https://products.conholdate.com/total/net/) supports signing Word (DOCX) documents with digital signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add digital e-signatures to Word Processing (DOCX) file using GroupDocs.Signature API
        // Instantiate Signature with input DOCX document
