...
head_description: "Add 65+ barcode images to GIF file format in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."
...
steps:
    enable: true
    title_left: ".NET Code to Add Barcodes to GIF"
    content_left: |
    ...
    content_right: |
        ...
        Insert barcodes to a GIF file on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
