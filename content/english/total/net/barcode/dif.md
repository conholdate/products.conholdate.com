...
steps:
    enable: true
    title_left: ".NET Code to Add Barcodes to DIF"
    content_left: |
    ...
    content_right: |
        ...
        Insert barcodes to a DIF file on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
