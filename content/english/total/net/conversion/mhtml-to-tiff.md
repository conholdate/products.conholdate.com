...
ad_headline: "Convert MHTML to TIFF | .NET"
ad_description: "Most Accurate MHTML to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MHTML to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MHTML to TIFF in .NET & View as HTML"
...
content:
    ...
    - title_left: "MHTML to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MHTML to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
