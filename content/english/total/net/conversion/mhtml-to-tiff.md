...
content:
    enable: true
    block:
    - title_left: "Convert MHTML to TIFF in C# .NET"
      content_left: |
          Follow these simple steps for MHTML to TIFF conversion in .NET. View the converted TIFF document as it is or render and display it as HTML, PDF or an image without using any external software.
          ...
          -   Create **Viewer** object to view converted TIFF as HTML, PDF or image
