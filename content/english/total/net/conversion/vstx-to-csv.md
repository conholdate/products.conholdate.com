...
ad_headline: "Convert VSTX to CSV | .NET"
ad_description: "Most Accurate VSTX to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VSTX to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VSTX to CSV in C#"
      content_left: |
          Follow these simple steps to convert VSTX to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
