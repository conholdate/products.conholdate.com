...
content:
    enable: true
    block:
    - title_left: "How to Convert RTF to DOT in C# .NET"
      content_left: |
          Follow these simple steps for RTF to DOT conversion in .NET. View the converted DOT document as it is or render and display it as HTML without using any external software.
