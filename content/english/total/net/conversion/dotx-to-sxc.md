...
content:
    enable: true
    block:
    - title_left: "How to Convert DOTX to SXC in C# .NET"
      content_left: |
          Follow these simple steps for DOTX to SXC conversion in .NET. View the converted SXC document as it is or render and display it as HTML without using any external software.
