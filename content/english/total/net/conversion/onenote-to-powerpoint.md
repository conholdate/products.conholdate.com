...
############################# Header ############################
title: "Convert ONENOTE to POWERPOINT in C# & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "ONENOTE to POWERPOINT Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert ONENOTE to POWERPOINT in C# .NET. View the converted POWERPOINT document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to Converted POWERPOINT in C#"
      content_left: |
          Accurately convert documents (ONENOTE to POWERPOINT) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET.
