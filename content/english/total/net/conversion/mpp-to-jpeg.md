...
ad_headline: "Convert MPP to JPEG | .NET"
ad_description: "Most Accurate MPP to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPP to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPP to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPP to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPP to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
