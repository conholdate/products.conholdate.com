...
ad_headline: "Convert FODP to CSV | .NET"
ad_description: "Most Accurate FODP to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert FODP to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "FODP to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODP to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
