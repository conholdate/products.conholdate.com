...
content:
    enable: true
    block:
    - title_left: "How to Convert MD to WMF in C# .NET"
      content_left: |
          Follow these simple steps for MD to WMF conversion in .NET. View the converted WMF document as it is or render and display it as HTML without using any external software.
