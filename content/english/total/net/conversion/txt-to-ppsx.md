...
content:
    enable: true
    block:
    - title_left: "How to Convert TXT to PPSX in C# .NET"
      content_left: |
          Follow these simple steps for TXT to PPSX conversion in .NET. View the converted PPSX document as it is or render and display it as HTML without using any external software.
