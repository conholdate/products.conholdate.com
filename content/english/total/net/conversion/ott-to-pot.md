...
content:
    enable: true
    block:
    - title_left: "How to Convert OTT to POT in C# .NET"
      content_left: |
          Follow these simple steps for OTT to POT conversion in .NET. View the converted POT document as it is or render and display it as HTML without using any external software.
