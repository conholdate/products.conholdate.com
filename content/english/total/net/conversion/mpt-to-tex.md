...
ad_headline: "Convert MPT to TEX | .NET"
ad_description: "Most Accurate MPT to TEX document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPT to TEX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPT to TEX in .NET & View as HTML"
description: "Programmatically convert MPT to TEX in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    ...
    - title_left: "MPT to TEX Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPT to TEX in C# .NET. View the converted TEX document as HTML without using any external software.
