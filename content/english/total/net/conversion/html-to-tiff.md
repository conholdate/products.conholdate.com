...
############################# Head ############################
head_title: "Convert HTML to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert HTML to TIFF in .NET & View as HTML"
...
content:
    ...
    - title_left: "HTML to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert HTML to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
