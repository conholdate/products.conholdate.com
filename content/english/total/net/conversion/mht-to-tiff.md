...
ad_headline: "Convert MHT to TIFF | .NET"
ad_description: "Most Accurate MHT to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MHT to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "MHT to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MHT to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
