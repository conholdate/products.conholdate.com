...
############################# Head ############################
head_title: "Convert FODS to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert FODS to TIFF in .NET & View as HTML"
...
content:
    ...
    - title_left: "FODS to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
