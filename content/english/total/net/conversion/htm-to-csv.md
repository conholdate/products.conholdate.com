...
content:
    enable: true
    block:
    - title_left: "Convert HTM to CSV in C# .NET"
      content_left: |
          Follow these simple steps for HTM to CSV conversion in .NET. View the converted CSV document as it is or render and display it as HTML, PDF or an image without using any external software.
