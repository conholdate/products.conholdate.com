...
############################# Head ############################
head_title: "Convert DOC to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DOC to TIFF in .NET & View as HTML"
...
content:
    ...
    - title_left: "DOC to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert DOC to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
