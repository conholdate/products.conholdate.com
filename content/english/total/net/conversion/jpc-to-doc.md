...
ad_headline: "Convert JPC to DOC | .NET"
ad_description: "Most Accurate JPC to DOC document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JPC to DOC in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert JPC to DOC in .NET & View as HTML"
description: "Programmatically convert JPC to DOC in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert JPC to DOC in C#"
      content_left: |
          Follow these simple steps to convert JPC to DOC in C# .NET. View the converted DOC document as HTML without using any external software.
