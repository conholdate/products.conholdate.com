...
ad_headline: "Convert MPT to JPEG | .NET"
ad_description: "Most Accurate MPT to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPT to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPT to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPT to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPT to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
