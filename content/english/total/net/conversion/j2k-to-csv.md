...
ad_headline: "Convert J2K to CSV | .NET"
ad_description: "Most Accurate J2K to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert J2K to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert J2K to CSV in C#"
      content_left: |
          Follow these simple steps to convert J2K to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
