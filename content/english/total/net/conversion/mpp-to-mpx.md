...
ad_headline: "Convert MPP to MPX | .NET"
ad_description: "Most Accurate MPP to MPX document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPP to MPX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPP to MPX in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPP to MPX Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPP to MPX in C# .NET. View the converted MPX document as HTML without using any external software.
