...
ad_headline: "Convert DXF to CSV | .NET"
ad_description: "Most Accurate DXF to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert DXF to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert DXF to CSV in C#"
      content_left: |
          Follow these simple steps to convert DXF to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
