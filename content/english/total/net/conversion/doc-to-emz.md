...
content:
    enable: true
    block:
    - title_left: "How to Convert DOC to EMZ in C# .NET"
      content_left: |
          Follow these simple steps for DOC to EMZ conversion in .NET. View the converted EMZ document as it is or render and display it as HTML without using any external software.
