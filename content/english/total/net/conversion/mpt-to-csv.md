...
ad_headline: "Convert MPT to CSV | .NET"
ad_description: "Most Accurate MPT to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPT to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "MPT to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPT to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
