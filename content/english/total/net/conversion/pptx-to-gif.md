...
ad_headline: "Convert PPTX to GIF | .NET"
ad_description: "Most Accurate PPTX to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPTX to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPTX to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPTX to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPTX to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
