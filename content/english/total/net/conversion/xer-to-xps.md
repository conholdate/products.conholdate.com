...
ad_headline: "Convert XER to XPS | .NET"
ad_description: "Most Accurate XER to XPS document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert XER to XPS in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert XER to XPS in .NET & View as HTML"
description: "Programmatically convert XER to XPS in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    ...
    - title_left: "XER to XPS Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XER to XPS in C# .NET. View the converted XPS document as HTML without using any external software.
