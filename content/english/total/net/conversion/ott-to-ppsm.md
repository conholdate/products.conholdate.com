...
content:
    enable: true
    block:
    - title_left: "How to Convert OTT to PPSM in C# .NET"
      content_left: |
          Follow these simple steps for OTT to PPSM conversion in .NET. View the converted PPSM document as it is or render and display it as HTML without using any external software.
