...
content:
    enable: true
    block:
    - title_left: "How to Convert RTF to PSD in C# .NET"
      content_left: |
          Follow these simple steps for RTF to PSD conversion in .NET. View the converted PSD document as it is or render and display it as HTML without using any external software.
