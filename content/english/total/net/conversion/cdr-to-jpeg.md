...
ad_headline: "Convert CDR to JPEG | .NET"
ad_description: "Most Accurate CDR to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert CDR to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert CDR to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert CDR to JPEG in C#"
      content_left: |
          Follow these simple steps to convert CDR to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
