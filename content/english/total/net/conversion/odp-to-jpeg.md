...
ad_headline: "Convert ODP to JPEG | .NET"
ad_description: "Most Accurate ODP to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert ODP to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert ODP to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "ODP to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert ODP to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
