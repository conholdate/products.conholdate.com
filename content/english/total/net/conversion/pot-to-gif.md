...
ad_headline: "Convert POT to GIF | .NET"
ad_description: "Most Accurate POT to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert POT to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert POT to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "POT to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert POT to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
