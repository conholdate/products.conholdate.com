...
ad_headline: "Convert POTX to GIF | .NET"
ad_description: "Most Accurate POTX to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert POTX to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert POTX to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "POTX to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert POTX to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
