...
ad_headline: "Convert FODP to GIF | .NET"
ad_description: "Most Accurate FODP to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert FODP to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert FODP to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "FODP to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODP to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
