...
ad_headline: "Convert OTG to JPEG | .NET"
ad_description: "Most Accurate OTG to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert OTG to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert OTG to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert OTG to JPEG in C#"
      content_left: |
          Follow these simple steps to convert OTG to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
