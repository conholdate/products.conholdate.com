...
ad_headline: "Convert DWF to JPEG | .NET"
ad_description: "Most Accurate DWF to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert DWF to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DWF to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert DWF to JPEG in C#"
      content_left: |
          Follow these simple steps to convert DWF to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
