...
content:
    enable: true
    block:
    - title_left: "EMAIL to EBOOK Conversion"
      content_left: |
          Follow these simple steps for EMAIL to EBOOK conversion in C# .NET. View the converted EBOOK document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to EBOOK File in C#"
      content_left: |
          Accurately convert documents (EMAIL to EBOOK) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET code.
