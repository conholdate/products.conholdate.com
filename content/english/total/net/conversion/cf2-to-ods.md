...
ad_headline: "Convert CF2 to ODS | .NET"
ad_description: "Most Accurate CF2 to ODS document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert CF2 to ODS in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert CF2 to ODS in .NET & View as HTML"
description: "Programmatically convert CF2 to ODS in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert CF2 to ODS in C#"
      content_left: |
          Follow these simple steps to convert CF2 to ODS in C# .NET. View the converted ODS document as HTML without using any external software.
