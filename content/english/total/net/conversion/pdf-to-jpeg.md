...
############################# Head ############################
head_title: "Convert PDF to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PDF to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "PDF to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PDF to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
