...
content:
    enable: true
    block:
    - title_left: "How to Convert DOCX to ICO in C# .NET"
      content_left: |
          Follow these simple steps for DOCX to ICO conversion in .NET. View the converted ICO document as it is or render and display it as HTML without using any external software.
