...
content:
    enable: true
    block:
    - title_left: "How to Convert MD to XPS in C# .NET"
      content_left: |
          Follow these simple steps for MD to XPS conversion in .NET. View the converted XPS document as it is or render and display it as HTML without using any external software.
