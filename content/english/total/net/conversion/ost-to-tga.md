...
############################# Head ############################
head_title: "Convert OST to TGA in C# VB.NET & View as HTML"
...
############################# Header ############################
title: "Convert OST to TGA & View as HTML"
description: "Programmatically convert OST to TGA in .NET applications using flexible options to customize the resultant document. Convert the complete document or specific pages based on page numbers or selective page ranges using the .NET document conversion library."
...
content:
    enable: true
    block:
    - title_left: "OST to TGA Conversion in C# .NET"
      content_left: |
          OST to TGA file conversion using C#. Add watermark and view the converted document as HTML without using any external software.
      ...
      code: |
          ```cs {linenos=false}
          // Convert OST to TGA using GroupDocs.Conversion API
          // Create Converter object to convert OST document
