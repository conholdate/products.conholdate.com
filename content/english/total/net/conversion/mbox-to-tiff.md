...
ad_headline: "Convert MBOX to TIFF | .NET"
ad_description: "Most Accurate MBOX to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert MBOX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert MBOX to TIFF in C#"
      content_left: |
          Follow these simple steps to convert MBOX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
