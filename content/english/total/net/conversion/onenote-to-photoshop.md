...
content:
    enable: true
    block:
    - title_left: "ONENOTE to PHOTOSHOP Conversion"
      content_left: |
          Follow these simple steps for ONENOTE to PHOTOSHOP conversion in C# .NET. View the converted PHOTOSHOP document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to PHOTOSHOP File in C#"
      content_left: |
          Accurately convert documents (ONENOTE to PHOTOSHOP) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET code.
