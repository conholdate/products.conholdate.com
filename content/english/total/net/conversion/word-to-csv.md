...
content:
    enable: true
    block:
    - title_left: "How to Convert WORD to CSV in C# .NET"
      content_left: |
          Follow these simple steps for WORD to CSV conversion in .NET. View the converted CSV document as it is or render and display it as HTML without using any external software.
    ...
    - title_left: "Add Text or Image Watermark to CSV in C#"
      content_left: |
          Accurately convert documents (WORD to CSV) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET.
