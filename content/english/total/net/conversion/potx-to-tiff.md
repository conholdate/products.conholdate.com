...
ad_headline: "Convert POTX to TIFF | .NET"
ad_description: "Most Accurate POTX to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert POTX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "POTX to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert POTX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
