...
ad_headline: "Convert MPX to JPEG | .NET"
ad_description: "Most Accurate MPX to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPX to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPX to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPX to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPX to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
