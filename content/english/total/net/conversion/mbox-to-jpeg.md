...
ad_headline: "Convert MBOX to JPEG | .NET"
ad_description: "Most Accurate MBOX to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert MBOX to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MBOX to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert MBOX to JPEG in C#"
      content_left: |
          Follow these simple steps to convert MBOX to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
