...
ad_headline: "Convert ODP to CSV | .NET"
ad_description: "Most Accurate ODP to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert ODP to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "ODP to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert ODP to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
