...
content:
    enable: true
    block:
    - title_left: "How to Convert TXT to XLSB in C# .NET"
      content_left: |
          Follow these simple steps for TXT to XLSB conversion in .NET. View the converted XLSB document as it is or render and display it as HTML without using any external software.
