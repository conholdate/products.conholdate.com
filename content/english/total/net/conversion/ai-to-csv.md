...
ad_headline: "Convert AI to CSV | .NET"
ad_description: "Most Accurate AI to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert AI to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert AI to CSV in C#"
      content_left: |
          Follow these simple steps to convert AI to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
