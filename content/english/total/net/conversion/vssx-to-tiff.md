...
ad_headline: "Convert VSSX to TIFF | .NET"
ad_description: "Most Accurate VSSX to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VSSX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VSSX to TIFF in C#"
      content_left: |
          Follow these simple steps to convert VSSX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
