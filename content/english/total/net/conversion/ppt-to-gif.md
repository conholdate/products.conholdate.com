...
ad_headline: "Convert PPT to GIF | .NET"
ad_description: "Most Accurate PPT to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPT to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPT to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPT to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPT to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
