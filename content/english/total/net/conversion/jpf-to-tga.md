...
ad_headline: "Convert JPF to TGA | .NET"
ad_description: "Most Accurate JPF to TGA document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JPF to TGA in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert JPF to TGA in .NET & View as HTML"
description: "Programmatically convert JPF to TGA in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert JPF to TGA in C#"
      content_left: |
          Follow these simple steps to convert JPF to TGA in C# .NET. View the converted TGA document as HTML without using any external software.
