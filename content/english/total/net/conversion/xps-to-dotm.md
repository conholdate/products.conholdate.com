...
ad_headline: "Convert XPS to DOTM | .NET"
ad_description: "Most Accurate XPS to DOTM document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert XPS to DOTM in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert XPS to DOTM in .NET & View as HTML"
description: "Programmatically convert XPS to DOTM in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert XPS to DOTM in C#"
      content_left: |
          Follow these simple steps to convert XPS to DOTM in C# .NET. View the converted DOTM document as HTML without using any external software.
