...
ad_headline: "Convert XML to CSV | .NET"
ad_description: "Most Accurate XML to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert XML to CSV in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert XML to CSV in .NET & View as HTML"
...
content:
    ...
    - title_left: "XML to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XML to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
