...
ad_headline: "Convert PPTM to GIF | .NET"
ad_description: "Most Accurate PPTM to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPTM to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPTM to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPTM to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPTM to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
