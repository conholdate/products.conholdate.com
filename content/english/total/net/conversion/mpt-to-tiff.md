...
ad_headline: "Convert MPT to TIFF | .NET"
ad_description: "Most Accurate MPT to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPT to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "MPT to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPT to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
