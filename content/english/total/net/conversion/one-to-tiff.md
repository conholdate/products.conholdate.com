...
ad_headline: "Convert ONE to TIFF | .NET"
ad_description: "Most Accurate ONE to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert ONE to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert ONE to TIFF in C#"
      content_left: |
          Follow these simple steps to convert ONE to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
