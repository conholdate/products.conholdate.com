...
############################# Head ############################
head_title: "Convert FODS to DOTM in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert FODS to DOTM and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted DOTM document as HTML viewer."

############################# Header ############################
title: "Convert FODS to DOTM in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "FODS to DOTM Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to DOTM in C# .NET. View the converted DOTM document as HTML without using any external software.
