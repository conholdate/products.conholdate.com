...
ad_headline: "Convert MPX to CSV | .NET"
ad_description: "Most Accurate MPX to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPX to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "MPX to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPX to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
