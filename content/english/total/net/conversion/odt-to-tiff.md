...
content:
    enable: true
    block:
    - title_left: "How to Convert ODT to TIFF in C# .NET"
      content_left: |
          Follow these simple steps for ODT to TIFF conversion in .NET. View the converted TIFF document as it is or render and display it as HTML without using any external software.
    ...
    - title_left: "Add Text or Image Watermark to TIFF in C#"
      content_left: |
          Accurately convert documents (ODT to TIFF) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET.
