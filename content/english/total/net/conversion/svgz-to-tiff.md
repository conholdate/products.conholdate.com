...
ad_headline: "Convert SVGZ to TIFF | .NET"
ad_description: "Most Accurate SVGZ to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert SVGZ to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert SVGZ to TIFF in C#"
      content_left: |
          Follow these simple steps to convert SVGZ to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
