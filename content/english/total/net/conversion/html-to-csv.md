...
ad_headline: "Convert HTML to CSV | .NET"
ad_description: "Most Accurate HTML to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert HTML to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "HTML to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert HTML to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
