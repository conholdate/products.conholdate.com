...
ad_headline: "Convert PCL to CSV | .NET"
ad_description: "Most Accurate PCL to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert PCL to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert PCL to CSV in C#"
      content_left: |
          Follow these simple steps to convert PCL to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
