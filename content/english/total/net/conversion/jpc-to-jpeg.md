...
ad_headline: "Convert JPC to JPEG | .NET"
ad_description: "Most Accurate JPC to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JPC to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert JPC to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert JPC to JPEG in C#"
      content_left: |
          Follow these simple steps to convert JPC to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
