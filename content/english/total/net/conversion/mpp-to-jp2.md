...
ad_headline: "Convert MPP to JP2 | .NET"
ad_description: "Most Accurate MPP to JP2 document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPP to JP2 in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPP to JP2 in .NET & View as HTML"
description: "Programmatically convert MPP to JP2 in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    ...
    - title_left: "MPP to JP2 Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPP to JP2 in C# .NET. View the converted JP2 document as HTML without using any external software.
