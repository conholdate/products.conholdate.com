...
ad_headline: "Convert PPSX to GIF | .NET"
ad_description: "Most Accurate PPSX to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPSX to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPSX to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPSX to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPSX to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
