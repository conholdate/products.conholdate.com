...
ad_headline: "Convert PPS to GIF | .NET"
ad_description: "Most Accurate PPS to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPS to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPS to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPS to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPS to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
