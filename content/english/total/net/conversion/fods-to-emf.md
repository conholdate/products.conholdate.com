...
############################# Head ############################
head_title: "Convert FODS to EMF in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert FODS to EMF and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted EMF document as HTML viewer."

############################# Header ############################
title: "Convert FODS to EMF in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "FODS to EMF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to EMF in C# .NET. View the converted EMF document as HTML without using any external software.
