...
content:
    enable: true
    block:
    - title_left: "How to Convert OTT to DOC in C# .NET"
      content_left: |
          Follow these simple steps for OTT to DOC conversion in .NET. View the converted DOC document as it is or render and display it as HTML without using any external software.
