...
ad_headline: "Convert VSDX to JPEG | .NET"
ad_description: "Most Accurate VSDX to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VSDX to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VSDX to JPEG in C#"
      content_left: |
          Follow these simple steps to convert VSDX to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
