...
############################# Head ############################
head_title: "Convert DOC to PPTX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DOC to PPTX in .NET & View as HTML"
...
content:
    ...
    - title_left: "DOC to PPTX Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert DOC to PPTX in C# .NET. View the converted PPTX document as HTML without using any external software.
