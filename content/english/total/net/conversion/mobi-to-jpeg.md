...
ad_headline: "Convert MOBI to JPEG | .NET"
ad_description: "Most Accurate MOBI to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert MOBI to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert MOBI to JPEG in C#"
      content_left: |
          Follow these simple steps to convert MOBI to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
