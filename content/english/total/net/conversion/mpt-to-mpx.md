...
ad_headline: "Convert MPT to MPX | .NET"
ad_description: "Most Accurate MPT to MPX document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPT to MPX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPT to MPX in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPT to MPX Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPT to MPX in C# .NET. View the converted MPX document as HTML without using any external software.
