...
content:
    enable: true
    block:
    - title_left: "How to Convert TXT to XLS in C# .NET"
      content_left: |
          Follow these simple steps for TXT to XLS conversion in .NET. View the converted XLS document as it is or render and display it as HTML without using any external software.
