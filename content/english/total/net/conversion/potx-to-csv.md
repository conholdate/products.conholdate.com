...
ad_headline: "Convert POTX to CSV | .NET"
ad_description: "Most Accurate POTX to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert POTX to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "POTX to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert POTX to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
