...
ad_headline: "Convert JLS to TIFF | .NET"
ad_description: "Most Accurate JLS to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JLS to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert JLS to TIFF in C#"
      content_left: |
          Follow these simple steps to convert JLS to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
