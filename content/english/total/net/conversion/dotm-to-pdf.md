...
content:
    enable: true
    block:
    - title_left: "How to Convert DOTM to PDF in C# .NET"
      content_left: |
          Follow these simple steps for DOTM to PDF conversion in .NET. View the converted PDF document as it is or render and display it as HTML without using any external software.
