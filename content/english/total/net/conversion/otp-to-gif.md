...
ad_headline: "Convert OTP to GIF | .NET"
ad_description: "Most Accurate OTP to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert OTP to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert OTP to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "OTP to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert OTP to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
