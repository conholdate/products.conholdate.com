...
ad_headline: "Convert ODP to GIF | .NET"
ad_description: "Most Accurate ODP to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert ODP to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert ODP to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "ODP to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert ODP to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
