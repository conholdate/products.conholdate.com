...
content:
    enable: true
    block:
    - title_left: "How to Convert ODT to DOTX in C# .NET"
      content_left: |
          Follow these simple steps for ODT to DOTX conversion in .NET. View the converted DOTX document as it is or render and display it as HTML without using any external software.
