...
content:
    enable: true
    block:
    - title_left: "How to Convert DOCX to XLTM in C# .NET"
      content_left: |
          Follow these simple steps for DOCX to XLTM conversion in .NET. View the converted XLTM document as it is or render and display it as HTML without using any external software.
