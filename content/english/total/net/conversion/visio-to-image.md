...
############################# Header ############################
title: "Convert VISIO to IMAGE in C# & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "VISIO to IMAGE Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert VISIO to IMAGE in C# .NET. View the converted IMAGE document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to Converted IMAGE in C#"
      content_left: |
          Accurately convert documents (VISIO to IMAGE) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET.
