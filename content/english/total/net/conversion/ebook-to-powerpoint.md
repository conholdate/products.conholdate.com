...
############################# Header ############################
title: "Convert EBOOK to POWERPOINT in C#"
...
content:
    enable: true
    block:
    - title_left: "EBOOK to POWERPOINT Conversion"
      content_left: |
          Follow these simple steps for EBOOK to POWERPOINT conversion in C# .NET. View the converted POWERPOINT document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to POWERPOINT File in C#"
      content_left: |
          Accurately convert documents (EBOOK to POWERPOINT) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET code.
