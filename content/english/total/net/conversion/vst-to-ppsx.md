...
ad_headline: "Convert VST to PPSX | .NET"
ad_description: "Most Accurate VST to PPSX document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VST to PPSX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert VST to PPSX in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VST to PPSX in C#"
      content_left: |
          Follow these simple steps to convert VST to PPSX in C# .NET. View the converted PPSX document as HTML without using any external software.
