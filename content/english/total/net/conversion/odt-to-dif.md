...
content:
    enable: true
    block:
    - title_left: "How to Convert ODT to DIF in C# .NET"
      content_left: |
          Follow these simple steps for ODT to DIF conversion in .NET. View the converted DIF document as it is or render and display it as HTML without using any external software.
