...
############################# Head ############################
head_title: "Convert FODS to MHTML in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert FODS to MHTML and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted MHTML document as HTML viewer."

############################# Header ############################
title: "Convert FODS to MHTML in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "FODS to MHTML Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to MHTML in C# .NET. View the converted MHTML document as HTML without using any external software.
