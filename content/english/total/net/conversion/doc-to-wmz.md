...
content:
    enable: true
    block:
    - title_left: "How to Convert DOC to WMZ in C# .NET"
      content_left: |
          Follow these simple steps for DOC to WMZ conversion in .NET. View the converted WMZ document as it is or render and display it as HTML without using any external software.
