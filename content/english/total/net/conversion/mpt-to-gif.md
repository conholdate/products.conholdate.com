...
ad_headline: "Convert MPT to GIF | .NET"
ad_description: "Most Accurate MPT to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPT to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPT to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPT to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPT to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
