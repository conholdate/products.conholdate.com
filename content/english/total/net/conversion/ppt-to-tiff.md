...
ad_headline: "Convert PPT to TIFF | .NET"
ad_description: "Most Accurate PPT to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPT to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPT to TIFF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPT to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPT to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
