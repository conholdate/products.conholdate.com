...
ad_headline: "Convert JPC to CSV | .NET"
ad_description: "Most Accurate JPC to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JPC to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert JPC to CSV in C#"
      content_left: |
          Follow these simple steps to convert JPC to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
