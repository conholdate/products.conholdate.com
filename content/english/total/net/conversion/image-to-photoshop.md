...
ad_headline: "Convert IMAGE to PHOTOSHOP | .NET"
ad_description: "Most Accurate IMAGE to PHOTOSHOP document Conversion solution for your .NET applications."
...
content:
    enable: true
    block:
    - title_left: "IMAGE to PHOTOSHOP Conversion"
      content_left: |
          Follow these simple steps for IMAGE to PHOTOSHOP conversion in C# .NET. View the converted PHOTOSHOP document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to PHOTOSHOP File in C#"
      content_left: |
          Accurately convert documents (IMAGE to PHOTOSHOP) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET code.
