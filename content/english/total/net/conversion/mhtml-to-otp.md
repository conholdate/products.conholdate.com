...
############################# Head ############################
head_title: "MHTML -to-OTP.NET - Convert MHTML to OTP in C# .NET"
head_description: "C# .NET MHTML to OTP conversion API. Convert MHTML to PDF, Word, Excel, PowerPoint, images and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications."

############################# Header ############################
title: "Convert MHTML to OTP in C# .NET Core"
description: "C# .NET documents & images conversion API to convert MHTML to OTP in C# .NET applications. Work with advance document conversion features to customize the appearance of the converted document. Easily convert all popular web file formats to and from Word documents, Excel worksheets, PowerPoint presentations, PDF, Photoshop, eBook and images. Programmatically convert the complete document or choose some specific pages of the source document file based on the selective page numbers or page ranges and easily convert to a wide range of supported document formats."
...
content:
    enable: true
    block:
    - title_left: "Convert MHTML to OTP in C# .NET"
      content_left: |
          Follow these simple steps for MHTML to OTP conversion in .NET. View the converted OTP document as it is or render and display it as HTML, PDF or an image without using any external software.
          ...
          -   Create **Viewer** object to view converted OTP as HTML, PDF or image
