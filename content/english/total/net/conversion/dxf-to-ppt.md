...
ad_headline: "Convert DXF to PPT | .NET"
ad_description: "Most Accurate DXF to PPT document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert DXF to PPT in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DXF to PPT in .NET & View as HTML"
description: "Programmatically convert DXF to PPT in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert DXF to PPT in C#"
      content_left: |
          Follow these simple steps to convert DXF to PPT in C# .NET. View the converted PPT document as HTML without using any external software.
