...
ad_headline: "Convert PPT to JPEG | .NET"
ad_description: "Most Accurate PPT to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPT to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPT to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPT to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPT to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
