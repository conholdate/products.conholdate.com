...
content:
    enable: true
    block:
    - title_left: "How to Convert DOTX to DCM in C# .NET"
      content_left: |
          Follow these simple steps for DOTX to DCM conversion in .NET. View the converted DCM document as it is or render and display it as HTML without using any external software.
