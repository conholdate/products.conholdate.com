...
content:
    enable: true
    block:
    - title_left: "How to Convert ODT to XLSB in C# .NET"
      content_left: |
          Follow these simple steps for ODT to XLSB conversion in .NET. View the converted XLSB document as it is or render and display it as HTML without using any external software.
