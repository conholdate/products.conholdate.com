...
content:
    enable: true
    block:
    - title_left: "WEB to WORD Conversion"
      content_left: |
          Follow these simple steps for WEB to WORD conversion in C# .NET. View the converted WORD document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to WORD File in C#"
      content_left: |
          Accurately convert documents (WEB to WORD) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET code.
