...
content:
    enable: true
    block:
    - title_left: "How to Convert DOCM to GIF in C# .NET"
      content_left: |
          Follow these simple steps for DOCM to GIF conversion in .NET. View the converted GIF document as it is or render and display it as HTML without using any external software.
