...
ad_headline: "Convert POTM to GIF | .NET"
ad_description: "Most Accurate POTM to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert POTM to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert POTM to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "POTM to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert POTM to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
