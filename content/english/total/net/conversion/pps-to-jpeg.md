...
ad_headline: "Convert PPS to JPEG | .NET"
ad_description: "Most Accurate PPS to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPS to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPS to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPS to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPS to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
