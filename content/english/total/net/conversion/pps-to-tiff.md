...
ad_headline: "Convert PPS to TIFF | .NET"
ad_description: "Most Accurate PPS to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPS to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "PPS to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPS to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
