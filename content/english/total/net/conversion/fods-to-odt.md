...
############################# Head ############################
head_title: "Convert FODS to ODT in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert FODS to ODT in .NET & View as HTML"
...
content:
    ...
    - title_left: "FODS to ODT Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to ODT in C# .NET. View the converted ODT document as HTML without using any external software.
