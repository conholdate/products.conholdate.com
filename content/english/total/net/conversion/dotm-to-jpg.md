...
content:
    enable: true
    block:
    - title_left: "How to Convert DOTM to JPG in C# .NET"
      content_left: |
          Follow these simple steps for DOTM to JPG conversion in .NET. View the converted JPG document as it is or render and display it as HTML without using any external software.
