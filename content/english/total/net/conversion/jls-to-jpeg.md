...
ad_headline: "Convert JLS to JPEG | .NET"
ad_description: "Most Accurate JLS to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JLS to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert JLS to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert JLS to JPEG in C#"
      content_left: |
