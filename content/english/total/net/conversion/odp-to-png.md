...
ad_headline: "Convert ODP to PNG | .NET"
ad_description: "Most Accurate ODP to PNG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert ODP to PNG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert ODP to PNG in .NET & View as HTML"
description: "Programmatically convert ODP to PNG in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    ...
    - title_left: "ODP to PNG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert ODP to PNG in C# .NET. View the converted PNG document as HTML without using any external software.
