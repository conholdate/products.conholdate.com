...
ad_headline: "Convert SVGZ to GIF | .NET"
ad_description: "Most Accurate SVGZ to GIF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert SVGZ to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert SVGZ to GIF in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert SVGZ to GIF in C#"
      content_left: |
          Follow these simple steps to convert SVGZ to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
