...
ad_headline: "Convert BMP to TIFF | .NET"
ad_description: "Most Accurate BMP to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert BMP to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert BMP to TIFF in C#"
      content_left: |
          Follow these simple steps to convert BMP to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
