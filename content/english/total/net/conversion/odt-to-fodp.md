...
content:
    enable: true
    block:
    - title_left: "How to Convert ODT to FODP in C# .NET"
      content_left: |
          Follow these simple steps for ODT to FODP conversion in .NET. View the converted FODP document as it is or render and display it as HTML without using any external software.
