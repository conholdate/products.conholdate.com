...
ad_headline: "Convert MPP to CSV | .NET"
ad_description: "Most Accurate MPP to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPP to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "MPP to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPP to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
