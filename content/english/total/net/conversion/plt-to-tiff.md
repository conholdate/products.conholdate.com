...
ad_headline: "Convert PLT to TIFF | .NET"
ad_description: "Most Accurate PLT to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert PLT to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert PLT to TIFF in C#"
      content_left: |
