...
ad_headline: "Convert VSDX to TIFF | .NET"
ad_description: "Most Accurate VSDX to TIFF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VSDX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VSDX to TIFF in C#"
      content_left: |
          Follow these simple steps to convert VSDX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
