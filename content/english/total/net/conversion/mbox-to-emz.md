...
############################# Head ############################
head_title: "Convert MBOX to EMZ in C# VB.NET & View as HTML"
...
############################# Header ############################
title: "Convert MBOX to EMZ & View as HTML"
description: "Programmatically convert MBOX to EMZ in .NET applications using flexible options to customize the resultant document. Convert the complete document or specific pages based on page numbers or selective page ranges using the .NET document conversion library."
...
content:
    enable: true
    block:
    - title_left: "MBOX to EMZ Conversion in C# .NET"
      content_left: |
          MBOX to EMZ file conversion using C#. Add watermark and view the converted document as HTML without using any external software.
      ...
      code: |
          ```cs {linenos=false}
          // Convert MBOX to EMZ using GroupDocs.Conversion API
          // Create Converter object to convert MBOX document
