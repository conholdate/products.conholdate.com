...
ad_headline: "Convert DOC to GIF | .NET"
ad_description: "Most Accurate DOC to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert DOC to GIF in C# ASP.NET | .NET Word Document Conversion"
head_description: ".NET Word processing documents conversion API. Convert DOC to GIF and 100+ other images and file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted GIF document as HTML viewer."

############################# Header ############################
title: "Convert Word Files (DOC) to GIF in C# .NET"
...
content:
    enable: true
    block:
    - title_left: "How to Convert DOC to GIF in C# .NET"
      content_left: |
          Follow these simple steps for DOC to GIF conversion in .NET. View the converted GIF document as it is or render and display it as HTML without using any external software.
