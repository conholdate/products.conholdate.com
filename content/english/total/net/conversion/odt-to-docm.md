...
content:
    enable: true
    block:
    - title_left: "How to Convert ODT to DOCM in C# .NET"
      content_left: |
          Follow these simple steps for ODT to DOCM conversion in .NET. View the converted DOCM document as it is or render and display it as HTML without using any external software.
