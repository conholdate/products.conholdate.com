...
ad_headline: "Convert EPUB to XPS | .NET"
ad_description: "Most Accurate EPUB to XPS document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert EPUB to XPS in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert EPUB to XPS in .NET & View as HTML"
description: "Programmatically convert EPUB to XPS in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert EPUB to XPS in C#"
      content_left: |
          Follow these simple steps to convert EPUB to XPS in C# .NET. View the converted XPS document as HTML without using any external software.
