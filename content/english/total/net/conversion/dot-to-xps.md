...
ad_headline: "Convert DOT to XPS | .NET"
ad_description: "Most Accurate DOT to XPS document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert DOT to XPS in C# ASP.NET | .NET Word Document Conversion"
head_description: ".NET Word processing documents conversion API. Convert DOT to XPS and 100+ other images and file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted XPS document as HTML viewer."

############################# Header ############################
title: "Convert Word Files (DOT) to XPS in C# .NET"
description: "Programmatically convert DOT (Word files) to XPS in C# VB.NET & ASP.NET applications using flexible documents conversion features that allow you to customize the resultant document appearance. Convert all popular Word processing document formats to Excel spreadsheets, PowerPoint presentations, PDF, Photoshop, eBook, web and image file formats. The native .NET conversion API offers multiple document conversion options to convert the whole document or choose specific pages of the source document file based on the selective page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert DOT to XPS in C# .NET"
      content_left: |
          Follow these simple steps for DOT to XPS conversion in .NET. View the converted XPS document as it is or render and display it as HTML without using any external software.
