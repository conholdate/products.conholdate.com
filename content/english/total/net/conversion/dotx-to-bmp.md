...
content:
    enable: true
    block:
    - title_left: "How to Convert DOTX to BMP in C# .NET"
      content_left: |
          Follow these simple steps for DOTX to BMP conversion in .NET. View the converted BMP document as it is or render and display it as HTML without using any external software.
