...
ad_headline: "Convert XER to JPEG | .NET"
ad_description: "Most Accurate XER to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert XER to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert XER to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "XER to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XER to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
