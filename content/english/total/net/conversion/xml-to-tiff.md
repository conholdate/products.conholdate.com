...
content:
    enable: true
    block:
    - title_left: "Convert XML to TIFF in C# .NET"
      content_left: |
          Follow these simple steps for XML to TIFF conversion in .NET. View the converted TIFF document as it is or render and display it as HTML, PDF or an image without using any external software.
