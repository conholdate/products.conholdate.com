...
ad_headline: "Convert DJVU to GIF | .NET"
ad_description: "Most Accurate DJVU to GIF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert DJVU to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DJVU to GIF in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert DJVU to GIF in C#"
      content_left: |
          Follow these simple steps to convert DJVU to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
