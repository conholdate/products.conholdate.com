...
ad_headline: "Convert VSTX to JPEG | .NET"
ad_description: "Most Accurate VSTX to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VSTX to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VSTX to JPEG in C#"
      content_left: |
          Follow these simple steps to convert VSTX to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
