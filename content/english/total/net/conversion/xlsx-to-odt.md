...
############################# Head ############################
head_title: "Convert XLSX to ODT in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert XLSX to ODT and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted ODT document as HTML viewer."

############################# Header ############################
title: "Convert XLSX to ODT in .NET & View as HTML"
description: "Programmatically convert XLSX to ODT in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "XLSX to ODT Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XLSX to ODT in C# .NET. View the converted ODT document as HTML without using any external software.
