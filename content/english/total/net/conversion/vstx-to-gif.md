...
ad_headline: "Convert VSTX to GIF | .NET"
ad_description: "Most Accurate VSTX to GIF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VSTX to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert VSTX to GIF in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VSTX to GIF in C#"
      content_left: |
          Follow these simple steps to convert VSTX to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
