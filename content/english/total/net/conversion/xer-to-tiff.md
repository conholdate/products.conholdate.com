...
ad_headline: "Convert XER to TIFF | .NET"
ad_description: "Most Accurate XER to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert XER to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "XER to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XER to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
