...
ad_headline: "Convert POT to TIFF | .NET"
ad_description: "Most Accurate POT to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert POT to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "POT to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert POT to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
