...
ad_headline: "Convert PDF to GIF | .NET"
ad_description: "Most Accurate PDF to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PDF to GIF in C# .NET – Fast PDF Conversion"
head_description: "Fast & secure PDF to GIF conversion in .NET & Mono frameworks – Convert PDF to GIF and 100+ other file formats in any type of C#, VB.NET, ASP.NET & .NET Core application."

############################# Header ############################
title: "Convert PDF to GIF In C# .NET"
...
content:
    enable: true
    block:
    - title_left: "How to Convert PDF to GIF in C# .NET"
      content_left: |
          Follow these simple steps for PDF to GIF conversion in .NET. View the converted document as it is or render and display it as HTML without using any external software.
