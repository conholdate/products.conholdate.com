...
content:
    enable: true
    block:
    - title_left: "How to Convert RTF to TGA in C# .NET"
      content_left: |
          Follow these simple steps for RTF to TGA conversion in .NET. View the converted TGA document as it is or render and display it as HTML without using any external software.
