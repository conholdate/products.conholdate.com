...
ad_headline: "Convert DJVU to TEX | .NET"
ad_description: "Most Accurate DJVU to TEX document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert DJVU to TEX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DJVU to TEX in .NET & View as HTML"
description: "Programmatically convert DJVU to TEX in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    enable: true
    block:
    - title_left: "How to Convert DJVU to TEX in C#"
      content_left: |
          Follow these simple steps to convert DJVU to TEX in C# .NET. View the converted TEX document as HTML without using any external software.
