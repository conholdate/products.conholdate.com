...
content:
    enable: true
    block:
    - title_left: "How to Convert MD to OTT in C# .NET"
      content_left: |
          Follow these simple steps for MD to OTT conversion in .NET. View the converted OTT document as it is or render and display it as HTML without using any external software.
