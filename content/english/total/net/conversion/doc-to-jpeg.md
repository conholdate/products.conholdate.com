...
ad_headline: "Convert DOC to JPEG | .NET"
ad_description: "Most Accurate DOC to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert DOC to JPEG in C# ASP.NET | .NET Word Document Conversion"
head_description: ".NET Word processing documents conversion API. Convert DOC to JPEG and 100+ other images and file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted JPEG document as HTML viewer."

############################# Header ############################
title: "Convert Word Files (DOC) to JPEG in C# .NET"
...
content:
    enable: true
    block:
    - title_left: "How to Convert DOC to JPEG in C# .NET"
      content_left: |
          Follow these simple steps for DOC to JPEG conversion in .NET. View the converted JPEG document as it is or render and display it as HTML without using any external software.
