...
############################# Head ############################
head_title: "Convert XLSB to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "XLSB to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XLSB to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
