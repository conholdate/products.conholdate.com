...
############################# Head ############################
head_title: "Convert DOT to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DOT to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "DOT to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert DOT to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
