...
ad_headline: "Convert DNG to JPEG | .NET"
ad_description: "Most Accurate DNG to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert DNG to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert DNG to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert DNG to JPEG in C#"
      content_left: |
          Follow these simple steps to convert DNG to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
