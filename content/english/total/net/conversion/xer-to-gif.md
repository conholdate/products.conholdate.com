...
ad_headline: "Convert XER to GIF | .NET"
ad_description: "Most Accurate XER to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert XER to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert XER to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "XER to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XER to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
