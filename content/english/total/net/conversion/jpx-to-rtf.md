...
ad_headline: "Convert JPX to RTF | .NET"
ad_description: "Most Accurate JPX to RTF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JPX to RTF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert JPX to RTF in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert JPX to RTF in C#"
      content_left: |
          Follow these simple steps to convert JPX to RTF in C# .NET. View the converted RTF document as HTML without using any external software.
