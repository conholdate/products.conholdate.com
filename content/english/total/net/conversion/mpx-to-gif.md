...
ad_headline: "Convert MPX to GIF | .NET"
ad_description: "Most Accurate MPX to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPX to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPX to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPX to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPX to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
