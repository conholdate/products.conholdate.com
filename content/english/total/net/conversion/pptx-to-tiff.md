...
ad_headline: "Convert PPTX to TIFF | .NET"
ad_description: "Most Accurate PPTX to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPTX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPTX to TIFF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPTX to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPTX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
