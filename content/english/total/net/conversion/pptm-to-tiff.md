...
ad_headline: "Convert PPTM to TIFF | .NET"
ad_description: "Most Accurate PPTM to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPTM to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "PPTM to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPTM to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
