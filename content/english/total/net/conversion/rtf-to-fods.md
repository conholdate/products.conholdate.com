...
content:
    enable: true
    block:
    - title_left: "How to Convert RTF to FODS in C# .NET"
      content_left: |
          Follow these simple steps for RTF to FODS conversion in .NET. View the converted FODS document as it is or render and display it as HTML without using any external software.
