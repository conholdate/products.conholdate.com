...
############################# Head ############################
head_title: "Convert OTG to TXT in C# VB.NET & View as HTML"
...
############################# Header ############################
title: "Convert OTG to TXT & View as HTML"
description: "Programmatically convert OTG to TXT in .NET applications using flexible options to customize the resultant document. Convert the complete document or specific pages based on page numbers or selective page ranges using the .NET document conversion library."
...
content:
    enable: true
    block:
    - title_left: "OTG to TXT Conversion in C# .NET"
      content_left: |
          OTG to TXT file conversion using C#. Add watermark and view the converted document as HTML without using any external software.
      ...
      code: |
          ```cs {linenos=false}
          // Convert OTG to TXT using GroupDocs.Conversion API
          // Create Converter object to convert OTG document
