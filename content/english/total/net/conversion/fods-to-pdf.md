...
############################# Head ############################
head_title: "Convert FODS to PDF in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert FODS to PDF and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted PDF document as HTML viewer."

############################# Header ############################
title: "Convert FODS to PDF in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "FODS to PDF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to PDF in C# .NET. View the converted PDF document as HTML without using any external software.
