...
ad_headline: "Convert TAR to PDF | C# .NET"
ad_description: "Convert archive TAR file to PDF in C# .NET Core – compress & decompress zip files."

############################# Head ############################
head_title: "Convert TAR Files to PDF in C# VB.NET ASP.NET .NET Core"
head_description: "Dynamically convert archive TAR files to PDF document in C#, AP.NET, VB.NET & .NET Core applications. Encrypt archives, compress and decompress files and folders."

############################# Header ############################
title: "Convert TAR to PDF File in C# .NET"
description: "Programmatically convert archived TAR files to PDF document in C#, AP.NET, VB.NET & .NET Core applications. The compressed archive files will be converted safely and securely to PDF."
...
content:
    enable: true
    block:
    - title_left: "TAR to PDF Conversion in C# .NET Core"
      content_left: |
