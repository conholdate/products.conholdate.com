...
ad_headline: "Convert PDF to TIFF | .NET"
ad_description: "Most Accurate PDF to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PDF to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PDF to TIFF in .NET & View as HTML"
...
content:
    ...
    - title_left: "PDF to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PDF to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
