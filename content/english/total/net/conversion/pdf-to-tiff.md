...
content:
    enable: true
    block:
    - title_left: "How to Convert PDF to TIFF in C# .NET"
      content_left: |
          Follow these simple steps for PDF to TIFF conversion in .NET. View the converted document as it is or render and display it as HTML without using any external software.
