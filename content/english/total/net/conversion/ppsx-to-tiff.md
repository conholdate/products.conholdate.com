...
ad_headline: "Convert PPSX to TIFF | .NET"
ad_description: "Most Accurate PPSX to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPSX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "PPSX to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPSX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
