...
############################# Head ############################
head_title: "Convert FODS to EMZ in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert FODS to EMZ and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted EMZ document as HTML viewer."

############################# Header ############################
title: "Convert FODS to EMZ in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "FODS to EMZ Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to EMZ in C# .NET. View the converted EMZ document as HTML without using any external software.
