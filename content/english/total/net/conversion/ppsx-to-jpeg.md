...
ad_headline: "Convert PPSX to JPEG | .NET"
ad_description: "Most Accurate PPSX to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPSX to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPSX to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPSX to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPSX to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
