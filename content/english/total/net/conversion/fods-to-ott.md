...
############################# Head ############################
head_title: "Convert FODS to OTT in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert FODS to OTT and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted OTT document as HTML viewer."

############################# Header ############################
title: "Convert FODS to OTT in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "FODS to OTT Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to OTT in C# .NET. View the converted OTT document as HTML without using any external software.
