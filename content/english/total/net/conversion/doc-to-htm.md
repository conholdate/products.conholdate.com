...
draft: false
path: "total/net/conversion/doc-to-htm/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM CSV DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT OTP ODP ODS EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Convert DOC to HTM | .NET"
ad_description: "Most Accurate DOC to HTM document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert DOC to HTM in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert DOC to HTM and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted HTM document as HTML viewer."

############################# Header ############################
title: "Convert DOC to HTM in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "DOC to HTM Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert DOC to HTM in C# .NET. View the converted HTM document as HTML without using any external software.
    ...
    - title_left: "Add Watermark to Converted HTM in C#"
      content_left: |
          Accurately convert documents (DOC to HTM) exactly as the original file and apply text or image watermarks to the converted document pages using C# .NET.
