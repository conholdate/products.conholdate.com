...
ad_headline: "Convert XER to MPX | .NET"
ad_description: "Most Accurate XER to MPX document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert XER to MPX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert XER to MPX in .NET & View as HTML"
...
content:
    ...
    - title_left: "XER to MPX Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XER to MPX in C# .NET. View the converted MPX document as HTML without using any external software.
