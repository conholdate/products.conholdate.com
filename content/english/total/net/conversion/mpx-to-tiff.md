...
ad_headline: "Convert MPX to TIFF | .NET"
ad_description: "Most Accurate MPX to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "MPX to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
