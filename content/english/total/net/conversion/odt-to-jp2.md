...
content:
    enable: true
    block:
    - title_left: "How to Convert ODT to JP2 in C# .NET"
      content_left: |
          Follow these simple steps for ODT to JP2 conversion in .NET. View the converted JP2 document as it is or render and display it as HTML without using any external software.
