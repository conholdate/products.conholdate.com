...
content:
    enable: true
    block:
    - title_left: "How to Convert TXT to DIF in C# .NET"
      content_left: |
          Follow these simple steps for TXT to DIF conversion in .NET. View the converted DIF document as it is or render and display it as HTML without using any external software.
