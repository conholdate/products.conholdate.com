...
############################# Head ############################
head_title: "Convert SXC to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert SXC to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "SXC to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert SXC to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
