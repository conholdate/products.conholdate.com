...
ad_headline: "Convert PPT to CSV | .NET"
ad_description: "Most Accurate PPT to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPT to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "PPT to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPT to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
