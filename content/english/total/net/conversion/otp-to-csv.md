...
ad_headline: "Convert OTP to CSV | .NET"
ad_description: "Most Accurate OTP to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert OTP to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "OTP to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert OTP to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
