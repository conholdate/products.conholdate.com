...
ad_headline: "Convert MPP to GIF | .NET"
ad_description: "Most Accurate MPP to GIF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert MPP to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MPP to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "MPP to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert MPP to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
