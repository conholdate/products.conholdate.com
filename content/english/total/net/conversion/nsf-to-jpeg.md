...
ad_headline: "Convert NSF to JPEG | .NET"
ad_description: "Most Accurate NSF to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert NSF to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert NSF to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert NSF to JPEG in C#"
      content_left: |
          Follow these simple steps to convert NSF to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
