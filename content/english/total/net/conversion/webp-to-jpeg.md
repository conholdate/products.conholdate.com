...
ad_headline: "Convert WEBP to JPEG | .NET"
ad_description: "Most Accurate WEBP to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert WEBP to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert WEBP to JPEG in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert WEBP to JPEG in C#"
      content_left: |
          Follow these simple steps to convert WEBP to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
