...
content:
    enable: true
    block:
    - title_left: "How to Convert MD to SVG in C# .NET"
      content_left: |
          Follow these simple steps for MD to SVG conversion in .NET. View the converted SVG document as it is or render and display it as HTML without using any external software.
