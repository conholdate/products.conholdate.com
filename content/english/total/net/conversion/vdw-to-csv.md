...
ad_headline: "Convert VDW to CSV | .NET"
ad_description: "Most Accurate VDW to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert VDW to CSV in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert VDW to CSV in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VDW to CSV in C#"
      content_left: |
          Follow these simple steps to convert VDW to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
