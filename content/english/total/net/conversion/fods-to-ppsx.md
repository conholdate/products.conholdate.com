...
############################# Head ############################
head_title: "Convert FODS to PPSX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert FODS to PPSX in .NET & View as HTML"
...
content:
    ...
    - title_left: "FODS to PPSX Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to PPSX in C# .NET. View the converted PPSX document as HTML without using any external software.
