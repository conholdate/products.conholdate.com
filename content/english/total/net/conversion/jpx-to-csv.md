...
ad_headline: "Convert JPX to CSV | .NET"
ad_description: "Most Accurate JPX to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JPX to CSV in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert JPX to CSV in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert JPX to CSV in C#"
      content_left: |
          Follow these simple steps to convert JPX to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
