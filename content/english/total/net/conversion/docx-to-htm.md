...
content:
    enable: true
    block:
    - title_left: "How to Convert DOCX to HTM in C# .NET"
      content_left: |
          Follow these simple steps for DOCX to HTM conversion in .NET. View the converted HTM document as it is or render and display it as HTML without using any external software.
