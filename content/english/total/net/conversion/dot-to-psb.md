...
content:
    enable: true
    block:
    - title_left: "How to Convert DOT to PSB in C# .NET"
      content_left: |
          Follow these simple steps for DOT to PSB conversion in .NET. View the converted PSB document as it is or render and display it as HTML without using any external software.
