...
ad_headline: "Convert DWFX to JPEG | .NET"
ad_description: "Most Accurate DWFX to JPEG document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert DWFX to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
content:
    enable: true
    block:
    - title_left: "How to Convert DWFX to JPEG in C#"
      content_left: |
          Follow these simple steps to convert DWFX to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
