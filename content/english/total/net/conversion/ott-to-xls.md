...
content:
    enable: true
    block:
    - title_left: "How to Convert OTT to XLS in C# .NET"
      content_left: |
          Follow these simple steps for OTT to XLS conversion in .NET. View the converted XLS document as it is or render and display it as HTML without using any external software.
