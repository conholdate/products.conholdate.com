...
ad_headline: "Convert FODP to JPEG | .NET"
ad_description: "Most Accurate FODP to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert FODP to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert FODP to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "FODP to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODP to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
