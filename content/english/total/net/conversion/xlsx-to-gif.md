...
############################# Head ############################
head_title: "Convert XLSX to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert XLSX to GIF in .NET & View as HTML"
...
content:
    ...
    - title_left: "XLSX to GIF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XLSX to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
