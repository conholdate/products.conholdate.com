...
ad_headline: "Convert JPX to PPSX | .NET"
ad_description: "Most Accurate JPX to PPSX document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert JPX to PPSX in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert JPX to PPSX in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert JPX to PPSX in C#"
      content_left: |
          Follow these simple steps to convert JPX to PPSX in C# .NET. View the converted PPSX document as HTML without using any external software.
