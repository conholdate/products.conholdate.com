...
############################# Head ############################
head_title: "Convert OTS to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert OTS to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "OTS to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert OTS to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
