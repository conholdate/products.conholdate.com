...
content:
    enable: true
    block:
    - title_left: "How to Convert DOTX to RTF in C# .NET"
      content_left: |
          Follow these simple steps for DOTX to RTF conversion in .NET. View the converted RTF document as it is or render and display it as HTML without using any external software.
