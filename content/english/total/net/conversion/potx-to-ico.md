...
ad_headline: "Convert POTX to ICO | .NET"
ad_description: "Most Accurate POTX to ICO document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert POTX to ICO in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert POTX to ICO in .NET & View as HTML"
description: "Programmatically convert POTX to ICO in C# .NET applications using flexible document conversion features to customize the resultant document. Convert the complete document from one file format to other or choose selective pages of a source document based on the page numbers or page ranges and easily convert to a supported document format."
...
content:
    ...
    - title_left: "POTX to ICO Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert POTX to ICO in C# .NET. View the converted ICO document as HTML without using any external software.
