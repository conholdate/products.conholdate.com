...
ad_headline: "Convert IFC to GIF | .NET"
ad_description: "Most Accurate IFC to GIF document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert IFC to GIF in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert IFC to GIF in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert IFC to GIF in C#"
      content_left: |
          Follow these simple steps to convert IFC to GIF in C# .NET. View the converted GIF document as HTML without using any external software.
