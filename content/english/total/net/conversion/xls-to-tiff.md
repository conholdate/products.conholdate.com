...
############################# Head ############################
head_title: "Convert XLS to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "XLS to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XLS to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
