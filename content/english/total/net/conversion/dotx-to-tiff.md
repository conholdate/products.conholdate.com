...
############################# Head ############################
head_title: "Convert DOTX to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "DOTX to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert DOTX to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
