...
ad_headline: "Convert PPTX to JPEG | .NET"
ad_description: "Most Accurate PPTX to JPEG document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert PPTX to JPEG in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert PPTX to JPEG in .NET & View as HTML"
...
content:
    ...
    - title_left: "PPTX to JPEG Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert PPTX to JPEG in C# .NET. View the converted JPEG document as HTML without using any external software.
