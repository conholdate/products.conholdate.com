...
content:
    enable: true
    block:
    - title_left: "How to Convert DOC to DOT in C# .NET"
      content_left: |
          Follow these simple steps for DOC to DOT conversion in .NET. View the converted DOT document as it is or render and display it as HTML without using any external software.
