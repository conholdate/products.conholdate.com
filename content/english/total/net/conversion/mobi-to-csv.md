...
ad_headline: "Convert MOBI to CSV | .NET"
ad_description: "Most Accurate MOBI to CSV document Conversion solution for .NET applications."

############################# Head ############################
head_title: "Convert MOBI to CSV in C# VB.NET ASP.NET | Document Conversion"
...
############################# Header ############################
title: "Convert MOBI to CSV in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "How to Convert MOBI to CSV in C#"
      content_left: |
          Follow these simple steps to convert MOBI to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
