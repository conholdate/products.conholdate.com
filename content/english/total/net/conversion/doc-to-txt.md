...
content:
    enable: true
    block:
    - title_left: "How to Convert DOC to TXT in C# .NET"
      content_left: |
          Follow these simple steps for DOC to TXT conversion in .NET. View the converted TXT document as it is or render and display it as HTML without using any external software.
