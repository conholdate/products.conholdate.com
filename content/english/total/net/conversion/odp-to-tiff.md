...
ad_headline: "Convert ODP to TIFF | .NET"
ad_description: "Most Accurate ODP to TIFF document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert ODP to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "ODP to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert ODP to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
