...
draft: false
path: "total/net/conversion/lz-to-pdf/"
other_in_formats: "ZIP TAR GZIP LZ RAR BZ2 7Z"
ad_headline: "lz to pdf Conversion in .NET"
ad_description: "Convert archive lz Files to pdf document in C# .NET Core Applications with capabilities to compress & decompress zip files."

############################# Head ############################
head_title: "Convert LZ Files to PDF in C# VB.NET ASP.NET .NET Core"
head_description: "Dynamically convert archive LZ files to PDF document in C#, AP.NET, VB.NET & .NET Core applications. Encrypt archives, compress and decompress files and folders."

############################# Header ############################
title: "Convert LZ to PDF File in C# .NET"
description: "Programmatically convert archived LZ files to PDF document in C#, AP.NET, VB.NET & .NET Core applications. The compressed archive files will be converted safely and securely to PDF."
...
content:
    enable: true
    block:
    - title_left: "LZ to PDF Conversion in C# .NET Core"
      content_left: |
          
          -   Create Archive instance with input LZ file
          -   Extract contents of LZ file using **ExtractToDictionary** method of Archive
