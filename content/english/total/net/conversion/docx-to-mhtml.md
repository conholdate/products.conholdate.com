...
content:
    enable: true
    block:
    - title_left: "How to Convert DOCX to MHTML in C# .NET"
      content_left: |
          Follow these simple steps for DOCX to MHTML conversion in .NET. View the converted MHTML document as it is or render and display it as HTML without using any external software.
