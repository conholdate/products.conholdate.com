...
ad_headline: "Convert XER to CSV | .NET"
ad_description: "Most Accurate XER to CSV document Conversion solution for your .NET applications."

############################# Head ############################
head_title: "Convert XER to CSV in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "XER to CSV Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert XER to CSV in C# .NET. View the converted CSV document as HTML without using any external software.
