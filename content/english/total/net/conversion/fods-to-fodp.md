...
############################# Head ############################
head_title: "Convert FODS to FODP in C# VB.NET ASP.NET | Document Conversion"
head_description: "Code example to convert FODS to FODP and 100+ other file formats in .NET (C#, VB.NET, ASP.NET & .NET Core) applications. Display the Converted FODP document as HTML viewer."

############################# Header ############################
title: "Convert FODS to FODP in .NET & View as HTML"
...
content:
    enable: true
    block:
    - title_left: "FODS to FODP Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert FODS to FODP in C# .NET. View the converted FODP document as HTML without using any external software.
