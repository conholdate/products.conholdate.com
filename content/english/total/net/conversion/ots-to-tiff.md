...
############################# Head ############################
head_title: "Convert OTS to TIFF in C# VB.NET ASP.NET | Document Conversion"
...
content:
    ...
    - title_left: "OTS to TIFF Conversion in C# .NET"
      content_left: |
          Follow these simple steps to convert OTS to TIFF in C# .NET. View the converted TIFF document as HTML without using any external software.
