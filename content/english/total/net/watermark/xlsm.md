...
############################# Head ############################
head_title: "Add Watermark to XLSM Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to XLSM file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to XLSM Viewer in C# .NET"
description: "Add watermark image to XLSM document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to XLSM File in .NET"
    content_left: |
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to XLSM in C# .NET
        // Instantiate Watermarker with input XLSM document
