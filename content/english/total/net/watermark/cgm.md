...
############################# Head ############################
head_title: "Add Watermark to CGM Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to CGM file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to CGM Viewer in C# .NET"
description: "Add watermark image to CGM document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to CGM File in .NET"
    content_left: |
        ...
        *   Instantiate **Watermarker** with input CGM document
    ...
    content_right: |
        ...
        Insert image watermark to CGM on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to CGM in C# .NET
        // Instantiate Watermarker with input CGM document
        using (Watermarker watermarker = new Watermarker("input.cgm"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
            using (ImageWatermark watermark = new ImageWatermark("watermark.png"))
            {
              ...
              watermarker.Save("output.cgm");
            }
          }
        
        // View watermarked CGM file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
        using (Viewer viewer = new Viewer("output.cgm"))
          {
            // Set options to view document as HTML
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-code-o"
          ...
          content: |
            Computer Graphics Metafile (CGM) is free, platform-independent, international standard metafile format for storing and exchanging vector graphics (2D), raster graphics, and text. CGM uses an object-oriented approach and many function provisions for image production. CGM uses these object-oriented characteristics for remolding graphical elements to render an image. A metafile contains necessary information that defines other files. In CGM, a text-based source file contains all graphical elements that can be later compiled into a binary file. Basically, CGM is a way to facilitate 2D graphical data interchange, independent from any particular platform, or device. CGM format provides different elements to perform functions, and signify objects to adjust geometric primitives and graphical information. Although CGM has been superseded by other formats to display graphic arts on web pages as it is not well supported by web pages, still very popular among industrial, aeronautical, and other technical applications. Though World Wide Web Consortium has developed WebCGM, an alternative approach for the use of CGM on the Web. The primary CGM implementation was an illustration of the sequence of basic operations of the Graphical Kernel System (GKS). It has not been much adopted in professional designs but has largely supplanted by other formats such as DXF and SVG.
