...
############################# Head ############################
head_title: "Add Watermark to RAR5 Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to RAR5 file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to RAR5 Viewer in C# .NET"
description: "Add watermark image to RAR5 document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to RAR5 File in .NET"
    content_left: |
        ...
        *   Instantiate **Watermarker** with input RAR5 document
    ...
    content_right: |
        ...
        Insert image watermark to RAR5 on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to RAR5 in C# .NET
        // Instantiate Watermarker with input RAR5 document
        ...
        // View watermarked RAR5 file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
