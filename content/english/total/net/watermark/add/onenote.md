...
############################# Head ############################
head_title: "Add Watermark to OneNote Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to OneNote file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to OneNote Viewer in C# .NET"
description: "Add watermark image to OneNote document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to OneNote File in .NET"
    content_left: |
        ...
        *   Instantiate **Watermarker** with input OneNote document
    ...
    content_right: |
        ...
        Insert image watermark to OneNote on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to OneNote in C# .NET
        // Instantiate Watermarker with input OneNote document
        using (Watermarker watermarker = new Watermarker("input.one"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
        ...
        // View watermarked OneNote file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
        using (Viewer viewer = new Viewer("output.one"))
          {
            // Set options to view document as HTML
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-sticky-note-o"
          ...
          content: |
            Note-taking program files contain sections and pages for storing notes. A note document can be as simple as a text document as well as more detailed consisting of digital images, audio/video clips, and hand sketch drawings. Common OneNote file extensions and their associated file formats include .ONE and its table of contents file .ONETOC2.

          link: "https://docs.fileformat.com/note-taking/"
