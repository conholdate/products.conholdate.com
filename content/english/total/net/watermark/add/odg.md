...
############################# Head ############################
head_title: "Add Watermark to ODG Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to ODG file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to ODG Viewer in C# .NET"
description: "Add watermark image to ODG document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to ODG File in .NET"
    content_left: |
    ...
    content_right: |
        ...
        Insert image watermark to ODG on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to ODG in C# .NET
        // Instantiate Watermarker with input ODG document
        using (Watermarker watermarker = new Watermarker("input.odg"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
            using (ImageWatermark watermark = new ImageWatermark("watermark.png"))
            {
              ...
              watermarker.Save("output.odg");
            }
          }
        
        // View watermarked ODG file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
        using (Viewer viewer = new Viewer("output.odg"))
          {
            // Set options to view document as HTML
