...
############################# Head ############################
head_title: "Add Watermark to SVGZ Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to SVGZ file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to SVGZ Viewer in C# .NET"
description: "Add watermark image to SVGZ document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to SVGZ File in .NET"
    content_left: |
        ...
        *   Instantiate **Watermarker** with input SVGZ document
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to SVGZ in C# .NET
        // Instantiate Watermarker with input SVGZ document
        using (Watermarker watermarker = new Watermarker("input.svgz"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
