...
############################# Head ############################
head_title: "Add Watermark to DCM Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to DCM file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to DCM Viewer in C# .NET"
description: "Add watermark image to DCM document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to DCM File in .NET"
    content_left: |
        ...
        *   Instantiate **Watermarker** with input DCM document
    ...
    content_right: |
        ...
        Insert image watermark to DCM on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to DCM in C# .NET
        // Instantiate Watermarker with input DCM document
        using (Watermarker watermarker = new Watermarker("input.dcm"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
            using (ImageWatermark watermark = new ImageWatermark("watermark.png"))
            {
              ...
              watermarker.Save("output.dcm");
            }
          }
        
        // View watermarked DCM file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
