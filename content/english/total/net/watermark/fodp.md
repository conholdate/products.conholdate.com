...
############################# Head ############################
head_title: "Add Watermark to FODG Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to FODG file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to FODG Viewer in C# .NET"
description: "Add watermark image to FODG document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to FODG File in .NET"
    content_left: |
        ...
        *   Instantiate **Watermarker** with input FODG document
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to FODG in C# .NET
        // Instantiate Watermarker with input FODG document
        using (Watermarker watermarker = new Watermarker("input.fodg"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
            using (ImageWatermark watermark = new ImageWatermark("watermark.png"))
            {
              ...
              watermarker.Save("output.fodg");
            }
          }
        
        // View watermarked FODG file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
        using (Viewer viewer = new Viewer("output.fodg"))
          {
            // Set options to view document as HTML
