...
############################# Head ############################
head_title: "Add Watermark to CF2 Viewer in Java & J2SE"
head_description: "Add image watermark to CF2 file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to CF2 Viewer in Java"
description: "Add watermark image to CF2 document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to CF2 File in Java"
    content_left: |
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to CF2 in Java
        // Instantiate FileInputStream Object with input file
        FileInputStream stream = new FileInputStream("input.cf2");
        ...
        try (Viewer viewer = new Viewer("output.cf2")) {
          viewer.view(options);
          }
        ```
