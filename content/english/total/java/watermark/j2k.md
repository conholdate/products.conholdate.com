...
############################# Head ############################
head_title: "Add Watermark to J2K Viewer in Java & J2SE"
head_description: "Add image watermark to J2K file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to J2K Viewer in Java"
description: "Add watermark image to J2K document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to J2K File in Java"
    content_left: |
        ...
        *   Instantiate **FileInputStream** Object with input J2K document
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to J2K in Java
        // Instantiate FileInputStream Object with input file
        FileInputStream stream = new FileInputStream("input.j2k");
        ...
        try (Viewer viewer = new Viewer("output.j2k")) {
          viewer.view(options);
          }
        ```
