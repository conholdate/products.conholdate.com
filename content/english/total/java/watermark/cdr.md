...
############################# Head ############################
head_title: "Add Watermark to CDR Viewer in Java & J2SE"
head_description: "Add image watermark to CDR file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to CDR Viewer in Java"
description: "Add watermark image to CDR document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to CDR File in Java"
    content_left: |
        ...
        *   Instantiate **FileInputStream** Object with input CDR document
    ...
    content_right: |
        ...
        Insert image watermark to CDR on different operating systems such as Windows, Linux or macOS while using Java 7 (1.7) and above versions.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to CDR in Java
        // Instantiate FileInputStream Object with input file
        FileInputStream stream = new FileInputStream("input.cdr");
