...
############################# Head ############################
head_title: "Add Watermark to Presentation Viewer in Java & J2SE"
head_description: "Add image watermark to Presentation file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to Presentation Viewer in Java"
description: "Add watermark image to Presentation document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to Presentation File in Java"
    content_left: |
