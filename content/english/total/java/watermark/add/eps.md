...
############################# Head ############################
head_title: "Add Watermark to EPS Viewer in Java & J2SE"
head_description: "Add image watermark to EPS file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to EPS Viewer in Java"
description: "Add watermark image to EPS document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to EPS File in Java"
    content_left: |
        ...
        *   Instantiate **FileInputStream** Object with input EPS document
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to EPS in Java
