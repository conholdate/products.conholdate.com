...
############################# Head ############################
head_title: "Add Watermark to J2C Viewer in Java & J2SE"
head_description: "Add image watermark to J2C file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to J2C Viewer in Java"
description: "Add watermark image to J2C document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to J2C File in Java"
    content_left: |
        ...
        *   Instantiate **FileInputStream** Object with input J2C document
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to J2C in Java
        // Instantiate FileInputStream Object with input file
        FileInputStream stream = new FileInputStream("input.j2c");
        ...
        try (Viewer viewer = new Viewer("output.j2c")) {
          viewer.view(options);
          }
        ```
