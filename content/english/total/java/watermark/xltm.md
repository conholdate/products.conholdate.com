...
draft: false
path: "total/java/watermark/xltm/"
...
ad_headline: "Watermark XLTM File | Java"
ad_description: "Add, search, modify & remove watermarks from XLTM file in Java"

############################# Head ############################
head_title: "Watermark XLTM File in Java – Add, Edit, Search, Remove Watermark"
head_description: "Watermark a XLTM document in Java. Add, edit, search and delete text or image watermark from a XLTM, Word, Excel, PowerPoint, diagram or image file within Java and J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Text & Image Watermark to XLTM in Java"
description: "Add an image or text watermark to a XLTM document viewer application, built on Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside the applications without using any additional software. Use a smart set of watermarks management and manipulation methods to add, edit, search and delete all popular watermark types from PDF, Microsoft Word documents, Excel spreadsheets, PowerPoint presentations, diagrams, email attachments and image file formats. The .NET watermark API also allows viewing the watermarked file as HTML, Image or a PDF file inside any Java based application."
...
content:
    enable: true
    block:
    - title_left: "How to Add Image Watermark to XLTM in Java"
      content_left: |
          [Conholdate.Total for Java](https://products.conholdate.com/total/java/) makes it easier for java programmers to add image watermarks to their XLTM document viewer applications by adding a few easy steps.

          -   Instantiate **FileInputStream** Object with input XLTM document
    ...
    - title_left: "How to Add Text Watermark to XLTM in Java"
      content_left: |
          This Java code example demonstrates how to add text watermark to a XLTM document using a few simple lines of Java code. The watermark will be added to all the pages of the source document.
