...
############################# Head ############################
head_title: "Add Watermark to DWF Viewer in Java & J2SE"
head_description: "Add image watermark to DWF file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to DWF Viewer in Java"
description: "Add watermark image to DWF document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to DWF File in Java"
    content_left: |
        ...
        *   Instantiate **FileInputStream** Object with input DWF document
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to DWF in Java
        // Instantiate FileInputStream Object with input file
        FileInputStream stream = new FileInputStream("input.dwf");
        ...
        try (Viewer viewer = new Viewer("output.dwf")) {
          viewer.view(options);
          }
        ```
