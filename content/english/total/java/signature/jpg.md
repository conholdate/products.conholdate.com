...
head_description: "Java JPG Signature API to add, edit, remove, verify and search digital signatures (text, image, metadata, QR-Code, stamp). View the signed JPG file in HTML."
...
content:
    enable: true
    block:
    - title_left: "Add Image Signatures to JPG in Java"
      content_left: |
          Insert custom image as an electronic signature to a JPG document in Java. Add company logo, stamp icon or name using different colors and text effects.
      ...
      title_right: "Inserting Digital Signatures to JPG"
      content_right: |
    ...
    - title_left: "Add Text Signatures to JPG in Java"
      content_left: |
          Add customized text signature to a JPG document using advanced text settings such as font color, size, name, text alignment and border adjustment.
