...
draft: false
path: "total/java/signature/pot/"

############################# Head ############################
head_title: "Sign POT File with Text or Image Signatures in Java"
head_description: "Java POT Signature API to add, edit, remove, verify and search digital signatures (text, image, metadata, QR-Code, stamp). View the signed POT file in HTML."

############################# Header ############################
title: "Sign POT File in Java & View in HTML"
description: "Sign & secure POT files in Java applications using popular electronic signature types such as text, image, metadata, QR-Code, stamp and form field. Programmatically generate, update, delete, verify and search digital signatures in documents, images and various other file formats without Adobe Reader installed."
...
content:
    enable: true
    block:
    - title_left: "Add Image Signatures to POT in Java"
      content_left: |
          Insert custom image as an electronic signature to a POT document in Java. Add company logo, stamp icon or name using different colors and text effects.
      ...
      title_right: "Inserting Digital Signatures to POT"
      content_right: |
      ...
      code: |
          ```cs {linenos=false}
          Signature signature = new Signature("input.pot")
          ...
          signature.sign("output.pot", options);
          ...
          ```
    - title_left: "Add Text Signatures to POT in Java"
      content_left: |
          Add customized text signature to a POT document using advanced text settings such as font color, size, name, text alignment and border adjustment.
