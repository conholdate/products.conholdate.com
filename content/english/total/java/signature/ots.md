...
ad_headline: "Digitally Sign OTS | Java"
ad_description: "Add, edit, search, verify & delete digital signatures from OTS in Java"

############################# Head ############################
head_title: "Sign OTS File with Text or Image Signatures in Java"
head_description: "Java OTS Signature API to add, edit, remove, verify and search digital signatures (text, image, metadata, QR-Code, stamp). View the signed BMP file in HTML."
...
content:
    enable: true
    block:
    - title_left: "How to Add Image Signatures to OTS in Java"
      content_left: |
          Using [Conholdate.Total for Java](https://products.conholdate.com/total/java/) - insert custom image as an electronic signature to a OTS document in Java. Add company logo, stamp icon or name using different colors and text effects.
