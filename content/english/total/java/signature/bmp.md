...
ad_headline: "Digitally Sign BMP | Java"
ad_description: "Add, edit, search, verify & delete digital signatures from BMP in Java"

############################# Head ############################
head_title: "Sign BMP File with Text or Image Signatures in Java"
head_description: "Java BMP Signature API to add, edit, remove, verify and search digital signatures (text, image, metadata, QR-Code, stamp). View the signed BMP file in HTML."

############################# Header ############################
title: "Sign BMP File in Java & View in HTML"
description: "Sign & secure BMP files in Java applications using popular electronic signature types such as text, image, metadata, QR-Code, stamp and form field. Programmatically generate, update, delete, verify and search digital signatures in BMP documents, images and various other file formats without Adobe Reader installed."
...
content:
    enable: true
    block:
    - title_left: "How to Add Image Signatures to BMP in Java"
      content_left: |
          Using [Conholdate.Total for Java](https://products.conholdate.com/total/java/) - insert custom image as an electronic signature to a BMP document in Java. Add company logo, stamp icon or name using different colors and text effects.
    ...
    - title_left: "Add Text Signatures to BMP in Java"
      content_left: |
          Add customized text signature to a BMP document in Java using advanced text settings such as font color, size, name, text alignment and border adjustment.
