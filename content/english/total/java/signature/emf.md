...
draft: false
path: "total/java/signature/emf/"

############################# Head ############################
head_title: "Sign EMF File with Text or Image Signatures in Java"
head_description: "Java EMF Signature API to add, edit, remove, verify and search digital signatures (text, image, metadata, QR-Code, stamp). View the signed EMF file in HTML."

############################# Header ############################
title: "Sign EMF File in Java & View in HTML"
description: "Sign & secure EMF files in Java applications using popular electronic signature types such as text, image, metadata, QR-Code, stamp and form field. Programmatically generate, update, delete, verify and search digital signatures in documents, images and various other file formats without Adobe Reader installed."
...
content:
    enable: true
    block:
    - title_left: "Add Image Signatures to EMF in Java"
      content_left: |
          Insert custom image as an electronic signature to a EMF document in Java. Add company logo, stamp icon or name using different colors and text effects.
      ...
      title_right: "Inserting Digital Signatures to EMF"
      content_right: |
      ...
      code: |
          ```cs {linenos=false}
          Signature signature = new Signature("input.emf")
          ...
          signature.sign("output.emf", options);
          ...
          ```
    - title_left: "Add Text Signatures to EMF in Java"
      content_left: |
          Add customized text signature to a EMF document using advanced text settings such as font color, size, name, text alignment and border adjustment.
