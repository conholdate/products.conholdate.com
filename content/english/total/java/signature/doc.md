...
ad_headline: "Digitally Sign DOC | Java"
ad_description: "Add, edit, search, verify & delete digital signatures from DOC in Java"

############################# Head ############################
head_title: "Sign DOC File with Text or Image Signatures in Java"
head_description: "Java DOC Signature API to add, edit, remove, verify and search digital signatures (text, image, metadata, QR-Code, stamp). View the signed BMP file in HTML."
