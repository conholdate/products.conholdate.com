...
content:
    enable: true
    block:
    - title_left: "How to Convert XLSX to SVG in Java"
      content_left: |
          Perform XLSX to SVG file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
