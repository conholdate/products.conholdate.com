...
content:
    enable: true
    block:
    - title_left: "How to Convert OTS to IMAGE in Java"
      content_left: |
          Perform OTS to IMAGE file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected OTS to IMAGE"
      content_left: |
