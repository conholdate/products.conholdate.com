...
draft: false
path: "total/java/conversion/mpp-to-xltm/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java MPP to XLTM Conversion"
ad_description: "MPP to XLTM document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert MPP to XLTM in Java & J2SE Applications"
head_description: "Java document conversion library to convert MPP to XLTM and 100+ other file formats in Java & J2SE applications. View the Converted XLTM document as HTML viewer."

############################# Header ############################
title: "Convert MPP to XLTM in Java & View as HTML"
description: "Programmatically convert MPP to XLTM in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java MPP to XLTM conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert MPP to XLTM in Java"
      content_left: |
          Perform MPP to XLTM file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected MPP to XLTM"
      content_left: |
