...
draft: false
path: "total/java/conversion/dgn-to-pps/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java DGN to PPS Conversion"
ad_description: "DGN to PPS document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert DGN to PPS in Java & J2SE Applications"
head_description: "Java document conversion library to convert DGN to PPS and 100+ other file formats in Java & J2SE applications. View the Converted PPS document as HTML viewer."

############################# Header ############################
title: "Convert DGN to PPS in Java & View as HTML"
description: "Programmatically convert DGN to PPS in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java DGN to PPS conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert DGN to PPS in Java"
      content_left: |
          Perform DGN to PPS file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected DGN to PPS"
      content_left: |
