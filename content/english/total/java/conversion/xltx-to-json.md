...
content:
    enable: true
    block:
    - title_left: "How to Convert XLTX to JSON in Java"
      content_left: |
          Perform XLTX to JSON file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected XLTX to JSON"
      content_left: |
