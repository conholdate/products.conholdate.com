...
content:
    ...
    - title_left: "How to Convert SXC to JPEG in Java"
      content_left: |
          Perform SXC to JPEG file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
