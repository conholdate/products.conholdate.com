...
ad_headline: "Java PPTX to DCM Conversion"
ad_description: "PPTX to DCM document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert PPTX to DCM in Java & J2SE Applications"
...
description: "Programmatically convert PPTX to DCM in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java PPTX to DCM conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert PPTX to DCM in Java"
      content_left: |
          Perform PPTX to DCM file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
