...
draft: false
path: "total/java/conversion/gif-to-xps/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java GIF to XPS Conversion"
ad_description: "GIF to XPS document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert GIF to XPS in Java & J2SE Applications"
head_description: "Java document conversion library to convert GIF to XPS and 100+ other file formats in Java & J2SE applications. View the Converted XPS document as HTML viewer."

############################# Header ############################
title: "Convert GIF to XPS in Java & View as HTML"
description: "Programmatically convert GIF to XPS in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java GIF to XPS conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert GIF to XPS in Java"
      content_left: |
          Perform GIF to XPS file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected GIF to XPS"
      content_left: |
