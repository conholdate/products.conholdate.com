...
############################# Head ############################
head_title: "Convert TXT to JPEG in Java | Java Word Conversion Library"
head_description: "Java Word processing documents conversion API. Convert TXT to JPEG and 100+ other images and file formats in Java applications using NetBeans, IntelliJ IDEA and Eclipse development environments."

############################# Header ############################
title: "Java Library for TXT to JPEG Conversion"
...
content:
    ...
    - title_left: "How to Convert TXT to JPEG in Java"
      content_left: |
          Perform TXT to JPEG file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
