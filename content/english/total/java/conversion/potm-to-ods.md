...
draft: false
path: "total/java/conversion/potm-to-ods/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java POTM to ODS Conversion"
ad_description: "POTM to ODS document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert POTM to ODS in Java & J2SE Applications"
head_description: "Java document conversion library to convert POTM to ODS and 100+ other file formats in Java & J2SE applications. View the Converted ODS document as HTML viewer."

############################# Header ############################
title: "Convert POTM to ODS in Java & View as HTML"
description: "Programmatically convert POTM to ODS in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java POTM to ODS conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert POTM to ODS in Java"
      content_left: |
          Perform POTM to ODS file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected POTM to ODS"
      content_left: |
