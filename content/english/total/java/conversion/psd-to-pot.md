...
draft: false
path: "total/java/conversion/psd-to-pot/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java PSD to POT Conversion"
ad_description: "PSD to POT document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert PSD to POT in Java & J2SE Applications"
head_description: "Java document conversion library to convert PSD to POT and 100+ other file formats in Java & J2SE applications. View the Converted POT document as HTML viewer."

############################# Header ############################
title: "Convert PSD to POT in Java & View as HTML"
description: "Programmatically convert PSD to POT in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java PSD to POT conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert PSD to POT in Java"
      content_left: |
          Perform PSD to POT file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected PSD to POT"
      content_left: |
