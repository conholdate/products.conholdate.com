...
ad_headline: "Java POTX to XLS Conversion"
ad_description: "POTX to XLS document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert POTX to XLS in Java & J2SE Applications"
...
description: "Programmatically convert POTX to XLS in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java POTX to XLS conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert POTX to XLS in Java"
      content_left: |
          Perform POTX to XLS file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
