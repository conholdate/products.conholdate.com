...
content:
    ...
    - title_left: "How to Convert XLSM to POTM in Java"
      content_left: |
          Perform XLSM to POTM file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
