...
content:
    enable: true
    block:
    - title_left: "How to Convert EXCEL to JSON in Java"
      content_left: |
          Perform EXCEL to JSON file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.

          -   Create a new instance of **Converter** class and load the EXCEL file
          -   Set **ConvertOptions** for the JSON document type
    ...
    - title_left: "Convert Password Protected EXCEL to JSON"
      content_left: |
