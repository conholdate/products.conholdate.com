...
content:
    enable: true
    block:
    - title_left: "How to Convert XLT to MD in Java"
      content_left: |
          Perform XLT to MD file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected XLT to MD"
      content_left: |
