...
content:
    ...
    - title_left: "How to Convert TXT to EMF in Java"
      content_left: |
          Perform TXT to EMF file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
