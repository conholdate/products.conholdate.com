...
ad_headline: "Java PPSM to MHTML Conversion"
ad_description: "PPSM to MHTML document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert PPSM to MHTML in Java & J2SE Applications"
...
content:
    enable: true
    block:
    - title_left: "How to Convert PPSM to MHTML in Java"
      content_left: |
          Perform PPSM to MHTML file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
