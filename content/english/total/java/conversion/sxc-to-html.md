...
content:
    ...
    - title_left: "How to Convert SXC to HTML in Java"
      content_left: |
          Perform SXC to HTML file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
