...
content:
    ...
    - title_left: "How to Convert XLAM to DOT in Java"
      content_left: |
          Perform XLAM to DOT file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
