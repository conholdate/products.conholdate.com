...
content:
    ...
    - title_left: "How to Convert RTF to POTX in Java"
      content_left: |
          Perform RTF to POTX file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
