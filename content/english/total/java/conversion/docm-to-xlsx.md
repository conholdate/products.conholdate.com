...
content:
    ...
    - title_left: "How to Convert DOCM to XLSX in Java"
      content_left: |
          Perform DOCM to XLSX file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
