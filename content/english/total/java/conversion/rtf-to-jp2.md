...
content:
    ...
    - title_left: "How to Convert RTF to JP2 in Java"
      content_left: |
          Perform RTF to JP2 file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
