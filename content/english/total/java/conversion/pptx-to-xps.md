...
ad_headline: "Java PPTX to XPS Conversion"
ad_description: "PPTX to XPS document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert PPTX to XPS in Java & J2SE Applications"
...
description: "Programmatically convert PPTX to XPS in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java PPTX to XPS conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert PPTX to XPS in Java"
      content_left: |
          Perform PPTX to XPS file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
