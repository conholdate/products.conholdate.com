...
ad_headline: "Java MHTML to PPSX Conversion"
ad_description: "MHTML to PPSX document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert MHTML to PPSX in Java & J2SE Applications"
...
content:
    enable: true
    block:
    - title_left: "How to Convert MHTML to PPSX in Java"
      content_left: |
          Perform MHTML to PPSX file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
