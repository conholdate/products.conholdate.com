...
content:
    enable: true
    block:
    - title_left: "How to Convert SXC to MD in Java"
      content_left: |
          Perform SXC to MD file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected SXC to MD"
      content_left: |
