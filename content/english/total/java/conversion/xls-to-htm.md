...
content:
    ...
    - title_left: "How to Convert XLS to HTM in Java"
      content_left: |
          Perform XLS to HTM file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
