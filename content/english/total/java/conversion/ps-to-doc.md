...
ad_headline: "Java PS to DOC Conversion"
ad_description: "PS to DOC document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert PS to DOC in Java & J2SE Applications"
...
description: "Programmatically convert PS to DOC in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java PS to DOC conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert PS to DOC in Java"
      content_left: |
          Perform PS to DOC file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
