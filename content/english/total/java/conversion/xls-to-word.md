...
content:
    enable: true
    block:
    - title_left: "How to Convert XLS to WORD in Java"
      content_left: |
          Perform XLS to WORD file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected XLS to WORD"
      content_left: |
