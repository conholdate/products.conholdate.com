...
content:
    enable: true
    block:
    - title_left: "How to Convert XLT to DICOM in Java"
      content_left: |
          Perform XLT to DICOM file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected XLT to DICOM"
      content_left: |
