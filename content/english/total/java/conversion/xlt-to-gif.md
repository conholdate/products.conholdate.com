...
content:
    ...
    - title_left: "How to Convert XLT to GIF in Java"
      content_left: |
          Perform XLT to GIF file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
