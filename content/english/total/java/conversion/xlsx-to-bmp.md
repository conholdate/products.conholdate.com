...
content:
    ...
    - title_left: "How to Convert XLSX to BMP in Java"
      content_left: |
          Perform XLSX to BMP file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
