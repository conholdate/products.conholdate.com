...
draft: false
path: "total/java/conversion/cf2-to-xlam/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java CF2 to XLAM Conversion"
ad_description: "CF2 to XLAM document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert CF2 to XLAM in Java & J2SE Applications"
head_description: "Java document conversion library to convert CF2 to XLAM and 100+ other file formats in Java & J2SE applications. View the Converted XLAM document as HTML viewer."

############################# Header ############################
title: "Convert CF2 to XLAM in Java & View as HTML"
description: "Programmatically convert CF2 to XLAM in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java CF2 to XLAM conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert CF2 to XLAM in Java"
      content_left: |
          Perform CF2 to XLAM file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected CF2 to XLAM"
      content_left: |
