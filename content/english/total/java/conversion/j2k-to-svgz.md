...
draft: false
path: "total/java/conversion/j2k-to-svgz/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java J2K to SVGZ Conversion"
ad_description: "J2K to SVGZ document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert J2K to SVGZ in Java & J2SE Applications"
head_description: "Java document conversion library to convert J2K to SVGZ and 100+ other file formats in Java & J2SE applications. View the Converted SVGZ document as HTML viewer."

############################# Header ############################
title: "Convert J2K to SVGZ in Java & View as HTML"
description: "Programmatically convert J2K to SVGZ in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java J2K to SVGZ conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert J2K to SVGZ in Java"
      content_left: |
          Perform J2K to SVGZ file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected J2K to SVGZ"
      content_left: |
