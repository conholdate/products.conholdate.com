...
content:
    ...
    - title_left: "How to Convert XLTX to DOTX in Java"
      content_left: |
          Perform XLTX to DOTX file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
