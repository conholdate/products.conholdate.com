...
content:
    ...
    - title_left: "How to Convert CSV to XLT in Java"
      content_left: |
          Perform CSV to XLT file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
