...
############################# Head ############################
head_title: "Convert DOT to HTM in Java - Sample Java Code"
...
description: "Programmatically convert DOT to HTM in Java & J2SE platforms using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java document conversion library."
...
content:
    enable: true
    block:
    - title_left: "DOT to HTM Conversion in Java"
      content_left: |
          Perform DOT to HTM file conversion in three simple steps using Java. View the converted document as HTML without any external software dependency.
