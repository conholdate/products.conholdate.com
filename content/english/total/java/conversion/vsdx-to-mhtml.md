...
ad_headline: "Java VSDX to MHTML Conversion"
ad_description: "VSDX to MHTML document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert VSDX to MHTML in Java & J2SE Applications"
...
content:
    enable: true
    block:
    - title_left: "How to Convert VSDX to MHTML in Java"
      content_left: |
          Perform VSDX to MHTML file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
