...
draft: false
path: "total/java/conversion/otp-to-dotm/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java OTP to DOTM Conversion"
ad_description: "OTP to DOTM document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert OTP to DOTM in Java & J2SE Applications"
head_description: "Java document conversion library to convert OTP to DOTM and 100+ other file formats in Java & J2SE applications. View the Converted DOTM document as HTML viewer."

############################# Header ############################
title: "Convert OTP to DOTM in Java & View as HTML"
description: "Programmatically convert OTP to DOTM in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java OTP to DOTM conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert OTP to DOTM in Java"
      content_left: |
          Perform OTP to DOTM file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected OTP to DOTM"
      content_left: |
