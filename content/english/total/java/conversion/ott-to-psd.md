...
content:
    ...
    - title_left: "How to Convert OTT to PSD in Java"
      content_left: |
          Perform OTT to PSD file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
