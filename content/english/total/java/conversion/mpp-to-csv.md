...
ad_headline: "Java MPP to CSV Conversion"
ad_description: "MPP to CSV document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert MPP to CSV in Java & J2SE Applications"
...
description: "Programmatically convert MPP to CSV in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java MPP to CSV conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert MPP to CSV in Java"
      content_left: |
          Perform MPP to CSV file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
