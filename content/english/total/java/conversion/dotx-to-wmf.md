...
content:
    ...
    - title_left: "How to Convert DOTX to WMF in Java"
      content_left: |
          Perform DOTX to WMF file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
