...
ad_headline: "Java MHT to XLS Conversion"
ad_description: "MHT to XLS document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert MHT to XLS in Java & J2SE Applications"
...
description: "Programmatically convert MHT to XLS in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java MHT to XLS conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert MHT to XLS in Java"
      content_left: |
          Perform MHT to XLS file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
