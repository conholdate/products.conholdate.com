...
content:
    enable: true
    block:
    - title_left: "How to Convert DOCX to TGA in Java"
      content_left: |
          Perform DOCX to TGA file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
