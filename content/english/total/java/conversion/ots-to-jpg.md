...
content:
    ...
    - title_left: "How to Convert OTS to JPG in Java"
      content_left: |
          Perform OTS to JPG file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
