...
content:
    ...
    - title_left: "How to Convert XLSB to PPTX in Java"
      content_left: |
          Perform XLSB to PPTX file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
