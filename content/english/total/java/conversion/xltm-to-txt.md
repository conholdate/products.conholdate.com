...
content:
    ...
    - title_left: "How to Convert XLTM to TXT in Java"
      content_left: |
          Perform XLTM to TXT file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
