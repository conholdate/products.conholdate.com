...
############################# Head ############################
head_title: "Convert DOC to PDF in Java | Java Word Conversion Library"
head_description: "Java Word processing documents conversion API. Convert DOC to PDF and 100+ other images and file formats in Java applications using NetBeans, IntelliJ IDEA and Eclipse development environments."

############################# Header ############################
title: "Java Library for DOC to PDF Conversion"
...
content:
    ...
    - title_left: "How to Convert DOC to PDF in Java"
      content_left: |
          Perform DOC to PDF file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
