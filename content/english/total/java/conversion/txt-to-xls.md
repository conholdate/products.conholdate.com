...
ad_headline: "Java TXT to XLS Conversion"
ad_description: "TXT to XLS document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert TXT to XLS in Java & J2SE Applications"
...
description: "Programmatically convert TXT to XLS in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java TXT to XLS conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert TXT to XLS in Java"
      content_left: |
          Perform TXT to XLS file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
