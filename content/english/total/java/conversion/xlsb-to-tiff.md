...
content:
    ...
    - title_left: "How to Convert XLSB to TIFF in Java"
      content_left: |
          Perform XLSB to TIFF file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
