...
content:
    ...
    - title_left: "How to Convert CSV to ODT in Java"
      content_left: |
          Perform CSV to ODT file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
