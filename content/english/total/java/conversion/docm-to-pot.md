...
content:
    ...
    - title_left: "How to Convert DOCM to POT in Java"
      content_left: |
          Perform DOCM to POT file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
