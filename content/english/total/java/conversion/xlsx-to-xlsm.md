...
############################# Head ############################
head_title: "Convert XLSX to XLSM in Java & J2SE Applications"
...
description: "Programmatically convert XLSX to XLSM in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java XLSX to XLSM conversion library."
...
content:
    ...
    - title_left: "How to Convert XLSX to XLSM in Java"
      content_left: |
          Perform XLSX to XLSM file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
