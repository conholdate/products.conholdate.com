...
draft: false
path: "total/java/conversion/txt-to-emz/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java TXT to EMZ Conversion"
ad_description: "TXT to EMZ document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert TXT to EMZ in Java & J2SE Applications"
head_description: "Java document conversion library to convert TXT to EMZ and 100+ other file formats in Java & J2SE applications. View the Converted EMZ document as HTML viewer."

############################# Header ############################
title: "Convert TXT to EMZ in Java & View as HTML"
description: "Programmatically convert TXT to EMZ in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java TXT to EMZ conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert TXT to EMZ in Java"
      content_left: |
          Perform TXT to EMZ file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected TXT to EMZ"
      content_left: |
