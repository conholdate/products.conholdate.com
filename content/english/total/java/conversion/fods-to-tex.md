...
content:
    ...
    - title_left: "How to Convert FODS to TEX in Java"
      content_left: |
          Perform FODS to TEX file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
