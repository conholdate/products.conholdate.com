...
############################# Head ############################
head_title: "Convert DOC to PPSM in Java | Java Word Conversion Library"
head_description: "Java Word processing documents conversion API. Convert DOC to PPSM and 100+ other images and file formats in Java applications using NetBeans, IntelliJ IDEA and Eclipse development environments."

############################# Header ############################
title: "Java Library for DOC to PPSM Conversion"
...
content:
    ...
    - title_left: "How to Convert DOC to PPSM in Java"
      content_left: |
          Perform DOC to PPSM file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
