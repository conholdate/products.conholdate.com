...
content:
    ...
    - title_left: "How to Convert XLSX to PNG in Java"
      content_left: |
          Perform XLSX to PNG file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
