...
content:
    ...
    - title_left: "How to Convert CSV to OTP in Java"
      content_left: |
          Perform CSV to OTP file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
