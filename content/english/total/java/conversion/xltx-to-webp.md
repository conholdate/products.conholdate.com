...
content:
    ...
    - title_left: "How to Convert XLTX to WEBP in Java"
      content_left: |
          Perform XLTX to WEBP file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
