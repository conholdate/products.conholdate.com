...
content:
    ...
    - title_left: "How to Convert ODT to ICO in Java"
      content_left: |
          Perform ODT to ICO file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
