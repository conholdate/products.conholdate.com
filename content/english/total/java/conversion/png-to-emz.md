...
draft: false
path: "total/java/conversion/png-to-emz/"
other_out_formats: "PDF DOCX DOT DOTX DOTM TXT RTF HTML MHTML XLS XLSX XLSM XLT XLTX XLTM DIF PPT PPTX PPS PPSX POT POTX POTM ODT OTT EMZ WMZ SVGZ TEX DCM WMF BMP PNG GIF JPEG TIFF"
ad_headline: "Java PNG to EMZ Conversion"
ad_description: "PNG to EMZ document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert PNG to EMZ in Java & J2SE Applications"
head_description: "Java document conversion library to convert PNG to EMZ and 100+ other file formats in Java & J2SE applications. View the Converted EMZ document as HTML viewer."

############################# Header ############################
title: "Convert PNG to EMZ in Java & View as HTML"
description: "Programmatically convert PNG to EMZ in Java & J2SE applications using flexible document manipulation options to customize the resultant document. Convert the complete document or some specific pages based on page numbers or selective page ranges using Java PNG to EMZ conversion library."
...
content:
    enable: true
    block:
    - title_left: "How to Convert PNG to EMZ in Java"
      content_left: |
          Perform PNG to EMZ file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected PNG to EMZ"
      content_left: |
