...
content:
    ...
    - title_left: "How to Convert RTF to WMZ in Java"
      content_left: |
          Perform RTF to WMZ file conversion in Java using three simple steps. View the converted MHTML document as it is or render and display it as HTML without using any external software.
