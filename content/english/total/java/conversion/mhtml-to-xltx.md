...
ad_headline: "Java MHTML to XLTX Conversion"
ad_description: "MHTML to XLTX document conversion API for Java | 100+ file formats supported"

############################# Head ############################
head_title: "Convert MHTML to XLTX in Java & J2SE Applications"
...
content:
    enable: true
    block:
    - title_left: "How to Convert MHTML to XLTX in Java"
      content_left: |
          Perform MHTML to XLTX file conversion in Java using three simple steps. View the converted document as HTML without any external software dependency.
