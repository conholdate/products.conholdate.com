...
content:
    enable: true
    block:
    - title_left: "How to Convert EXCEL to WMF in Java"
      content_left: |
          Perform EXCEL to WMF file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
    ...
    - title_left: "Convert Password Protected EXCEL to WMF"
      content_left: |
