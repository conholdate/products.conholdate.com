...
content:
    enable: true
    block:
    - title_left: "How to Convert FODS to RTF in Java"
      content_left: |
          Perform FODS to RTF file conversion in Java using three simple steps. View the converted document as it is or render it to view as HTML without any external software dependency.
