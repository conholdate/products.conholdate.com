...
content:
    enable: true
    block:
    - title_left: "Come convertire XLSX in XPS in Java"
      content_left: |
          Esegui la conversione di file XLSX in XPS in Java utilizzando tre semplici passaggi. Visualizza il documento convertito così com'è o visualizzalo come HTML senza alcuna dipendenza da software esterno.

          -   Crea una nuova istanza della classe **Converter** e carica il file XLSX
          -   Impostare **ConvertOptions** per il tipo di documento XPS
    ...
    - title_left: "Converti XLSX protetto da password in XPS"
      content_left: |
