...
content:
    enable: true
    block:
    - title_left: "Come convertire XLT in POTX in Java"
      content_left: |
          Esegui la conversione di file XLT in POTX in Java utilizzando tre semplici passaggi. Visualizza il documento convertito così com'è o visualizzalo come HTML senza alcuna dipendenza da software esterno.
    ...
    - title_left: "Converti XLT protetto da password in POTX"
      content_left: |
