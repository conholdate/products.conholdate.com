...
content:
    enable: true
    block:
    - title_left: "Come convertire DOTX in OTT in Java"
      content_left: |
          Esegui la conversione di file DOTX in OTT in Java utilizzando tre semplici passaggi. Visualizza il documento MHTML convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
