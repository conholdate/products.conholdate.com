...
content:
    enable: true
    block:
    - title_left: "Come convertire XLS in TEX in Java"
      content_left: |
          Esegui la conversione di file XLS in TEX in Java utilizzando tre semplici passaggi. Visualizza il documento convertito così com'è o visualizzalo come HTML senza alcuna dipendenza da software esterno.
    ...
    - title_left: "Converti XLS protetto da password in TEX"
      content_left: |
