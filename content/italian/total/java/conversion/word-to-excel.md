...
content:
    enable: true
    block:
    - title_left: "Come convertire WORD in EXCEL in Java"
      content_left: |
          Esegui la conversione di file WORD in EXCEL in Java utilizzando tre semplici passaggi. Visualizza il documento MHTML convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.

          -   Crea una nuova istanza della classe **Converter** e carica il file WORD
          -   Impostare **ConvertOptions** per il tipo di documento EXCEL
