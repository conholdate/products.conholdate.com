...
content:
    enable: true
    block:
    - title_left: "Come convertire XLSX in DOTM in Java"
      content_left: |
          Esegui la conversione di file XLSX in DOTM in Java utilizzando tre semplici passaggi. Visualizza il documento convertito così com'è o visualizzalo come HTML senza alcuna dipendenza da software esterno.
    ...
    - title_left: "Converti XLSX protetto da password in DOTM"
      content_left: |
