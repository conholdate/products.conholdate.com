...
content:
    enable: true
    block:
    - title_left: "Come convertire XLSM in DIF in Java"
      content_left: |
          Esegui la conversione di file XLSM in DIF in Java utilizzando tre semplici passaggi. Visualizza il documento convertito così com'è o visualizzalo come HTML senza alcuna dipendenza da software esterno.
    ...
    - title_left: "Converti XLSM protetto da password in DIF"
      content_left: |
