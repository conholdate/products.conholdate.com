...
content:
    enable: true
    block:
    - title_left: "Come convertire XLAM in TEX in Java"
      content_left: |
          Esegui la conversione di file XLAM in TEX in Java utilizzando tre semplici passaggi. Visualizza il documento convertito così com'è o visualizzalo come HTML senza alcuna dipendenza da software esterno.

          -   Crea una nuova istanza della classe **Converter** e carica il file XLAM
          -   Impostare **ConvertOptions** per il tipo di documento TEX
    ...
    - title_left: "Converti XLAM protetto da password in TEX"
      content_left: |
