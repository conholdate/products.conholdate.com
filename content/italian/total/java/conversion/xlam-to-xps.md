...
content:
    enable: true
    block:
    - title_left: "Come convertire XLAM in XPS in Java"
      content_left: |
          Esegui la conversione di file XLAM in XPS in Java utilizzando tre semplici passaggi. Visualizza il documento convertito così com'è o visualizzalo come HTML senza alcuna dipendenza da software esterno.
    ...
    - title_left: "Converti XLAM protetto da password in XPS"
      content_left: |
