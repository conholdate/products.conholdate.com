...
content:
    enable: true
    block:
    - title_left: "Come convertire FODS in WORD in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da FODS a WORD in .NET. Visualizza il documento WORD convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.

          -   Crea un oggetto **Converter** per convertire il documento FODS
          -   Imposta le opzioni di conversione per il formato WORD
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a WORD in C#"
      content_left: |
          Converti accuratamente i documenti (da FODS a WORD) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
