...
content:
    enable: true
    block:
    - title_left: "Come convertire XLAM in CSV in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLAM a CSV in .NET. Visualizza il documento CSV convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a CSV in C#"
      content_left: |
          Converti accuratamente i documenti (da XLAM a CSV) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
