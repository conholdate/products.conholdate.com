...
content:
    enable: true
    block:
    - title_left: "Come convertire DOTX in XLAM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da DOTX a XLAM in .NET. Visualizza il documento XLAM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.

          -   Crea un oggetto **Converter** per convertire il documento DOTX
          -   Imposta le opzioni di conversione per il formato XLAM
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a XLAM in C#"
      content_left: |
          Converti accuratamente i documenti (da DOTX a XLAM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
