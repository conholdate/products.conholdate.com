...
content:
    enable: true
    block:
    - title_left: "Come convertire XLT in POT in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLT a POT in .NET. Visualizza il documento POT convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a POT in C#"
      content_left: |
          Converti accuratamente i documenti (da XLT a POT) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
