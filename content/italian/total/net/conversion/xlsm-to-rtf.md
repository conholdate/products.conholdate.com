...
content:
    enable: true
    block:
    - title_left: "Come convertire XLSM in RTF in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLSM a RTF in .NET. Visualizza il documento RTF convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a RTF in C#"
      content_left: |
          Converti accuratamente i documenti (da XLSM a RTF) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
