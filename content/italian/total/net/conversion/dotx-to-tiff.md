...
content:
    enable: true
    block:
    - title_left: "Come convertire DOTX in TIFF in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da DOTX a TIFF in .NET. Visualizza il documento TIFF convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.

          -   Crea un oggetto **Converter** per convertire il documento DOTX
          -   Imposta le opzioni di conversione per il formato TIFF
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a TIFF in C#"
      content_left: |
          Converti accuratamente i documenti (da DOTX a TIFF) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
