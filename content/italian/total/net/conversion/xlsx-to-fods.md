...
content:
    enable: true
    block:
    - title_left: "Come convertire XLSX in FODS in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLSX a FODS in .NET. Visualizza il documento FODS convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a FODS in C#"
      content_left: |
          Converti accuratamente i documenti (da XLSX a FODS) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
