...
content:
    enable: true
    block:
    - title_left: "Come convertire XLTM in HTML in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLTM a HTML in .NET. Visualizza il documento HTML convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a HTML in C#"
      content_left: |
          Converti accuratamente i documenti (da XLTM a HTML) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
