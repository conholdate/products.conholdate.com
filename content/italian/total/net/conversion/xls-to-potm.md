...
content:
    enable: true
    block:
    - title_left: "Come convertire XLS in POTM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLS a POTM in .NET. Visualizza il documento POTM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a POTM in C#"
      content_left: |
          Converti accuratamente i documenti (da XLS a POTM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
