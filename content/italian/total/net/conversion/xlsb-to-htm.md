...
content:
    enable: true
    block:
    - title_left: "Come convertire XLSB in HTM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLSB a HTM in .NET. Visualizza il documento HTM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a HTM in C#"
      content_left: |
          Converti accuratamente i documenti (da XLSB a HTM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
