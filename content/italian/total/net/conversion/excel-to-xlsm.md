...
content:
    enable: true
    block:
    - title_left: "Come convertire EXCEL in XLSM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da EXCEL a XLSM in .NET. Visualizza il documento XLSM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a XLSM in C#"
      content_left: |
          Converti accuratamente i documenti (da EXCEL a XLSM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
