...
content:
    enable: true
    block:
    - title_left: "Come convertire ODS in PPTX in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da ODS a PPTX in .NET. Visualizza il documento PPTX convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a PPTX in C#"
      content_left: |
          Converti accuratamente i documenti (da ODS a PPTX) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
