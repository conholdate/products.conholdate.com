...
content:
    enable: true
    block:
    - title_left: "Come convertire XLAM in TIFF in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLAM a TIFF in .NET. Visualizza il documento TIFF convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a TIFF in C#"
      content_left: |
          Converti accuratamente i documenti (da XLAM a TIFF) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
