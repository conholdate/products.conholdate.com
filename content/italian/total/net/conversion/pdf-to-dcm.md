...
content:
    enable: true
    block:
    - title_left: "Come convertire PDF in DCM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da PDF a DCM in .NET. Visualizza il documento convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
