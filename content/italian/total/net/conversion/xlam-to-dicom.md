...
content:
    enable: true
    block:
    - title_left: "Come convertire XLAM in DICOM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLAM a DICOM in .NET. Visualizza il documento DICOM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a DICOM in C#"
      content_left: |
          Converti accuratamente i documenti (da XLAM a DICOM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
