...
content:
    enable: true
    block:
    - title_left: "Come convertire FODS in MD in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da FODS a MD in .NET. Visualizza il documento MD convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a MD in C#"
      content_left: |
          Converti accuratamente i documenti (da FODS a MD) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
