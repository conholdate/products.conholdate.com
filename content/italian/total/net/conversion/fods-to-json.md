...
content:
    enable: true
    block:
    - title_left: "Come convertire FODS in JSON in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da FODS a JSON in .NET. Visualizza il documento JSON convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.

          -   Crea un oggetto **Converter** per convertire il documento FODS
          -   Imposta le opzioni di conversione per il formato JSON
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a JSON in C#"
      content_left: |
          Converti accuratamente i documenti (da FODS a JSON) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
