...
content:
    enable: true
    block:
    - title_left: "Come convertire SXC in MHTML in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da SXC a MHTML in .NET. Visualizza il documento MHTML convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.

          -   Crea un oggetto **Converter** per convertire il documento SXC
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a MHTML in C#"
      content_left: |
          Converti accuratamente i documenti (da SXC a MHTML) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
