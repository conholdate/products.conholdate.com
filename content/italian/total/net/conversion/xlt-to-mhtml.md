...
content:
    enable: true
    block:
    - title_left: "Come convertire XLT in MHTML in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLT a MHTML in .NET. Visualizza il documento MHTML convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a MHTML in C#"
      content_left: |
          Converti accuratamente i documenti (da XLT a MHTML) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
