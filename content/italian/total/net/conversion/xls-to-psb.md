...
content:
    enable: true
    block:
    - title_left: "Come convertire XLS in PSB in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLS a PSB in .NET. Visualizza il documento PSB convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a PSB in C#"
      content_left: |
          Converti accuratamente i documenti (da XLS a PSB) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
