...
content:
    enable: true
    block:
    - title_left: "Come convertire XLSM in PPTM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLSM a PPTM in .NET. Visualizza il documento PPTM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a PPTM in C#"
      content_left: |
          Converti accuratamente i documenti (da XLSM a PPTM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
