...
content:
    enable: true
    block:
    - title_left: "Come convertire XLTX in EMZ in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da XLTX a EMZ in .NET. Visualizza il documento EMZ convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a EMZ in C#"
      content_left: |
          Converti accuratamente i documenti (da XLTX a EMZ) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
