...
content:
    enable: true
    block:
    - title_left: "Come convertire DOCX in TGA in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da DOCX a TGA in .NET. Visualizza il documento TGA convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.

          -   Crea un oggetto **Converter** per convertire il documento DOCX
          -   Imposta le opzioni di conversione per il formato TGA
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a TGA in C#"
      content_left: |
          Converti accuratamente i documenti (da DOCX a TGA) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
