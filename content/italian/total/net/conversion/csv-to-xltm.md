...
content:
    enable: true
    block:
    - title_left: "Come convertire CSV in XLTM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da CSV a XLTM in .NET. Visualizza il documento XLTM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a XLTM in C#"
      content_left: |
          Converti accuratamente i documenti (da CSV a XLTM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
