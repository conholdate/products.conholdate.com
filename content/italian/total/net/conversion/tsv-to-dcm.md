...
content:
    enable: true
    block:
    - title_left: "Come convertire TSV in DCM in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da TSV a DCM in .NET. Visualizza il documento DCM convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a DCM in C#"
      content_left: |
          Converti accuratamente i documenti (da TSV a DCM) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
