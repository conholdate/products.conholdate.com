...
content:
    enable: true
    block:
    - title_left: "Come convertire DOCX in PPT in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da DOCX a PPT in .NET. Visualizza il documento PPT convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a PPT in C#"
      content_left: |
          Converti accuratamente i documenti (da DOCX a PPT) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
