...
content:
    enable: true
    block:
    - title_left: "Come convertire TSV in BMP in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da TSV a BMP in .NET. Visualizza il documento BMP convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a BMP in C#"
      content_left: |
          Converti accuratamente i documenti (da TSV a BMP) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
