...
content:
    enable: true
    block:
    - title_left: "Come convertire WORD in SVG in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da WORD a SVG in .NET. Visualizza il documento SVG convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a SVG in C#"
      content_left: |
          Converti accuratamente i documenti (da WORD a SVG) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
