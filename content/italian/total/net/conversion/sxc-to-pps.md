...
content:
    enable: true
    block:
    - title_left: "Come convertire SXC in PPS in C# .NET"
      content_left: |
          Segui questi semplici passaggi per la conversione da SXC a PPS in .NET. Visualizza il documento PPS convertito così com'è o esegui il rendering e visualizzalo come HTML senza utilizzare alcun software esterno.
    ...
    - title_left: "Aggiungi filigrana di testo o immagine a PPS in C#"
      content_left: |
          Converti accuratamente i documenti (da SXC a PPS) esattamente come il file originale e applica filigrane di testo o immagini alle pagine del documento convertito utilizzando C# .NET.
