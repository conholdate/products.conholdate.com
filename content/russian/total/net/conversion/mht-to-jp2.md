...
draft: false
path: "ru/total/net/conversion/mht-to-jp2/"
...
content:
    enable: true
    block:
    - title_left: "Преобразование MHT в JP2 на C# .NET"
      content_left: |
          Выполните следующие простые шаги для преобразования MHT в JP2 в .NET. Просматривайте преобразованный документ JP2 как есть или визуализируйте и отображайте его в виде HTML, PDF или изображения без использования какого-либо внешнего программного обеспечения.
