...
draft: false
path: "ru/total/net/conversion/xml-to-dif/"
...
content:
    enable: true
    block:
    - title_left: "Преобразование XML в DIF на C# .NET"
      content_left: |
          Выполните следующие простые шаги для преобразования XML в DIF в .NET. Просматривайте преобразованный документ DIF как есть или визуализируйте и отображайте его в виде HTML, PDF или изображения без использования какого-либо внешнего программного обеспечения.
