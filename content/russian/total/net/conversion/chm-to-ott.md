...
draft: false
path: "ru/total/net/conversion/chm-to-ott/"
...
content:
    enable: true
    block:
    - title_left: "Преобразование CHM в OTT на C# .NET"
      content_left: |
          Выполните следующие простые шаги для преобразования CHM в OTT в .NET. Просматривайте преобразованный документ OTT как есть или визуализируйте и отображайте его в виде HTML, PDF или изображения без использования какого-либо внешнего программного обеспечения.
