...
content:
    enable: true
    block:
    - title_left: "Как конвертировать OTS в JP2 на Java"
      content_left: |
          Выполните преобразование файлов OTS в JP2 на Java, выполнив три простых шага. Просмотрите преобразованный документ как есть или визуализируйте его для просмотра в формате HTML без какой-либо зависимости от внешнего программного обеспечения.
    ...
    - title_left: "Конвертировать защищенный паролем OTS в JP2"
      content_left: |
