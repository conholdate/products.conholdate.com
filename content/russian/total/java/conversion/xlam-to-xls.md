...
content:
    enable: true
    block:
    - title_left: "Как конвертировать XLAM в XLS на Java"
      content_left: |
          Выполните преобразование файлов XLAM в XLS на Java, выполнив три простых шага. Просмотрите преобразованный документ как есть или визуализируйте его для просмотра в формате HTML без какой-либо зависимости от внешнего программного обеспечения.
    ...
    - title_left: "Конвертировать защищенный паролем XLAM в XLS"
      content_left: |
