...
content:
    enable: true
    block:
    - title_left: "Как конвертировать EXCEL в MD на Java"
      content_left: |
          Выполните преобразование файлов EXCEL в MD на Java, выполнив три простых шага. Просмотрите преобразованный документ как есть или визуализируйте его для просмотра в формате HTML без какой-либо зависимости от внешнего программного обеспечения.
    ...
    - title_left: "Конвертировать защищенный паролем EXCEL в MD"
      content_left: |
