...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLS σε XLTM σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLS σε XLTM σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLS που προστατεύεται με κωδικό πρόσβασης σε XLTM"
      content_left: |
