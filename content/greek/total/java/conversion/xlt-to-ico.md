...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLT σε ICO σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLT σε ICO σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLT που προστατεύεται με κωδικό πρόσβασης σε ICO"
      content_left: |
