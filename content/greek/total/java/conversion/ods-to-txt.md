...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το ODS σε TXT σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου ODS σε TXT σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή ODS που προστατεύεται με κωδικό πρόσβασης σε TXT"
      content_left: |
