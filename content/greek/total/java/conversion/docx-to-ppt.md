...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το DOCX σε PPT σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου DOCX σε PPT σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο MHTML που έχει μετατραπεί ως έχει ή αποδώστε το και εμφανίστε το ως HTML χωρίς τη χρήση εξωτερικού λογισμικού.
