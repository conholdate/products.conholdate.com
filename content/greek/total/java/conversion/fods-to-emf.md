...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το FODS σε EMF σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου FODS σε EMF σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή FODS που προστατεύεται με κωδικό πρόσβασης σε EMF"
      content_left: |
