...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLTM σε DIF σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLTM σε DIF σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.

          -   Δημιουργήστε μια νέα παρουσία της κλάσης **Converter** και φορτώστε το αρχείο XLTM
          -   Ορίστε **ConvertOptions** για τον τύπο εγγράφου DIF
    ...
    - title_left: "Μετατροπή XLTM που προστατεύεται με κωδικό πρόσβασης σε DIF"
      content_left: |
