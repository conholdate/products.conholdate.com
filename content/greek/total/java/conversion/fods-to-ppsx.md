...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το FODS σε PPSX σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου FODS σε PPSX σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.

          -   Δημιουργήστε μια νέα παρουσία της κλάσης **Converter** και φορτώστε το αρχείο FODS
          -   Ορίστε **ConvertOptions** για τον τύπο εγγράφου PPSX
    ...
    - title_left: "Μετατροπή FODS που προστατεύεται με κωδικό πρόσβασης σε PPSX"
      content_left: |
