...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το OTS σε WORD σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου OTS σε WORD σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή OTS που προστατεύεται με κωδικό πρόσβασης σε WORD"
      content_left: |
