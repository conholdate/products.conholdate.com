...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLTM σε PDF σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLTM σε PDF σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLTM που προστατεύεται με κωδικό πρόσβασης σε PDF"
      content_left: |
