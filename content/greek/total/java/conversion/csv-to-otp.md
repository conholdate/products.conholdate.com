...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το CSV σε OTP σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου CSV σε OTP σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή CSV που προστατεύεται με κωδικό πρόσβασης σε OTP"
      content_left: |
