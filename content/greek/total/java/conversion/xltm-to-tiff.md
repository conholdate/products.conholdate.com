...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLTM σε TIFF σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLTM σε TIFF σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLTM που προστατεύεται με κωδικό πρόσβασης σε TIFF"
      content_left: |
