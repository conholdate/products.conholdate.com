...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLTM σε JP2 σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLTM σε JP2 σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.

          -   Δημιουργήστε μια νέα παρουσία της κλάσης **Converter** και φορτώστε το αρχείο XLTM
          -   Ορίστε **ConvertOptions** για τον τύπο εγγράφου JP2
    ...
    - title_left: "Μετατροπή XLTM που προστατεύεται με κωδικό πρόσβασης σε JP2"
      content_left: |
