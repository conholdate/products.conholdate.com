...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLSM σε PPSM σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLSM σε PPSM σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.

          -   Δημιουργήστε μια νέα παρουσία της κλάσης **Converter** και φορτώστε το αρχείο XLSM
          -   Ορίστε **ConvertOptions** για τον τύπο εγγράφου PPSM
    ...
    - title_left: "Μετατροπή XLSM που προστατεύεται με κωδικό πρόσβασης σε PPSM"
      content_left: |
