...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLSX σε OTP σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLSX σε OTP σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLSX που προστατεύεται με κωδικό πρόσβασης σε OTP"
      content_left: |
