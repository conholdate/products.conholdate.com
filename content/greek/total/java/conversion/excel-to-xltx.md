...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το EXCEL σε XLTX σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου EXCEL σε XLTX σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή EXCEL που προστατεύεται με κωδικό πρόσβασης σε XLTX"
      content_left: |
