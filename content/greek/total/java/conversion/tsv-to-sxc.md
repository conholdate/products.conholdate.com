...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το TSV σε SXC σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου TSV σε SXC σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή TSV που προστατεύεται με κωδικό πρόσβασης σε SXC"
      content_left: |
