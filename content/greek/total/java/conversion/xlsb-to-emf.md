...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLSB σε EMF σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLSB σε EMF σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLSB που προστατεύεται με κωδικό πρόσβασης σε EMF"
      content_left: |
