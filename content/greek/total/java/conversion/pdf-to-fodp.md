...
draft: false
path: "el/total/java/conversion/pdf-to-fodp/"
other_out_formats: "DOC DOCX DOCM DOT DOTX DOTM TXT RTF HTML HTM MHTML MHT XLS XLSX XLSM XLSB XLT XLTX XLTM XLAM CSV TSV DIF SXC FODS PPT PPTX PPTM PPS PPSX PPSM POT POTX POTM ODT OTT OTP ODP ODS EMZ WMZ SVG SVGZ XPS TEX DCM WMF EMF BMP PNG GIF JPEG TIFF ICO WEBP JP2 TGA PSB PSD EPUB MD DICOM FODP JPG"
ad_headline: "Μετατροπή PDF σε FODP | Java"
ad_description: "Πιο ακριβής λύση μετατροπής εγγράφων PDF σε FODP για εφαρμογές Java."

############################# Head ############################
head_title: "Μετατροπή PDF σε FODP σε Java – API μετατροπής PDF"
head_description: "Μετατροπή PDF σε FODP σε εφαρμογές Java. Γρήγορο και ακριβές API μετατροπής PDF σε FODP για Java για μετατροπή PDF σε έγγραφα, εικόνες και 100+ άλλες μορφές αρχείων."

############################# Header ############################
title: "Μετατροπή PDF σε FODP σε εφαρμογές Java"
description: "Μετατρέψτε αρχεία PDF σε FODP σε εφαρμογές Java χρησιμοποιώντας ευέλικτες δυνατότητες μετατροπής εγγράφων για να χειριστείτε την εμφάνιση της μορφής εγγράφου που έχει μετατραπεί. Μετατρέψτε εύκολα ολόκληρο το έγγραφο ταυτόχρονα ή επιλέξτε συγκεκριμένες σελίδες του αρχείου PDF με βάση τους επιλεκτικούς αριθμούς σελίδων ή εύρος σελίδων και μετατρέψτε σε ένα ευρύ φάσμα υποστηριζόμενων μορφών εγγράφων, όπως έγγραφα επεξεργασίας κειμένου, υπολογιστικά φύλλα Excel, παρουσιάσεις PowerPoint, Photoshop, eBook, web και εικόνες."
...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το PDF σε FODP σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείων PDF σε αρχείο FODP σε Java χρησιμοποιώντας τρία απλά βήματα. Χρησιμοποιώντας το παρακάτω παράδειγμα κώδικα - δείτε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το περαιτέρω για προβολή ως αρχείο HTML χωρίς να εγκαταστήσετε εξωτερικό λογισμικό.

          -   Δημιουργήστε μια νέα παρουσία της κλάσης **Converter** και φορτώστε το αρχείο PDF
          -   Ορίστε **ConvertOptions** για τον τύπο αρχείου FODP
