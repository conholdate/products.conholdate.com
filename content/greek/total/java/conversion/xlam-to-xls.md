...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLAM σε XLS σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLAM σε XLS σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLAM που προστατεύεται με κωδικό πρόσβασης σε XLS"
      content_left: |
