...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLSX σε RTF σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLSX σε RTF σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.

          -   Δημιουργήστε μια νέα παρουσία της κλάσης **Converter** και φορτώστε το αρχείο XLSX
          -   Ορίστε **ConvertOptions** για τον τύπο εγγράφου RTF
    ...
    - title_left: "Μετατροπή XLSX που προστατεύεται με κωδικό πρόσβασης σε RTF"
      content_left: |
