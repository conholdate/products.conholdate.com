...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLTX σε PPS σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLTX σε PPS σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.

          -   Δημιουργήστε μια νέα παρουσία της κλάσης **Converter** και φορτώστε το αρχείο XLTX
          -   Ορίστε **ConvertOptions** για τον τύπο εγγράφου PPS
    ...
    - title_left: "Μετατροπή XLTX που προστατεύεται με κωδικό πρόσβασης σε PPS"
      content_left: |
