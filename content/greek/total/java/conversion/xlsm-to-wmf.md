...
content:
    enable: true
    block:
    - title_left: "Πώς να μετατρέψετε το XLSM σε WMF σε Java"
      content_left: |
          Εκτελέστε μετατροπή αρχείου XLSM σε WMF σε Java χρησιμοποιώντας τρία απλά βήματα. Προβάλετε το έγγραφο που έχει μετατραπεί ως έχει ή αποδώστε το ως HTML χωρίς καμία εξάρτηση από εξωτερικό λογισμικό.
    ...
    - title_left: "Μετατροπή XLSM που προστατεύεται με κωδικό πρόσβασης σε WMF"
      content_left: |
