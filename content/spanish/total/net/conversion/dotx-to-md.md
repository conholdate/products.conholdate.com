...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTX a MD en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOTX a MD en .NET. Vea el documento MD convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a MD en C#"
      content_left: |
          Convierta con precisión documentos (DOTX a MD) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
