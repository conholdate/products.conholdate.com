...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLAM a PPS en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de XLAM a PPS en .NET. Vea el documento PPS convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a PPS en C#"
      content_left: |
          Convierta con precisión documentos (XLAM a PPS) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
