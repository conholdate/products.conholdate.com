...
content:
    enable: true
    block:
    - title_left: "Cómo convertir PDF a DOTX en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de PDF a DOTX en .NET. Vea el documento convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
