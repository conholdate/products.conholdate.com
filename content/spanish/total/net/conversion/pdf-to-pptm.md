...
content:
    enable: true
    block:
    - title_left: "Cómo convertir PDF a PPTM en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de PDF a PPTM en .NET. Vea el documento convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
