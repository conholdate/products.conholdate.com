...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLSX a WMZ en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de XLSX a WMZ en .NET. Vea el documento WMZ convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a WMZ en C#"
      content_left: |
          Convierta con precisión documentos (XLSX a WMZ) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
