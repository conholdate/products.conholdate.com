...
content:
    enable: true
    block:
    - title_left: "Cómo convertir PDF a ODS en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de PDF a ODS en .NET. Vea el documento convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
