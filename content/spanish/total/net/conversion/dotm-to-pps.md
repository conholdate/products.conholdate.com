...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTM a PPS en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOTM a PPS en .NET. Vea el documento PPS convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.

          -   Crear objeto **Converter** para convertir documentos DOTM
          -   Establecer las opciones de conversión para el formato PPS
          -   Llame al método **Convert** de la instancia de la clase **Converter** para la conversión a PPS
          -   Establecer opciones para el visor HTML
          -   Cree un objeto **Viewer** para ver PPS convertido como HTML
    ...
    - title_left: "Agregar marca de agua de texto o imagen a PPS en C#"
      content_left: |
          Convierta con precisión documentos (DOTM a PPS) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
