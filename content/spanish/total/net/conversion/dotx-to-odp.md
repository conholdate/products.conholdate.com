...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTX a ODP en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOTX a ODP en .NET. Vea el documento ODP convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a ODP en C#"
      content_left: |
          Convierta con precisión documentos (DOTX a ODP) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
