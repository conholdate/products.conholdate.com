...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOC a GIF en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOC a GIF en .NET. Vea el documento GIF convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a GIF en C#"
      content_left: |
          Convierta con precisión documentos (DOC a GIF) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
