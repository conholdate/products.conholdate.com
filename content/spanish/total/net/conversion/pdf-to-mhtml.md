...
content:
    enable: true
    block:
    - title_left: "Cómo convertir PDF a MHTML en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de PDF a MHTML en .NET. Vea el documento convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
