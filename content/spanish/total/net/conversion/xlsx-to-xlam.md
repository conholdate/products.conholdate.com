...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLSX a XLAM en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de XLSX a XLAM en .NET. Vea el documento XLAM convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a XLAM en C#"
      content_left: |
          Convierta con precisión documentos (XLSX a XLAM) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
