...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOC a ODT en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOC a ODT en .NET. Vea el documento ODT convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a ODT en C#"
      content_left: |
          Convierta con precisión documentos (DOC a ODT) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
