...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTX a JPEG en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOTX a JPEG en .NET. Vea el documento JPEG convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a JPEG en C#"
      content_left: |
          Convierta con precisión documentos (DOTX a JPEG) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
