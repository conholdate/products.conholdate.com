...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOC a ICO en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOC a ICO en .NET. Vea el documento ICO convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a ICO en C#"
      content_left: |
          Convierta con precisión documentos (DOC a ICO) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
