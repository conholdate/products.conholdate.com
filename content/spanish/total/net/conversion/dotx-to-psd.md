...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTX a PSD en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOTX a PSD en .NET. Vea el documento PSD convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a PSD en C#"
      content_left: |
          Convierta con precisión documentos (DOTX a PSD) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
