...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTX a WEBP en C# .NET"
      content_left: |
          Siga estos sencillos pasos para la conversión de DOTX a WEBP en .NET. Vea el documento WEBP convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
    ...
    - title_left: "Agregar marca de agua de texto o imagen a WEBP en C#"
      content_left: |
          Convierta con precisión documentos (DOTX a WEBP) exactamente como el archivo original y aplique marcas de agua de texto o imagen a las páginas del documento convertido usando C# .NET.
