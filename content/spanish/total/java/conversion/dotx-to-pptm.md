...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTX a PPTM en Java"
      content_left: |
          Realice la conversión de archivos DOTX a PPTM en Java siguiendo tres sencillos pasos. Vea el documento MHTML convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
