...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLSX a XLAM en Java"
      content_left: |
          Realice la conversión de archivos XLSX a XLAM en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo XLSX
          -   Configure **ConvertOptions** para el tipo de documento XLAM
    ...
    - title_left: "Convierta XLSX protegido por contraseña a XLAM"
      content_left: |
