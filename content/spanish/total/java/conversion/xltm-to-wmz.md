...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLTM a WMZ en Java"
      content_left: |
          Realice la conversión de archivos XLTM a WMZ en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLTM protegido por contraseña a WMZ"
      content_left: |
