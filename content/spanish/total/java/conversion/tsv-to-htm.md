...
content:
    enable: true
    block:
    - title_left: "Cómo convertir TSV a HTM en Java"
      content_left: |
          Realice la conversión de archivos TSV a HTM en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta TSV protegido por contraseña a HTM"
      content_left: |
