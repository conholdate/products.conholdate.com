...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLAM a XLSB en Java"
      content_left: |
          Realice la conversión de archivos XLAM a XLSB en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLAM protegido por contraseña a XLSB"
      content_left: |
