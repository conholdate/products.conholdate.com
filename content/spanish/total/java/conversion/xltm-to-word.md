...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLTM a WORD en Java"
      content_left: |
          Realice la conversión de archivos XLTM a WORD en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo XLTM
          -   Configure **ConvertOptions** para el tipo de documento WORD
    ...
    - title_left: "Convierta XLTM protegido por contraseña a WORD"
      content_left: |
