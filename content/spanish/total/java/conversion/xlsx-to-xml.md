...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLSX a XML en Java"
      content_left: |
          Realice la conversión de archivos XLSX a XML en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLSX protegido por contraseña a XML"
      content_left: |
