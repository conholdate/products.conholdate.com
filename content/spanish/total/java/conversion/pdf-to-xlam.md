...
content:
    enable: true
    block:
    - title_left: "Cómo convertir PDF a XLAM en Java"
      content_left: |
          Realice la conversión de archivos PDF a archivos XLAM en Java mediante tres sencillos pasos. Usando el ejemplo de código a continuación: vea el documento convertido tal como está o reprodúzcalo para verlo como un archivo HTML sin instalar ningún software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo PDF
          -   Configure **ConvertOptions** para el tipo de archivo XLAM
