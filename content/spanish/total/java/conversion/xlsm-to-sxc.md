...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLSM a SXC en Java"
      content_left: |
          Realice la conversión de archivos XLSM a SXC en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo XLSM
          -   Configure **ConvertOptions** para el tipo de documento SXC
    ...
    - title_left: "Convierta XLSM protegido por contraseña a SXC"
      content_left: |
