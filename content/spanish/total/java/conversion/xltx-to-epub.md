...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLTX a EPUB en Java"
      content_left: |
          Realice la conversión de archivos XLTX a EPUB en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo XLTX
          -   Configure **ConvertOptions** para el tipo de documento EPUB
    ...
    - title_left: "Convierta XLTX protegido por contraseña a EPUB"
      content_left: |
