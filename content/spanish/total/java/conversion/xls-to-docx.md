...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLS a DOCX en Java"
      content_left: |
          Realice la conversión de archivos XLS a DOCX en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLS protegido por contraseña a DOCX"
      content_left: |
