...
content:
    enable: true
    block:
    - title_left: "Cómo convertir ODS a TGA en Java"
      content_left: |
          Realice la conversión de archivos ODS a TGA en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta ODS protegido por contraseña a TGA"
      content_left: |
