...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTX a EXCEL en Java"
      content_left: |
          Realice la conversión de archivos DOTX a EXCEL en Java siguiendo tres sencillos pasos. Vea el documento MHTML convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo DOTX
          -   Configure **ConvertOptions** para el tipo de documento EXCEL
          -   Llame al método **Convert** de la instancia de la clase **Converter** para la conversión a EXCEL
          -   Establecer opciones para el visor HTML
          -   Cree un objeto **Viewer** para ver EXCEL convertido como HTML
