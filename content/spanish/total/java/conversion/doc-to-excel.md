...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOC a EXCEL en Java"
      content_left: |
          Realice la conversión de archivos DOC a EXCEL en Java siguiendo tres sencillos pasos. Vea el documento MHTML convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo DOC
