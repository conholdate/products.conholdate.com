...
content:
    enable: true
    block:
    - title_left: "Cómo convertir TSV a DICOM en Java"
      content_left: |
          Realice la conversión de archivos TSV a DICOM en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo TSV
    ...
    - title_left: "Convierta TSV protegido por contraseña a DICOM"
      content_left: |
