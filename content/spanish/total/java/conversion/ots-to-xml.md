...
content:
    enable: true
    block:
    - title_left: "Cómo convertir OTS a XML en Java"
      content_left: |
          Realice la conversión de archivos OTS a XML en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta OTS protegido por contraseña a XML"
      content_left: |
