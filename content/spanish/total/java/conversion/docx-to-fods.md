...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOCX a FODS en Java"
      content_left: |
          Realice la conversión de archivos DOCX a FODS en Java siguiendo tres sencillos pasos. Vea el documento MHTML convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
