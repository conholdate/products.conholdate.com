...
content:
    enable: true
    block:
    - title_left: "Cómo convertir SXC a DOCM en Java"
      content_left: |
          Realice la conversión de archivos SXC a DOCM en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta SXC protegido por contraseña a DOCM"
      content_left: |
