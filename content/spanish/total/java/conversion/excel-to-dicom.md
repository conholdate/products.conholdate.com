...
content:
    enable: true
    block:
    - title_left: "Cómo convertir EXCEL a DICOM en Java"
      content_left: |
          Realice la conversión de archivos EXCEL a DICOM en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo EXCEL
    ...
    - title_left: "Convierta EXCEL protegido por contraseña a DICOM"
      content_left: |
