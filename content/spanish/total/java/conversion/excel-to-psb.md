...
content:
    enable: true
    block:
    - title_left: "Cómo convertir EXCEL a PSB en Java"
      content_left: |
          Realice la conversión de archivos EXCEL a PSB en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta EXCEL protegido por contraseña a PSB"
      content_left: |
