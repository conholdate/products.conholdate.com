...
content:
    enable: true
    block:
    - title_left: "Cómo convertir ODS a DICOM en Java"
      content_left: |
          Realice la conversión de archivos ODS a DICOM en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta ODS protegido por contraseña a DICOM"
      content_left: |
