...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLTM a HTML en Java"
      content_left: |
          Realice la conversión de archivos XLTM a HTML en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLTM protegido por contraseña a HTML"
      content_left: |
