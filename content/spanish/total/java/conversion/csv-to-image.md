...
content:
    enable: true
    block:
    - title_left: "Cómo convertir CSV a IMAGE en Java"
      content_left: |
          Realice la conversión de archivos CSV a IMAGE en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo CSV
    ...
    - title_left: "Convierta CSV protegido por contraseña a IMAGE"
      content_left: |
