...
content:
    enable: true
    block:
    - title_left: "Cómo convertir OTS a XLSB en Java"
      content_left: |
          Realice la conversión de archivos OTS a XLSB en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta OTS protegido por contraseña a XLSB"
      content_left: |
