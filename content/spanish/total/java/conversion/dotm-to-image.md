...
content:
    enable: true
    block:
    - title_left: "Cómo convertir DOTM a IMAGE en Java"
      content_left: |
          Realice la conversión de archivos DOTM a IMAGE en Java siguiendo tres sencillos pasos. Vea el documento MHTML convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo DOTM
