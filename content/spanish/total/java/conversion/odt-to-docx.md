...
content:
    enable: true
    block:
    - title_left: "Cómo convertir ODT a DOCX en Java"
      content_left: |
          Realice la conversión de archivos ODT a DOCX en Java siguiendo tres sencillos pasos. Vea el documento MHTML convertido tal como está o reprodúzcalo y muéstrelo como HTML sin usar ningún software externo.
