...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLT a IMAGE en Java"
      content_left: |
          Realice la conversión de archivos XLT a IMAGE en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo XLT
    ...
    - title_left: "Convierta XLT protegido por contraseña a IMAGE"
      content_left: |
