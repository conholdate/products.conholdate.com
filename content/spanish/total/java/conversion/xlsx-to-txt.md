...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLSX a TXT en Java"
      content_left: |
          Realice la conversión de archivos XLSX a TXT en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.

          -   Cree una nueva instancia de la clase **Converter** y cargue el archivo XLSX
          -   Configure **ConvertOptions** para el tipo de documento TXT
    ...
    - title_left: "Convierta XLSX protegido por contraseña a TXT"
      content_left: |
