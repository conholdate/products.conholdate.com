...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLT a TXT en Java"
      content_left: |
          Realice la conversión de archivos XLT a TXT en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLT protegido por contraseña a TXT"
      content_left: |
