...
content:
    enable: true
    block:
    - title_left: "Cómo convertir CSV a BMP en Java"
      content_left: |
          Realice la conversión de archivos CSV a BMP en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta CSV protegido por contraseña a BMP"
      content_left: |
