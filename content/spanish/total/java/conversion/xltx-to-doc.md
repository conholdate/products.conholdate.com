...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLTX a DOC en Java"
      content_left: |
          Realice la conversión de archivos XLTX a DOC en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLTX protegido por contraseña a DOC"
      content_left: |
