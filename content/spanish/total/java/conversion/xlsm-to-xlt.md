...
content:
    enable: true
    block:
    - title_left: "Cómo convertir XLSM a XLT en Java"
      content_left: |
          Realice la conversión de archivos XLSM a XLT en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta XLSM protegido por contraseña a XLT"
      content_left: |
