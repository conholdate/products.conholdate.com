...
content:
    enable: true
    block:
    - title_left: "Cómo convertir SXC a MD en Java"
      content_left: |
          Realice la conversión de archivos SXC a MD en Java siguiendo tres sencillos pasos. Vea el documento convertido tal como está o reprodúzcalo para verlo como HTML sin ninguna dependencia de software externo.
    ...
    - title_left: "Convierta SXC protegido por contraseña a MD"
      content_left: |
