...
content:
    enable: true
    block:
    - title_left: "So konvertieren Sie TSV in TEX in C# .NET"
      content_left: |
          Befolgen Sie diese einfachen Schritte für die Konvertierung von TSV in TEX in .NET. Sehen Sie sich das konvertierte TEX-Dokument so an, wie es ist, oder rendern und zeigen Sie es als HTML an, ohne externe Software zu verwenden.
    ...
    - title_left: "Hinzufügen von Text- oder Bildwasserzeichen zu TEX in C#"
      content_left: |
          Konvertieren Sie Dokumente genau wie die Originaldatei (TSV in TEX) und wenden Sie mithilfe von C# .NET Text- oder Bildwasserzeichen auf die konvertierten Dokumentseiten an.
