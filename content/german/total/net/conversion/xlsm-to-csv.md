...
content:
    enable: true
    block:
    - title_left: "So konvertieren Sie XLSM in CSV in C# .NET"
      content_left: |
          Befolgen Sie diese einfachen Schritte für die Konvertierung von XLSM in CSV in .NET. Sehen Sie sich das konvertierte CSV-Dokument so an, wie es ist, oder rendern und zeigen Sie es als HTML an, ohne externe Software zu verwenden.
    ...
    - title_left: "Hinzufügen von Text- oder Bildwasserzeichen zu CSV in C#"
      content_left: |
          Konvertieren Sie Dokumente genau wie die Originaldatei (XLSM in CSV) und wenden Sie mithilfe von C# .NET Text- oder Bildwasserzeichen auf die konvertierten Dokumentseiten an.
