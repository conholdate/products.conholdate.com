...
content:
    enable: true
    block:
    - title_left: "So konvertieren Sie OTS in DOTM in C# .NET"
      content_left: |
          Befolgen Sie diese einfachen Schritte für die Konvertierung von OTS in DOTM in .NET. Sehen Sie sich das konvertierte DOTM-Dokument so an, wie es ist, oder rendern und zeigen Sie es als HTML an, ohne externe Software zu verwenden.
    ...
    - title_left: "Hinzufügen von Text- oder Bildwasserzeichen zu DOTM in C#"
      content_left: |
          Konvertieren Sie Dokumente genau wie die Originaldatei (OTS in DOTM) und wenden Sie mithilfe von C# .NET Text- oder Bildwasserzeichen auf die konvertierten Dokumentseiten an.
