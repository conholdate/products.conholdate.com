...
content:
    enable: true
    block:
    - title_left: "So konvertieren Sie FODS in EPUB in Java"
      content_left: |
          Führen Sie die FODS-zu-EPUB-Dateikonvertierung in Java in drei einfachen Schritten durch. Sehen Sie sich das konvertierte Dokument so an, wie es ist, oder rendern Sie es so, dass es ohne externe Softwareabhängigkeit als HTML angezeigt wird.

          -   Erstellen Sie eine neue Instanz der **Converter**-Klasse und laden Sie die FODS-Datei
          -   Legen Sie **ConvertOptions** für den EPUB-Dokumenttyp fest
    ...
    - title_left: "Konvertieren Sie passwortgeschütztes FODS in EPUB"
      content_left: |
