...
content:
    enable: true
    block:
    - title_left: "So konvertieren Sie DOCM in FODP in Java"
      content_left: |
          Führen Sie die DOCM-zu-FODP-Dateikonvertierung in Java in drei einfachen Schritten durch. Sehen Sie sich das konvertierte MHTML-Dokument so an, wie es ist, oder rendern und zeigen Sie es als HTML an, ohne externe Software zu verwenden.
