...
content:
    enable: true
    block:
    - title_left: "So konvertieren Sie CSV in HTML in Java"
      content_left: |
          Führen Sie die CSV-zu-HTML-Dateikonvertierung in Java in drei einfachen Schritten durch. Sehen Sie sich das konvertierte Dokument so an, wie es ist, oder rendern Sie es so, dass es ohne externe Softwareabhängigkeit als HTML angezeigt wird.
    ...
    - title_left: "Konvertieren Sie passwortgeschütztes CSV in HTML"
      content_left: |
