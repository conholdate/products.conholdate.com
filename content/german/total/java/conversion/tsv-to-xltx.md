...
content:
    enable: true
    block:
    - title_left: "So konvertieren Sie TSV in XLTX in Java"
      content_left: |
          Führen Sie die TSV-zu-XLTX-Dateikonvertierung in Java in drei einfachen Schritten durch. Sehen Sie sich das konvertierte Dokument so an, wie es ist, oder rendern Sie es so, dass es ohne externe Softwareabhängigkeit als HTML angezeigt wird.
    ...
    - title_left: "Konvertieren Sie passwortgeschütztes TSV in XLTX"
      content_left: |
