...
draft: false
path: "zh/total/net/conversion/tsv-to-tex/"
other_out_formats: "PDF DOC DOCX DOCM DOT DOTX DOTM TXT RTF HTML HTM MHTML MHT XLS XLSX XLSM XLSB XLT XLTX XLTM XLAM CSV TSV DIF SXC FODS PPT PPTX PPS PPSX PPSM POT POTX PPTM POTM ODT OTT OTP ODP ODS EMZ WMZ SVG SVGZ XPS TEX DCM WMF EMF BMP PNG GIF JPEG TIFF ICO WEBP JP2 TGA PSB PSD EPUB MD XML JSON DICOM FODP JPG"
ad_headline: "將 TSV 轉換為 TEX | .NET"
ad_description: "為您的 .NET 應用程序提供最準確的 TSV 到 TEX 文檔轉換解決方案。"

############################# Head ############################
head_title: "在 C# ASP.NET 中將 Excel TSV 轉換為 TEX | .NET 文檔轉換"
head_description: ".NET Excel 電子表格文檔格式轉換 API。在 .NET（C#、VB.NET、ASP.NET 和 .NET Core）應用程序中將 TSV 轉換為 TEX 和 100 多種其他圖像和文檔文件格式。"

############################# Header ############################
title: "在 C# .NET 中將 Excel (TSV) 文件轉換為 TEX"
description: "在 C# VB.NET & ASP.NET 應用程序中使用原生 Excel 文檔轉換器 API 將 TSV 轉換為 TEX。使用靈活的文檔轉換功能來自定義生成的文檔外觀。準確地將所有流行的 Excel 工作表格式與 Word 文檔、PowerPoint 演示文稿、PDF、Photoshop、電子書、Web 和圖像文件格式相互轉換。轉換整個文檔或根據選擇性頁碼或頁面範圍選擇源文檔文件的特定頁面，並輕鬆轉換為支持的文檔格式。"
...
content:
    enable: true
    block:
    - title_left: "如何在 C# .NET 中將 TSV 轉換為 TEX"
      content_left: |
          按照這些簡單的步驟在 .NET 中將 TSV 轉換為 TEX。無需使用任何外部軟件即可按原樣查看轉換後的 TEX 文檔或將其呈現並顯示為 HTML。
    ...
    - title_left: "在 C# 中將文本或圖像水印添加到 TEX"
      content_left: |
          準確地將文檔（TSV 到 TEX）轉換為原始文件，並使用 C# .NET 將文本或圖像水印應用於轉換後的文檔頁面。
