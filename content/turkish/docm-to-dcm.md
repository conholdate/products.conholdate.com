...
content:
    enable: true
    block:
    - title_left: "C# .NET'te DOCM'yi DCM'ye Dönüştürme"
      content_left: |
          .NET'te DOCM'den DCM'ye dönüştürme için bu basit adımları izleyin. Dönüştürülen DCM belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
    ...
    - title_left: "C# ile DCM'ye Metin veya Görüntü Filigranı Ekleme"
      content_left: |
          Belgeleri (DOCM'den DCM'ye) tam olarak orijinal dosya gibi doğru bir şekilde dönüştürün ve C# .NET kullanarak dönüştürülen belge sayfalarına metin veya görüntü filigranları uygulayın.
