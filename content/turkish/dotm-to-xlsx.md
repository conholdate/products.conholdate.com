...
content:
    enable: true
    block:
    - title_left: "C# .NET'te DOTM'yi XLSX'ye Dönüştürme"
      content_left: |
          .NET'te DOTM'den XLSX'ye dönüştürme için bu basit adımları izleyin. Dönüştürülen XLSX belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
    ...
    - title_left: "C# ile XLSX'ye Metin veya Görüntü Filigranı Ekleme"
      content_left: |
          Belgeleri (DOTM'den XLSX'ye) tam olarak orijinal dosya gibi doğru bir şekilde dönüştürün ve C# .NET kullanarak dönüştürülen belge sayfalarına metin veya görüntü filigranları uygulayın.
