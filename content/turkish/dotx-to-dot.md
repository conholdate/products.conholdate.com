...
content:
    enable: true
    block:
    - title_left: "C# .NET'te DOTX'yi DOT'ye Dönüştürme"
      content_left: |
          .NET'te DOTX'den DOT'ye dönüştürme için bu basit adımları izleyin. Dönüştürülen DOT belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
    ...
    - title_left: "C# ile DOT'ye Metin veya Görüntü Filigranı Ekleme"
      content_left: |
          Belgeleri (DOTX'den DOT'ye) tam olarak orijinal dosya gibi doğru bir şekilde dönüştürün ve C# .NET kullanarak dönüştürülen belge sayfalarına metin veya görüntü filigranları uygulayın.
