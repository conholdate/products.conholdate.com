...
content:
    enable: true
    block:
    - title_left: "C# .NET'te DOTM'yi MHT'ye Dönüştürme"
      content_left: |
          .NET'te DOTM'den MHT'ye dönüştürme için bu basit adımları izleyin. Dönüştürülen MHT belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
    ...
    - title_left: "C# ile MHT'ye Metin veya Görüntü Filigranı Ekleme"
      content_left: |
          Belgeleri (DOTM'den MHT'ye) tam olarak orijinal dosya gibi doğru bir şekilde dönüştürün ve C# .NET kullanarak dönüştürülen belge sayfalarına metin veya görüntü filigranları uygulayın.
