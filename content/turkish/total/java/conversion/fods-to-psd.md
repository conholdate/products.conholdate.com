...
content:
    enable: true
    block:
    - title_left: "Java'da FODS'yi PSD'ye dönüştürme"
      content_left: |
          FODS dosyalarını üç kolay adımda Java'da PSD'ye dönüştürün. Dönüştürülen belgeyi olduğu gibi görüntüleyin veya harici yazılıma herhangi bir bağımlılık olmaksızın HTML olarak görüntülemek için oynatın.
    ...
    - title_left: "Parola Korumalı FODS'yi PSD'ye Dönüştür"
      content_left: |
