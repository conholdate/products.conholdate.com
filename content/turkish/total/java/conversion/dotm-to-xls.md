...
content:
    enable: true
    block:
    - title_left: "Java'da DOTM'yi XLS'ye Dönüştürme"
      content_left: |
          Java'da DOTM'den XLS'ye dosya dönüştürme işlemini üç basit adımı kullanarak gerçekleştirin. Dönüştürülen MHTML belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
