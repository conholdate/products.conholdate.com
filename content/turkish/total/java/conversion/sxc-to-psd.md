...
content:
    enable: true
    block:
    - title_left: "Java'da SXC'yi PSD'ye dönüştürme"
      content_left: |
          SXC dosyalarını üç kolay adımda Java'da PSD'ye dönüştürün. Dönüştürülen belgeyi olduğu gibi görüntüleyin veya harici yazılıma herhangi bir bağımlılık olmaksızın HTML olarak görüntülemek için oynatın.
    ...
    - title_left: "Parola Korumalı SXC'yi PSD'ye Dönüştür"
      content_left: |
