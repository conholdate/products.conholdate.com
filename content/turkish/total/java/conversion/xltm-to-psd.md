...
content:
    enable: true
    block:
    - title_left: "Java'da XLTM'yi PSD'ye dönüştürme"
      content_left: |
          XLTM dosyalarını üç kolay adımda Java'da PSD'ye dönüştürün. Dönüştürülen belgeyi olduğu gibi görüntüleyin veya harici yazılıma herhangi bir bağımlılık olmaksızın HTML olarak görüntülemek için oynatın.
    ...
    - title_left: "Parola Korumalı XLTM'yi PSD'ye Dönüştür"
      content_left: |
