...
content:
    enable: true
    block:
    - title_left: "Java'da XLTX'yi PSD'ye dönüştürme"
      content_left: |
          XLTX dosyalarını üç kolay adımda Java'da PSD'ye dönüştürün. Dönüştürülen belgeyi olduğu gibi görüntüleyin veya harici yazılıma herhangi bir bağımlılık olmaksızın HTML olarak görüntülemek için oynatın.

          -   **Converter** sınıfının yeni bir örneğini oluşturun ve XLTX dosyasını yükleyin
          -   PSD belge türü için **ConvertOptions**'ı ayarlayın
          ...
          -   Dönüştürülen PSD'yi HTML olarak görüntülemek için **Görüntüleyici** nesnesi oluşturun
    ...
    - title_left: "Parola Korumalı XLTX'yi PSD'ye Dönüştür"
      content_left: |
