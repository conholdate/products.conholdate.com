...
content:
    enable: true
    block:
    - title_left: "Java'da CSV'yi XPS'ye dönüştürme"
      content_left: |
          CSV dosyalarını üç kolay adımda Java'da XPS'ye dönüştürün. Dönüştürülen belgeyi olduğu gibi görüntüleyin veya harici yazılıma herhangi bir bağımlılık olmaksızın HTML olarak görüntülemek için oynatın.
    ...
    - title_left: "Parola Korumalı CSV'yi XPS'ye Dönüştür"
      content_left: |
