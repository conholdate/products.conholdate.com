...
content:
    enable: true
    block:
    - title_left: "Java'da DOT'yi XLS'ye Dönüştürme"
      content_left: |
          Java'da DOT'den XLS'ye dosya dönüştürme işlemini üç basit adımı kullanarak gerçekleştirin. Dönüştürülen MHTML belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
