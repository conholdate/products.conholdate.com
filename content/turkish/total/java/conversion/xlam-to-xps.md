...
content:
    enable: true
    block:
    - title_left: "Java'da XLAM'yi XPS'ye dönüştürme"
      content_left: |
          XLAM dosyalarını üç kolay adımda Java'da XPS'ye dönüştürün. Dönüştürülen belgeyi olduğu gibi görüntüleyin veya harici yazılıma herhangi bir bağımlılık olmaksızın HTML olarak görüntülemek için oynatın.
    ...
    - title_left: "Parola Korumalı XLAM'yi XPS'ye Dönüştür"
      content_left: |
