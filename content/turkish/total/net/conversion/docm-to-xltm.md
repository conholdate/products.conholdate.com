...
content:
    enable: true
    block:
    - title_left: "C# .NET'te DOCM'yi XLTM'ye Dönüştürme"
      content_left: |
          .NET'te DOCM'den XLTM'ye dönüştürme için bu basit adımları izleyin. Dönüştürülen XLTM belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
    ...
    - title_left: "C# ile XLTM'ye Metin veya Görüntü Filigranı Ekleme"
      content_left: |
          Belgeleri (DOCM'den XLTM'ye) tam olarak orijinal dosya gibi doğru bir şekilde dönüştürün ve C# .NET kullanarak dönüştürülen belge sayfalarına metin veya görüntü filigranları uygulayın.
