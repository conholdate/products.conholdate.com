...
content:
    enable: true
    block:
    - title_left: "C# .NET'te XLAM'yi XPS'ye Dönüştürme"
      content_left: |
          .NET'te XLAM'den XPS'ye dönüştürme için bu basit adımları izleyin. Dönüştürülen XPS belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
    ...
    - title_left: "C# ile XPS'ye Metin veya Görüntü Filigranı Ekleme"
      content_left: |
          Belgeleri (XLAM'den XPS'ye) tam olarak orijinal dosya gibi doğru bir şekilde dönüştürün ve C# .NET kullanarak dönüştürülen belge sayfalarına metin veya görüntü filigranları uygulayın.
