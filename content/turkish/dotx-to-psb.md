...
content:
    enable: true
    block:
    - title_left: "C# .NET'te DOTX'yi PSB'ye Dönüştürme"
      content_left: |
          .NET'te DOTX'den PSB'ye dönüştürme için bu basit adımları izleyin. Dönüştürülen PSB belgesini olduğu gibi görüntüleyin veya herhangi bir harici yazılım kullanmadan HTML olarak oluşturun ve görüntüleyin.
    ...
    - title_left: "C# ile PSB'ye Metin veya Görüntü Filigranı Ekleme"
      content_left: |
          Belgeleri (DOTX'den PSB'ye) tam olarak orijinal dosya gibi doğru bir şekilde dönüştürün ve C# .NET kullanarak dönüştürülen belge sayfalarına metin veya görüntü filigranları uygulayın.
