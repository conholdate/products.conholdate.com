...
############################# Head ############################
head_title: "Add Watermark to EMZ Viewer in Java & J2SE"
head_description: "Add image watermark to EMZ file viewer applications using Java & J2SE in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to EMZ Viewer in Java"
description: "Add watermark image to EMZ document viewer applications in Java and J2SE platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to EMZ File in Java"
    content_left: |
        ...
        *   Instantiate **FileInputStream** Object with input EMZ document
    ...
    code: |
        ```cs {linenos=false}
        // Add image watermark to EMZ in Java
        // Instantiate FileInputStream Object with input file
        FileInputStream stream = new FileInputStream("input.emz");
