...
############################# Head ############################
head_title: "Add Watermark to TEX Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to TEX file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to TEX Viewer in C# .NET"
description: "Add watermark image to TEX document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to TEX File in .NET"
    content_left: |
    ...
    content_right: |
        ...
        Insert image watermark to TEX on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to TEX in C# .NET
        // Instantiate Watermarker with input TEX document
        using (Watermarker watermarker = new Watermarker("input.tex"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
        ...
        // View watermarked TEX file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
