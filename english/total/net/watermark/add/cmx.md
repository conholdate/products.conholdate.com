...
############################# Head ############################
head_title: "Add Watermark to CMX Viewer in C#, ASP.NET, VB.NET, Xamarin"
head_description: "Add image watermark to CMX file viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono in your desktop, web or mobile applications."

############################# Header ############################
title: "Add Watermark to CMX Viewer in C# .NET"
description: "Add watermark image to CMX document viewer applications in C#, ASP.NET, VB.NET, .NET Core, Xamarin and Mono platforms. Display the watermarked file in HTML, Image or PDF format inside your applications without using any additional software."
...
steps:
    enable: true
    title_left: "Insert Watermarks to CMX File in .NET"
    content_left: |
        ...
        *   Instantiate **Watermarker** with input CMX document
    ...
    content_right: |
        ...
        Insert image watermark to CMX on different operating systems such as Windows, Linux or macOS while using platforms such as Windows Azure, Mono and Xamarin.
        
    code: |
        ```cs {linenos=false}
        // Add image watermark to CMX in C# .NET
        // Instantiate Watermarker with input CMX document
        using (Watermarker watermarker = new Watermarker("input.cmx"))
          {
            // Use watermark image path as constructor parameter of ImageWatermark class
            using (ImageWatermark watermark = new ImageWatermark("watermark.png"))
            {
              ...
              watermarker.Save("output.cmx");
            }
          }
        
        // View watermarked CMX file using GroupDocs.Viewer API
        // Instantiate Viewer with output document
        using (Viewer viewer = new Viewer("output.cmx"))
          {
            // Set options to view document as HTML
